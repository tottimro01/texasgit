...
if($url_set==11){
	$txt="ສູງ $name1";
	$type_pay=" and play_type=3";
	}elseif($url_set==12){
	$txt="ຕໍ່າ $name1";	
	$type_pay=" and play_type=4";
	}elseif($url_set==13){	
	$txt="ສູງ - ຕໍ່າ";	
	$type_pay=" and (play_type=3 or play_type=4)";
	}
...
<div id="box_over">
	...
	?>
        ...
        <td width="15%" align="left" bgcolor="#FEFFA3" class="td_bd_right td_bd_bottom blue"><?=$txt;?></td>
