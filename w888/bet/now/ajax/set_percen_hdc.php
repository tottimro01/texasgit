...
$sql="update pha_tb_ball_list_live set   b_percent='$val'  where b_id='$id' and b_add='$add'";
sql_query($sql);
...
$_date = date("d-m-Y");
$_time = date("H:i:s");
$sql2="INSERT INTO z_live_log (`id_log`,`id_usr`,`id_ball`,`add`,`type`,`old`,`new`,`zdate`,`ztime`) VALUES (NULL,'".$_SESSION['usr_id_live']."','$id','$add','7','$old','$val','$_date','$_time');";
sql_query($sql2); 
