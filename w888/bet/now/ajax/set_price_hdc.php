...
echo $val20= number_format(_wp20( $val , $per ),2);
echo"<hr>";
echo $val30= number_format(_wp2( $val20 , $per ),2);
...
$_date = date("d-m-Y");
$_time = date("H:i:s");
$sql2="INSERT INTO z_live_log (`id_log`,`id_usr`,`id_ball`,`add`,`type`,`old`,`new`,`zdate`,`ztime`) VALUES (NULL,'".$_SESSION['usr_id_live']."','$id','$add','1','$old','$val','$_date','$_time');";
sql_query($sql2); 
