...
$sql="select * from pha_tb_football_bill_play where b_id='$id' and b_add='$add' and b_numstep=1  and b_cancel=0  and (play_type=3 or play_type=4)  order by play_id desc";
$re=sql_query($sql);
...
<input  type="button" value="ປິດ" onclick="_cc();"  style="float:right;"/>
  ...
  <tr>
    ...
    <td width="13%" align="center" bgcolor="#54BAFF" style="color: #FFF">ສູງ</td>
    <td width="13%" align="center" bgcolor="#54BAFF" style="color: #FFF">ຕໍ່າ</td>
      <td width="8%" align="center" bgcolor="#54BAFF" style="color: #FFF"><strong>0 - 0</strong></td>
    ...
    <td width="9%" align="center" bgcolor="#54BAFF" style="color: #FFF"><strong>3 - 0</strong></td>
    <td width="9%" align="center" bgcolor="#54BAFF" style="color: #FFF"><strong>4 - 0</strong></td>
    </tr>
  <tr>
    ...
    <td align="right" bgcolor="#FEFFA3"><?=number_format($hsum2);?></td>
      <td align="right" bgcolor="#FFFFFF">
       <?
    $sx1=@array_sum($mo_array[h0_0]);
	echo _mk($sx1);
	?></td>
         <td align="right" bgcolor="#FFFFFF">
       <?
    $sx2=@array_sum($mo_array[h1_0]);
	echo _mk($sx2);
	?></td>
        <td align="right" bgcolor="#FFFFFF">
       <?
    $sx3=@array_sum($mo_array[h2_0]);
	echo _mk($sx3);
	?></td>
          <td align="right" bgcolor="#FFFFFF">
       <?
    $sx4=@array_sum($mo_array[h3_0]);
	echo _mk($sx4);
	?></td>
             <td align="right" bgcolor="#FFFFFF">
       <?
    $sx5=@array_sum($mo_array[h4_0]);
	echo _mk($sx5);
	?></td>
      </tr>
</table>
