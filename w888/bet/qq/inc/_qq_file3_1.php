...
for($i=1;$i<count($ex_qq);$i++){
	...
	$hdc = strip_tags($value_new[24]);
	echo "เต็มเวลา HDC = ".$hdc."<br>";
	$hdc_1 = strip_tags($value_new[25]);
	echo "เต็มเวลา HDC1 = ".$hdc_1."<br>";
	$hdc_2 = strip_tags($value_new[26]);
	echo "เต็มเวลา HDC2 = ".$hdc_2."<br>";
	
	$goal = strip_tags($value_new[32]);
	echo "เต็มเวลา GOAL = ".$goal."<br>";
	$goal_1 = strip_tags($value_new[33]);
	echo "เต็มเวลา GOAL1 = ".$goal_1."<br>";
	$goal_2 = strip_tags($value_new[34]);
	echo "เต็มเวลา GOAL2 = ".$goal_2."<br>";
	
	/*$hdc_1h = strip_tags($value_new[32]);
	echo "ครึ่งแรก HDC = ".$hdc_1h."<br>";
	$hdc_1h_1 = strip_tags($value_new[33]);
	echo "ครึ่งแรก HDC1 = ".$hdc_1h_1."<br>";
	$hdc_1h_2 = strip_tags($value_new[34]);
