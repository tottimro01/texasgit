...
function ref_page(){
	$.post( 'refresh_page/check_refresh.php?randval='+ Math.random(), { "fzone": 4}, function( data ) {
...
function set_W(ele , id){
	var val = $(ele).html();
	$.post("ajax/set_W_kk.php" , { 'val': val , "id" : id },
		function(data){
			//save success;
			if(val=="O"){
				$(ele).html("X");
...
function set_B(ele , id){
	var val = $(ele).html();
	$.post("ajax/set_B_kk.php" , { 'val': val , "id" : id },
		function(data){
			//save success;
			if(val=="O"){
				$(ele).html("X");
...
function set_key(ele , id){
	var val = $(ele).html();
	$.post("ajax/set_key_kk.php" , { 'val': val , "id" : id },
		function(data){
			//save success;
			if(val=="O"){
				$(ele).html("X");
