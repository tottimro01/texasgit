...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="tr_data">
    ...
    <td width="15%" align="left" class="td_bd_right td_bd_bottom"><strong class="lk_hover hand_hover" onClick="edit_mem();">1234</strong>&nbsp;<img src="img/users.png" height="15" style="vertical-align: text-top; cursor:pointer;" title="คลิก เพื่อดูลูกเวป 2 คน" onClick="window.location.href='sub_mem.php'">&nbsp;<img src="img/thunder.png" height="15" style="vertical-align: text-top;" title="มนุษย์ไฟฟ้า">&nbsp;<img src="img/bcan.png" height="15" style="vertical-align: text-top;" title="ไม่ให้เล่น Internet Betting">&nbsp;<img src="img/keylock.png" height="15" style="vertical-align: text-top;" title="รหัสลูกค้าถูกล๊อค"></td>
    ...
    <td width="10%" align="right" class="td_bd_right td_bd_bottom td_bg_yellow"><span class="lk_hover hand_hover" onClick="parent.rightx.location.href='box_right.php';">100</span></td>
