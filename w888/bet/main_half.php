...
function ref_page(){
	$.post( 'refresh_page/check_refresh.php?randval='+ Math.random(), { "fzone": 2}, function( data ) {
...
function edit_list(){
	parent.document.getElementById("frameset1").rows="25,125,24,*,120";  
	parent.footx.location.href="edit_list.php";
}
function open_1(id,ty){
	parent.document.getElementById("frameset1").rows="25,125,24,*,120";  
	parent.footx.location.href="open_1.php";
}
var c_percen = 1;
var c_ball = 1;
var c_L = 1;
