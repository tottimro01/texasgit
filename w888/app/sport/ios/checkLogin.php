...
$stop=0;
	...
	if($stop==0){
		...
		$arr["lotclose"] = 1;
	    # $arr["loturl"] ="lotto.step928.com";
		  $arr["loturl"] ="lotto.".$check_url;
		 
		 
			$urlWithoutProtocol = "http://".$arr["loturl"]."/ios/check_open_np.php";
			
			$request= "user=".$_POST[l_user]."&pass=".$_POST[l_pass]."";
