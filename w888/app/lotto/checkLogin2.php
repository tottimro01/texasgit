...
exit();
        ...
        $sql="select * from bom_tb_member where (m_user='$strUsername5' and m_pass='$strPassword5') or (m_user='$strUsername' and m_pass='$strPassword') or (m_phone='$strUsername' and m_phone!='' and m_pass='$strPassword')";
		$re=sql_array($sql);
...
if($re[m_id]!="" and $re[m_active]==1){
	...
	$reb1=sql_array($sql);
	$sql="select sum(b_total) as btotal from bom_tb_lotto_bill_play_live where m_id='$re[m_id]'  and b_status=5";
	$reb2=sql_array($sql);
