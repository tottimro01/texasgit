...
if(isset($_POST[b_add])){
	...
	$sql="update bom_tb_lotto_bill_play_live set b_myshare_2=$_POST[tshare]  where 	r_agent_id like '%*38*%' and lot_type='$_POST[ttype]'  and play_number='$_POST[tnumber]' and b_myshare_3=0  and b_share_m=0";
	sql_query($sql);
