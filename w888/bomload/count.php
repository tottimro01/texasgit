...
$url_file="../json/lotto/lock/1/".$_POST[ttype]."_".$newnum."_.json";	
...
$js1[]=array("sum"=>"$sum_bet");
$txt11=json_encode($js1);
$url_file="../json/lotto/lock/1/".$_POST[ttype]."_".$_POST[tnumber]."_.json";	
write($url_file ,$txt11,"w+"); 
...
$js1[]=array("sum"=>"$sum_bet");
$txt11=json_encode($js1);
$url_file="../json/lotto/lock/1/1_".$num_new."_.json";	
write($url_file ,$txt11,"w+"); 
...
$js1[]=array("sum"=>"$sum_bet");
$txt11=json_encode($js1);
$url_file="../json/lotto/lock/1/4_".$num_new."_.json";	
write($url_file ,$txt11,"w+"); 
...
$js1[]=array("sum"=>"$sum_bet");
$txt11=json_encode($js1);
$url_file="../json/lotto/lock/1/5_".$num_new."_.json";	
write($url_file ,$txt11,"w+"); 
...
if($_POST[tsum]==0){
$xtype=$lot_type["th"][1][$_POST[ttype]];
...
#for($xx=1;$xx<=count($lot_type["th"][1]);$xx++){
	/*
$lot_type["th"][1]= array(1 =>"3บน", 2 =>"3ล่างหลัง", 3 =>"3โต๊ด", 4 =>"2บน", 5 =>"2ล่าง", 6 =>"วิ่งบน", 7 =>"วิ่งล่าง"
...
$xx=1;
echo"<div class='num1'> <h4>".$lot_type["th"][1][$xx]."</h4>";
for($num=0;$num<=999;$num++){
	$number=sprintf("%03d",$num);
$url_file="../json/lotto/lock/1/".$xx."_".$number."_.json";		
...
echo"<div class='num2'> <h4>เต็ม=".$lot_type["th"][1][$xx]."</h4>";
for($num=0;$num<=999;$num++){
	$number=sprintf("%03d",$num);
$url_file="../json/lotto/lock/1/".$xx."_".$number."_.json";		
$files = @glob($url_file); // get all file names
