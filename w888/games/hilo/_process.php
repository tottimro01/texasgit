...
header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT");
 header("Pragma-directive: no-cache");
  ...
  $url_filec="/home/lotto/domains/555king.com/public_html/hilo/json/bacarat_close.txt";
...
$url_filei="/home/lotto/domains/555king.com/public_html/hilo/json/bacarat_id.txt";
...
sql_query($sql);
$sql="update pha_tb_hilo_bill_play set  bet_win='$x_win'    where bill_id='$bet_id' and bet_win=''";
sql_query($sql);

$url_filed="/home/lotto/domains/555king.com/public_html/hilo/json/bacarat_win.txt";
$js1=array();
...
$sql="update pha_tb_hilo_bill_play set  play_status=1    where bill_id='$bet_id' and play_status=7 and play_bet=1 and play_bet='$ok1a,0,0'; ";
sql_query($sql);
$sql="update pha_tb_hilo_bill_play set  play_status=1    where bill_id='$bet_id' and play_status=7 and play_bet=1 and play_bet='$ok2a,0,0'; ";
sql_query($sql);
$sql="update pha_tb_hilo_bill_play set  play_status=1    where bill_id='$bet_id' and play_status=7 and play_bet=1 and play_bet='$ok3a,0,0'; ";
sql_query($sql);
