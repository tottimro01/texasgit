...
$type_games=1;
$paywinh=$arr_color_pay[$_POST["ok"]];
#$paywinh=$arr_color_pay[$_POST["ok"]]+($hdis[$type_games]/100);
?>
...
<table  border="0" align="center" cellpadding="0" cellspacing="0" class="">
  <tbody><tr class="tb_title_lotto">
    <td height="25" align="center" class="txt_white12btitle" style="padding-left:5px;"><span id="s_type"><?=$lang_member[353];?></span></td>                
  </tr>     
  <?
...
?>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="">
        <tbody><tr>
          <td width="176" height="70" align="center" bgcolor="#FFFFFF" class="txt_back11n" style="font-size: 16px; font-weight: bold;">
            ...
            <img src="img/2hit/60/<?=$_POST["ok"]?>.png" height="60">
          </td>
          </tr>
        <tr>
  ...
  <tr>
    <td height="30" align="center" class="bg_td rl-border">
        ...
        <input type="button" name="sm" id="sm" class="btn_le btn_small" value="<?=$lang_member[321];?>" onclick="_betok4();">
