...
require(__DIR__.'/../game/function.php');
...
$bet_id=$rec['con_id_games'];
    ...
    $sql="select * from bom_tb_color_bill_play where m_id='$_SESSION[m_id]' and bill_id='$bet_id'  order by play_id desc limit 100";
	$num=sql_num($sql);
	if($num>0){
	?>
...
<tr>
<td height="25" align="center" colspan="3" class="txt_white12btitle"><span id="s_type"><strong class="cw"><?=$lang_member[337];?></strong></span></td>  
  </tr>
...
while($rs=sql_fetch($re)){
  ?>
<tr class="tr_lot">
    <td align="center"><img src="img/color/<?=$rs["play_bet"]?>.png" height="22"></td>
