...
<!--<script language="JavaScript" type="text/javascript" src="commJS/odds/FGLG_Def.js?v=201109160917"></script>-->
<script language="JavaScript" type="text/javascript" src="commJS/odds/FGLG.js"></script>
...
<div class="titleBar">
    <div class="title">เต็มเวลาและครึ่งเวลา ประตูแรก/ ประตูสุดท้าย</div>
    <div class="right">
...
<li  title='เรียงลำดับตามปกติ' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>เรียงลำดับตามปกติ</li>
        ...
        <a href="javascript:openLeague(640,'เลือกลีค','t','1','14,127','0','FGLG');" class="button selectLeague" title="เลือกลีค">
			<span>
        ...
        <a href="#" id="btnRefresh_D" class="button disable" onclick="refreshData();"><span><div class="icon-refresh" title="กรุณารอ"></div></span></a>
    </div>
</div>
...
<form action="FGLG_data.php" target="DataFrame" name="DataForm" style="display: none">
