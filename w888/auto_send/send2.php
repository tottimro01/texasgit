...
$subject = "หวยหุ้น สายB LOTZX ".date("d-m-Y",$time_stam)."  รอบ 2 เวลา ".date("H:i",$time_stam)." ประเภท "._i_iset($_GET[i])."";
...
file_get_contents($hostserver.'create_pdf/go2.php?i='.$_GET[i].'');
sleep(1);
