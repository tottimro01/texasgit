...
require('gmail.php');
include('../auto/hun_date_stop.php');
...
#$subject = "หวยหุ้น ".date("d-m-Y",$time_stam)."  รอบ 1 เวลา ".date("H:i",$time_stam)."";
$subject = "หวยหุ้น สายB LOTZX ".date("d-m-Y",$time_stam)."  รอบ 1 เวลา ".date("H:i",$time_stam)." ประเภท "._i_iset(1)."";
...
$renum=sql_num($sql);
if($renum>0){
file_get_contents($hostserver.'create_pdf/go1.php');
sleep(1);
