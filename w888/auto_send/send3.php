...
#$subject = "หวยหุ้น ".date("d-m-Y",$time_stam)."  รอบ 3 เวลา ".date("H:i",$time_stam)."";
$subject = "หวยหุ้น สายB LOTZX ".date("d-m-Y",$time_stam)."  รอบ 3 เวลา ".date("H:i",$time_stam)." ประเภท "._i_iset(1)."";
...
file_get_contents($hostserver.'create_pdf/go3.php');
sleep(1);
