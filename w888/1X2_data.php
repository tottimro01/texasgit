...
if($_GET['Market']=='l' && $_GET['Sport']=='1' && $_GET['RT']=='W' && $_GET['Game']==0 && $_GET['MainLeague']=='0' && $_GET['key']=='lodds'){
	echo file_get_contents2($server_soccer."UnderOver_data_L_1x2.php?OddsType=".$_GET['OddsType']."&OrderBy=".$_GET['OrderBy']);
}else if($_GET['Market']=='t' && $_GET['Sport']=='1' && $_GET['RT']=='W' && $_GET['Game']==0 && $_GET['key']=='dodds' && $_GET['MainLeague']=='0'){
	echo file_get_contents2($server_soccer."UnderOver_data_T_1x2.php?OddsType=".$_GET['OddsType']."&OrderBy=".$_GET['OrderBy']);
// new ------------------------------------------------------------------------------------------
}elseif($_GET['Market']=='l' && $_GET['Sport']=='1' && $_GET['RT']=='U' && $_GET['Game']==0 && $_GET['MainLeague']=='0' && $_GET['key']=='lodds'){
	echo file_get_contents2($server_soccer."UnderOver_data_LR_1x2.php?OddsType=".$_GET['OddsType']."&OrderBy=".$_GET['OrderBy']);
}elseif($_GET['Market']=='t' && $_GET['Sport']=='1' && $_GET['RT']=='U' && $_GET['Game']==0 && $_GET['key']=='dodds'){
	echo file_get_contents2($server_soccer."UnderOver_data_TR_1x2.php?OddsType=".$_GET['OddsType']."&OrderBy=".$_GET['OrderBy']);
}
