...
function GetKenoURL(page,date,detail){
  ...
  var ary = url.split("/");
  var redirectURL = "http://" + ary[2] + "/AuthorizationCustomer.php?cust=keno&" + param;

  return "AuthorizationCustomer.php?cust=keno&" + param + "&redirectURL=" + encodeURIComponent(redirectURL)
}
...
function GetKenoLotteryURL(page,date,detail){
  ...
  var url = location.href;  
  var ary = url.split("/");
  var redirectURL = "http://" + ary[2] + "/AuthorizationCustomer.php?cust=kenolottery&" + param;

  return "AuthorizationCustomer.php?cust=kenolottery&" + param + "&redirectURL=" + encodeURIComponent(redirectURL)
}
...
function GetVendorURL(cust,page,date,detail){
  ...
  var url = location.href;  
  var ary = url.split("/");
  var redirectURL = "http://" + ary[2] + "/AuthorizationCustomer.php?cust=" + cust + "&" + param;
  return "AuthorizationCustomer.php?cust=" + cust + "&" + param + "&redirectURL=" + encodeURIComponent(redirectURL);
}
...
function OpenColossusBet(ref)
{
    var url = location.href;
    var ary = url.split("/");
    var redirectURL = "http://" + ary[2] + "/AuthorizationCustomer.php?cust=colossusbet";
    var callback = function (Handle, isNewOpen)
    {
        if (!isNewOpen)
        {
            //Handle.location = "AuthorizationCustomer.php?cust=colossusbet&redirectURL=" + encodeURIComponent(redirectURL);
    ...
    fFrame.openWindowsHandle("ColossusBet",
                                true,
                                null,
                                //"AuthorizationCustomer.php?cust=colossusbet&redirectURL=" + encodeURIComponent(redirectURL),
...
function OpenKeno(page,date,detail){
  ...
  if(page!="M"){
       ...
       {
           if(!isNewOpen){
              Handle.location="AuthorizationCustomer.php?cust=keno&" + param + "&redirectURL=" + encodeURIComponent(redirectURL);
             }
       }
       ...
       fFrame.openWindowsHandle("keno"+page,
                                ...
                                "AuthorizationCustomer.php?cust=keno&" + param +
...
function OpenKenoLottery(page,date,detail){
  ...
  if(page!="M"){
       ...
       {
           if(!isNewOpen){
              Handle.location="AuthorizationCustomer.php?cust=kenolottery&" + param + "&redirectURL=" + encodeURIComponent(redirectURL);
             }
       }
       ...
       fFrame.openWindowsHandle("kenolottery"+page,
                                ...
                                "AuthorizationCustomer.php?cust=kenolottery&" + param +
                                "&redirectURL=" + encodeURIComponent(redirectURL),
                                "fullscreen=1,scrollbars=yes,resizable=yes",
                                false,
                                callback);
...
function OpenCF(page,date,detail){
  ...
  var url = location.href;  
  var ary = url.split("/");
  var redirectURL = "http://" + ary[2] + "/AuthorizationCustomer.php?cust=cf&" + param;

  if(page!="M"){
       var callback =  function(Handle,isNewOpen)
       {
           if(!isNewOpen){
              Handle.location="AuthorizationCustomer.php?cust=cf&" + param + "&redirectURL=" + encodeURIComponent(redirectURL);
             }
       }
       ...
       fFrame.openWindowsHandle("cf"+page,
                                ...
                                "AuthorizationCustomer.php?cust=cf&" + param +
                                "&redirectURL=" + encodeURIComponent(redirectURL),
                                "fullscreen=1,scrollbars=yes,resizable=yes",
                                false,
                                callback);
...
function OpenAllBet(){
 fFrame.openWindowsHandle("winLobby" ,
                           ...
                           "AuthorizationCustomer.php?cust=allbet",
...
function OpenGG(refer){
		...
		if(checkV){
		    ...
		    fFrame.openWindowsHandle("GGLobby" ,
                           ...
                           "AuthorizationCustomer.php?cust=gg&refer=" + refer,
...
function OpenN7(){
    ...
    fFrame.openWindowsHandle("N7Lobby" ,
                           ...
                           "AuthorizationCustomer.php?cust=n7",
...
function OpenBullFighting(){
    ...
    var url = location.href;  
    var ary = url.split("/");
    var redirectURL = "http://" + ary[2] + "/AuthorizationCustomer.php?cust=bf&" + param;
    ...
    fFrame.openWindowsHandle("BFLobby" ,
                           ...
                           "AuthorizationCustomer.php?cust=bf" + "&redirectURL=" + encodeURIComponent(redirectURL),
                           "height=" + height + ", width=" + width + ", top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no"                           
                            );
}
...
function OpenCardClub(){
	...
	if (checkV) {
		fFrame.openWindowsHandle("CardClubLobby",
			...
			"{{CardClubFlashMsg}}",
			"AuthorizationCustomer.php?cust=cardclub",
...
function OpenCasino(para){
 ...
 fFrame.openWindowsHandle("winLobby" ,
                           ...
                           "AuthorizationCustomer.php?cust=onerng&casinourl=" + RngSingleLobbyWebURL+"&istablet=" + CheckIsIpadForCasino(),
...
function ConfirmCallMiniGame()
{
   if (fFrame.CanSeeMiniGame)
   {
		...
		$('#MiniGame_iframe').attr("src","AuthorizationCustomer.php?cust=minigame");
...
<body lang="th" id="LeftAllInOne" onload="refreshAccountInfo('full');">
<?}?>
<div> 
  ...
  <div id="MessageDisplayContainer" style="display:none">
    ...
    <div class="Backmenu"><span class="icon-arrow"></span><a href="javascript:ReloadWaitingBetList('yes','no','1');"><?=$lang_member[923];?></a></div>
  ...
  <div id="div_accountInfoFull"> 
    ...
    <div id="account_allhard">
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td valign="top"  nowrap="nowrap" style="cursor: pointer;" onclick="javascript:refreshAccountInfo('mini')"><a href="#" target="leftx"  class="btnIcon right balance-open" title="<?=$lang_member[924];?>"><span class="icon-arrow"></span></a></td>
          <td valign="top"  nowrap="nowrap" width="20"><a name="btnRefresh" href="javascript:refreshAccountInfo('full');"  class="btnIcon right" title="<?=$lang_member[769];?>"><span class="icon-refresh"></span></a></td>
        </tr>
      </table>
      <div class="line"></div>
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="20" align="left" title="<?=$lang_left[2];?>"><div class="text-ellipsis" style="max-width:80px;"><?=$lang_left[2];?></div></td>
          <td align="right">
            <?if($_SESSION['m_user_set']!=""){?>
            <span id="txt_nickname" class="member_nickname"><?=$_SESSION['m_user_set'];?></span>
            <?}else{?>
            <span id="txt_nickname" class="member_nickname"><?=$lang_left[8];?></span>
            <?}?>
          </td>
        </tr>
    ...
    <div class="account_body">
      <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="tabstyle01">
                <tr>
          <th align="left" nowrap="nowrap" title="<?=$lang_left[5];?>"><div class="text-ellipsis" style="width:70px;"><?=$lang_left[5];?></div></th>
          <td align="right"><span id="txt_betcredit"></span></td>
        </tr>
               <tr>
          <th align="left" nowrap="nowrap" title="<?=$lang_left[6];?>"><div class="text-ellipsis" style="width:70px;"><?=$lang_left[6];?></div></th>
          <td align="right"><span id="txt_outstanding"></span></td>
        </tr> 
        <tr>
          <th align="left" nowrap="nowrap" title="<?=$lang_left[3];?>"><div class="text-ellipsis" style="width:70px;"><?=$lang_left[3];?></div></th>
          <td id="cashBalance" align="right" class="UdrDogOddsClass"><span id="txt_cash" style="font-weight: normal;"></span></td>
        </tr>        


        <tr>
          <th align="left" nowrap="nowrap" title="<?=$lang_left[7];?>"><div class="text-ellipsis" style="width:70px;"><?=$lang_left[7];?></div></th>
          <td align="right"><span id="txt_credit"><?=number_format($_SESSION['m_count_de'] , 2)?></span></td>
        </tr>
        <tr>
          <th colspan="2" align="left" title="<?=$lang_left[9];?>"><div class="text-ellipsis" style="width:160px;"><?=$lang_left[9];?></div></th>
        </tr>
        <tr>
          <td colspan="2"><span id="txt_login"><?=$_SESSION['m_login']?></span></td>
        </tr>
        <tr>
          <th colspan="2" align="left" title="<?=$lang_left[10];?>"><div class="text-ellipsis" style="width:160px;"><?=$lang_left[10];?></div></th>
        </tr>
        <tr>
    ...
    <form id="FrameAllAccount" name="FrameAllAccount" action="inc/get_credit.php" method="post" target="iFrameAllAccount">
  ...
  <div id="div_accountInfoMini" style="display:none;"> <span id="account_info"></span>
    <div id="account_hard">
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="30" valign="top" class="Tcolor01" style="cursor: pointer;" onclick="javascript:refreshAccountInfo('full')"><div id="divMiniUserName"><?=$_SESSION['m_user'];?><br />
            <? if($_SESSION['m_user_set']!=""){?>
              <span class="member_nickname"><?=$_SESSION['m_user_set'];?></span></div></td>
            <? }else{?>
              <span class="member_nickname"><?=$lang_left[8];?></span></div></td>
            <? }?>
          <td valign="top"  nowrap="nowrap" style="cursor: pointer;" onclick="javascript:refreshAccountInfo('full')"><a href="#" target="leftx"  class="btnIcon right balance" title="<?=$lang_member[924];?>"><span class="icon-arrow"></span></a></td>
          <td valign="top"  nowrap="nowrap" width="20"><a name="btnRefresh" href="javascript:refreshAccountInfo('mini');"  class="btnIcon right" title="<?=$lang_member[769];?>"><span class="icon-refresh"></span></a></td>
        </tr>
      </table>
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabstyle01" style="cursor: pointer;" onclick="javascript:refreshAccountInfo('full')">
        <tbody>
          <tr>
            <th height="20" valign="top" title="<?=$lang_member[925];?>">
          ...
          <tr>
            <th height="20" valign="top" title="<?=$lang_member[94];?>">
              <span class="icon-cash"></span>
            </th>
            <td align="right" nowrap="nowrap">
              <span id="AccCurrency_P">THB </span>
			  <span id="txt_cashInfo" class="UdrDogOddsClass"<? if((floatval($re_m['m_count'])-floatval($_SESSION['m_count_de']))<0){ ?> style="color: red;"<? } ?>><?=number_format(floatval($re_m['m_count'])-floatval($_SESSION['m_count_de']), 2);?></span>
            </td>
          </tr>
        </tbody>
      </table>
...
<div id="TVBox" style="display:none;">
  <div class="leftBoxTitle" title="<?=$lang_member[926];?>"><span class="icon-arrow"></span>
    <div class="btnIcon mark right" onclick="CloseTVBox()"><span class="icon-close" title="<?=$lang_member[612];?>"></span></div>
    <div id="sTVReflash" class="btnIcon mark right" onclick="this.className='btnIcon mark right disable';ReflashSingleStreaming();" title="<?=$lang_member[769];?>"><span class="icon-refresh"></span></div>
    <a href="javascript:SwitchSingleStreaming();" class="btnIcon mark right"><span class="icon-zoom"></span></a>
    <span class="titleTxt"><?=$lang_member[926];?></span></div>
  <div class="leftBoxbody">
    <div class="boxbg">
...
<div>
  ...
  <!-- My Favorite menu -->
  <div id="div_favorite" class="favoritemenu" style="display:none;"><span id="Favorite" class="icon-favorite"></span><a href="javascript:ShowOdds('F','1',fFrame.DisplayMode);"><?=$lang_member[883];?></a></div>
  <!-- END My Favorite menu -->
  <div id="div_menu" class="hidemenu" style=""><span class="icon-arrow"></span><a href="javascript:SwitchMenu('th');"><span id="lblShowSportsMenu"><?=$lang_member[927];?></span><span id="lblHideSportsMenu"><?=$lang_member[928];?></span></a></div>
  <!--sport menu--> 
  ...
  <div id="BettingModeContainer" class="TabBox" style="display:none">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          <td id="div_menu_single" class="R_menu_R current" title="<?=$lang_member[537];?>"><span class="icon-arrow"></span><a href="JavaScript:SwitchBettingMode(0,'1')"><span class="subTitle"><?=$lang_member[537];?></span></a></td>
          ...
          <td id="div_menu_parlay" class="R_menu_gr" title="<?=$lang_member[767];?>"><span class="icon-arrow"></span><a href="JavaScript:SwitchBettingMode(2,'1')"><span class="subTitle"><?=$lang_member[767];?></span><span class="numSelections" id="mparlay_cnt"></span></a></td>
        </tr>
      </tbody>
    </table>
  </div>
        ...
        <div class="leftBoxbody">
          <div class="boxbg">
            <div id="BetInfo" class="BetInfo">
              <div class="TextStyle01 pad"><span id="menuTitle"></span> <span id="menuTitleOT"><?=$lang_member[758];?></span> <span id="tdBetKind"></span></div>
              <div id="trOddsInfo">
	...
	<ul class="numberPad" id="BPstake_numberPad">
        ...
        <li><a href="javascript:void(0);" class="enter">enter</a></li>
              ...
              <div id="divAcceptBetterOdds" class="checkbox txtleft" style="display: none;">
                ...
                <div style="display: none;"><?=$lang_member[929];?></div>
              </div>
            ...
            <div class="BetProcessBtnBox">
              ...
              <a style="cursor:pointer;" type="button" onclick="javascript:ReloadWaitingBetList('yes','no','1');" class="button" title="<?=$lang_member[65];?>"><span><?=$lang_member[65];?></span></a> </div>
	...
	<div class="leftBoxFoot"></div>
      ...
      <div id="BP_RACE" style="display:none">
          <div class="leftBoxbody">
            <div class="boxbg">
              <div class="BetInfo">
                <div class="TextStyle01 pad"><span id="hrmenuTitle"><?=$lang_member[758];?></span><span id="hrtdBetKind"></span></div>
                <div id="">
                <div class="pad">
                ...
                <div id="trOddsHorseFixedInfo">
                  <div id="tdHorseFixedBgColor">
                    ...
                    <div id="divHorseFixKeepBetProcess" class="checkbox mag">
                      ...
                      <span id="HorseFixKeep"></span><a href="#" class="btnIcon right" title="<?=$lang_member[769];?>"><span class="icon-refresh"></span></a></div>
                  </div>
                </div>
...
<div class="numberPad-wrap" style="display:none">
	<ul class="numberPad" id="HorseBPstake_numberPad">
        ...
        <li><a href="javascript:void(0);" class="enter">enter</a></li>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabstyle02">
                <tr id="VR_tr1">
                  <th nowrap="nowrap"><?=$lang_member[930];?></th>
                  <td id="VRPayout"></td>
                </tr>
                  <tr id="VR_tr2" style="display:none">
                    <th nowrap="nowrap"><?=$lang_member[933];?></th>
              ...
              <div class="BetProcessBtnBox">
                <a id='Race_btnBPSubmit' style="cursor:pointer" type="submit" class="button mark" title="<?=$lang_member[931];?>"><span onclick="betSubmit('click');"><?=$lang_member[931];?></span></a> 
                <a style="cursor:pointer" type="button" onclick="javascript:ReloadWaitingBetList('yes','no','1');" class="button" title="<?=$lang_member[65];?>"><span><?=$lang_member[65];?></span></a> </div>
      ...
      <input type="hidden" id="oddChange1" name="oddChange1" value="<?=$lang_member[935];?>" />
      <input type="hidden" id="oddChange2" name="oddChange2" value="<?=$lang_member[936];?>" />
  ...
  <div id="BetProcessPhoneContainer" style="display:none">
    ...
    <form name="fomConfirmBetPhone" onsubmit="return formvalidationP('fomConfirmBetPhone');" method="post"  target="ifmConfirmBetPhone" autocomplete="off">
      ...
      <div id="BetProcessPhoneDataOT" class="REFRESH_menu"><span><?=$lang_member[758];?></span></div>
      <div class="account_body">
        <table width="95%" border="0" align="center" cellpadding="5" cellspacing="3" class="tab_border">
          ...
          <tr id="trlPayOut_P" bordercolor="#ECECEC">
            <td nowrap="nowrap"><?=$lang_member[930];?></td>
            <td bordercolor="#FBFFFF" class="text_black11" align="right" id="payOut_P"></td>
          </tr>
          <tr bordercolor="#ECECEC">
            <td nowrap="nowrap"><?=$lang_member[379];?></td>
            <td align="right" bordercolor="#FBFFFF" class="BetprocessMinBet">THB&nbsp; <span id="spMinBetValue_P"></span></td>
          </tr>
          <tr bordercolor="#ECECEC">
            <td height="22" class="td" nowrap="nowrap"><?=$lang_member[934];?></td>
            <td align="right" bordercolor="#FBFFFF" class="BetprocessMaxBet">THB&nbsp; <span id="spMaxBetValue_P"></span></td>
          </tr>
        </table>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center"><input id="btnBPSubmit_P" name="btnBPSubmit_P" type="submit" class="font11" value="<?=$lang_member[931];?>" />
              <input type="button" class="font11" value="<?=$lang_member[65];?>" onclick="javascript:ReloadWaitingBetList('yes','no');" /></td>
          </tr>
      ...
      <input type="hidden" id="oddChange1_P" name="oddChange1_P" value="<?=$lang_member[935];?>" />
      <input type="hidden" id="oddChange2_P" name="oddChange2_P" value="<?=$lang_member[936];?>" />
      ...
      <input type="hidden" id="lowerminmesg_P" name="lowerminmesg_P" value="<?=$lang_member[919];?>" />
      <input type="hidden" id="highermaxmesg_P" name="highermaxmesg_P" value="<?=$lang_member[920];?>" />
      <input type="hidden" id="areyousuremesg_P" name="areyousuremesg_P" value="<?=$lang_member[917];?>" />
      ...
      <input type="hidden" id="oddsWarning_P" name="oddsWarning_P" value="<?=$lang_member[942];?>" />
      <input type="hidden" id="betconfirmmesg_P" name="betconfirmmesg_P" value="<?=$lang_member[943];?>" />
  ...
  <div id="SuccessBetContainer" style="display:none">
    ...
    <div class="leftBoxbody">
      <div class="boxbg">
        <div class="BetInfo">
          <div class="TextStyle01 pad"><?=$lang_member[944];?> : <span id="su_spRefnoValue"></span><br />
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabstyle02">
            ...
            <tr>
              <th title="<?=$lang_member[938];?>"><?=$lang_member[938];?></th>
              <td><b id="su_spOddsValue"></b></td>
            </tr>
            <tr>
              <th title="<?=$lang_member[708];?>"><?=$lang_member[708];?></th>
              <td class="MaxBet"><b id="su_spChoiceValue"></b></td>
            </tr>
            <tr>
              <th title="<?=$lang_member[945];?>"><?=$lang_member[945];?></th>
              <td class="TextStyle07">THB&nbsp;<span id="su_spStakeValue"></span></td>
            </tr>
            <tr>
              <th title="<?=$lang_member[301];?>"><?=$lang_member[301];?></th>
              <td id="su_spStatusValue" class="MaxBet"></td>
            </tr>
            <tr>
              <th title="<?=$lang_member[948];?>"><?=$lang_member[948];?></th>
    ...
    <input type='hidden' name='successInfo1' id='successInfo1' value='<?=$lang_member[949];?>' />
    <input type='hidden' name='successInfo2' id='successInfo2' value='<?=$lang_member[950];?>' />
  ...
  <div id="div_MixParlay"  style="display:none">
    <form name="betform" id="betform" method="post" target="iframMixParlay" autocomplete="off">
      <div id="ParlayTitle" class="leftBoxTitle current"><span class="icon-arrow"></span><span  class="titleTxt"><?=$lang_member[755];?></span></div>
      <div class="leftBoxbody">
        <div class="boxbg multiple">
        <div id="noparlayinfo" style="background-color:#FFFFFF" class="BetInfo">
            <div class="TextStyle04"><?=$lang_member[888];?></div>	
        </div>
...
<td colspan="2"><div class="numberPad-wrap" style="display:none">
	<ul class="numberPad" id="stake_numberPad">
        ...
        <li><a href="javascript:void(0);" class="enter">enter</a></li>
            ...
            <tr>
              <th><span class="wrap"><?=$lang_member[933];?></span></th>
              <td>&nbsp;<span id="txtPayOut"></span></td>
            </tr>
            <tr>
              <th><span class="wrap"><?=$lang_member[379];?></span></th>
          ...
          <div id="parlay_bet_info2">
            <div class="BetProcessBtnBox">
              <div style="display:none"><input name="btnMPSubmit" type="text" value="<?=$lang_member[931];?>" class="Graybutton"/></div>
              <a id="btnMPSubmit" style="cursor:pointer" type="submit" class="button mark" title="<?=$lang_member[931];?>"><span onclick="betSubmitMP('click');"><?=$lang_member[931];?></span></a> 
              <a style="cursor:pointer" type="button" onclick="ClearParlay();" class="button" title="<?=$lang_member[65];?>"><span><?=$lang_member[65];?></span></a></div>
            ...
            <input type="hidden" name="yousuretobetmesg" value="<?=$lang_member[917];?>" />
            <input type="hidden" name="yousuretobetmesg1" value="Your previous bet is still processing, are you sure you want to bet ?" />
            <input type="hidden" name="morethan2" value="<?=$lang_member[918];?>" />
            <input type="hidden" name="lowermin" value="<?=$lang_member[919];?>" />
            <input type="hidden" name="highermax" value="<?=$lang_member[920];?>" />
            <input type="hidden" name="username"  />
          </div>
        </div>
      </div>
      <div class="account_foot"></div>
      <div class="Backmenu"><span class="icon-arrow"></span><a href="javascript:ReloadWaitingBetList('yes','no');"><?=$lang_member[923];?></a></div>
    </form>
  </div>
...
<div class="numberPad-wrap" style="display:none">
	<ul class="numberPad" id="Bingo_BPstake_numberPad">
        ...
        <li><a href="javascript:void(0);" class="enter">enter</a></li>
          ...
          <div class="BetProcessBtnBox">
            <div style="display:none"><input name="Bingo_btnBPSubmit" type="text" value="<?=$lang_member[931];?>" class="Graybutton"/></div>
            <a id="Bingo_btnBPSubmit" style="cursor:pointer" type="submit" class="button mark" title="<?=$lang_member[931];?>"><span onclick="betSubmitBingo('click');"><?=$lang_member[931];?></span></a> 
            <a style="cursor:pointer" type="button" onclick="javascript:ReloadWaitingBetList('yes','no','1');" class="button" title="<?=$lang_member[65];?>"><span><?=$lang_member[65];?></span></a> </div>
      ...
      <input type="hidden" id="Bingo_oddChange1" name="Bingo_oddChange1" value="<?=$lang_member[935];?>" />
      <input type="hidden" id="Bingo_oddChange2" name="Bingo_oddChange2" value="<?=$lang_member[936];?>" />
      ...
      <input type="hidden" id="Bingo_lowerminmesg" name="Bingo_lowerminmesg" value="<?=$lang_member[919];?>" />
      <input type="hidden" id="Bingo_highermaxmesg" name="Bingo_highermaxmesg" value="<?=$lang_member[920];?>" />
      <input type="hidden" id="Bingo_areyousuremesg" name="Bingo_areyousuremesg" value="<?=$lang_member[917];?>" />
      ...
      <input type="hidden" id="Bingo_incorrectStakeMesg" name="Bingo_incorrectStakeMesg" value="<?=$lang_member[947];?>" />
      <input type="hidden" id="Bingo_oddsWarning" name="Bingo_oddsWarning" value="<?=$lang_member[942];?>" />
      <input type="hidden" id="Bingo_betconfirmmesg" name="Bingo_betconfirmmesg" value="<?=$lang_member[943];?>" />
    ...
    <div id="Lucky3BetProcessContainer" style="display:none">
        ...
        <form name="fomLucky3ConfirmBet" method="post" target="ifmLucky3ConfirmBet" autocomplete="off" action="/lucky3/confirm_bet_data.php">
            <div class="leftBoxbody">
                    ...
                    <div id="Lucky3_BetInfo" class="BetInfo liveligh">
                        <div class="TextStyle01 pad">
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabstyle02">
                                <tbody>
                                    <tr>
                                        <th nowrap="nowrap"><?=$lang_member[937];?></th>
                ...
                <input type="hidden" id="Bingo_lowerminmesg" name="Lucky3_lowerminmesg" value="<?=$lang_member[919];?>" />
                <input type="hidden" id="Bingo_highermaxmesg" name="Lucky3_highermaxmesg" value="<?=$lang_member[920];?>" />
                <input type="hidden" id="Bingo_areyousuremesg" name="Lucky3_areyousuremesg" value="<?=$lang_member[917];?>" />
                ...
                <input type="hidden" id="Bingo_betconfirmmesg" name="Lucky3_betconfirmmesg" value="<?=$lang_member[943];?>" />
  ...
  <div id="div_BetListMini" style="display:none">
    <div class="leftBoxTitle" title="<?=$lang_member[708];?> (<?=$lang_member[940];?>)"><span class="icon-arrow"></span>
      <div id="BetListMiniRefreshIcon" class="btnIcon mark right" name="btnRefresh_BetListMini" onclick="ReloadBetListMini('no','no');" title="<?=$lang_member[769];?>"><span class="icon-refresh"></span></div>
      <span class="titleTxt"><?=$lang_member[708];?> (<?=$lang_member[940];?>)</span></div>
    <div class="leftBoxbody">
      <div class="boxbg">
        <div class="reSet">
            <a style="cursor:pointer" onclick="ReloadWaitingBetList('no','no')" class="button" title="<?=$lang_member[352];?>"><span><?=$lang_member[352];?></span></a> 
            <a style="cursor:pointer" onclick="ReloadVoidTicket('no')" class="button" title="<?=$lang_member[941];?>"><span><?=$lang_member[941];?></span></a></div>
  ...
  <div id="div_WaitingBets" style="">
    <div class="leftBoxTitle" title="<?=$lang_member[951];?>"><span class="icon-arrow"></span>
      <div id="WaitingBetRefreshIcon" class="btnIcon mark right" name="btnRefresh_WaitingBets" onclick="ReloadWaitingBetList('','no');" title="<?=$lang_member[769];?>"><span class="icon-refresh"></span></div>
      <span class="titleTxt"><?=$lang_member[951];?></span></div>
    <div class="leftBoxbody">
      <div class="boxbg">
        <div id="account" class="reSet"> 
            <a style="cursor:pointer" onclick="ReloadBetListMini('no','no')" class="button" title="<?=$lang_member[708];?> (<?=$lang_member[940];?>)"><span><?=$lang_member[708];?> (<?=$lang_member[940];?>)</span></a> 
            <a style="cursor:pointer" onclick="ReloadVoidTicket('no');" class="button" title="<?=$lang_member[941];?>"><span><?=$lang_member[941];?></span></a></div>
  ...
  <div id="div_VoidTicket" style="display:none">
    <div class="leftBoxTitle" title="<?=$lang_member[952];?>"><span class="icon-arrow"></span>
      <div id="VoidTicketRefreshIcon" class="btnIcon mark right" name="btnRefresh_VoidTicket" onclick="ReloadVoidTicket('no');" title="<?=$lang_member[769];?>"><span class="icon-refresh"></span></div>
      <span class="titleTxt"><?=$lang_member[952];?></span></div>
    <div class="leftBoxbody">
      <div class="boxbg">
        <div id="account" class="reSet"> 
        <a style="cursor:pointer" onclick="ReloadBetListMini('no','no');" class="button" title="<?=$lang_member[708];?> (<?=$lang_member[940];?>)"><span><?=$lang_member[708];?> (<?=$lang_member[940];?>)</span></a> 
        <a style="cursor:pointer" onclick="ReloadWaitingBetList('no','no');" class="button" title="<?=$lang_member[352];?>"><span><?=$lang_member[352];?></span></a></div>
  ...
  <?}else{?>
    <div style="display: none;">
      <div id="BettingModeContainer"></div>
      <div id="BetProcessContainer"></div>
      <div id="Betslip"></div>
      <div id="SuccessBetContainer"></div>
      <div id="MessageAlertContainer"></div>
      <div id="div_menu"></div>
      <div id="MenuContainer"></div>
      <div id="div_MixParlay"></div>
      <div id="div_WaitingBets"></div>
      <div id="div_VoidTicket"></div>
      <div id="div_BetListMini"></div>
    </div>
  <?}?>
