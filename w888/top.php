...
<script language="JavaScript" type="text/javascript">
	...
	$(() => {
	    ...
	    socket.on('datalist', function (data) {
			...
			try{
				parent.leftx.data_menu(arr_data);
				try{
					parent.rightx.data_ball(0 , arr_data);
				}catch(err){
	    	...
	    	setInterval(() => {
	    		$.post("ajax_check_token.php", {socketID: socket.id},function(data) {
	    			if(data.muc==1){
			    		...
			    		try{
			    			parent.rightx.loadTransferData();
			    		}catch(err){
...
#shtop{
	...
	background-image: -moz-linear-gradient(top, #003289, #0b5dea);
    background-image: -webkit-linear-gradient(top, #003289, #0b5dea);
    background-image: -o-linear-gradient(top, #003289, #0b5dea);
    background-image: -ms-linear-gradient(top, #003289, #0b5dea);
}
...
<body>  
    ...
    <nav>
 	<div id="connect_ico" class="filter"></div>
  	<ul id="mbutton">
  		<li><a href="#" onClick="go_rule();" id="link_rule"><?=$lang_member[42];?></a></li>
...
?>
	<ul>
        <li>
        	<a href="#" onClick="goMain('main_sport_new.php',this,'<?=$lang_member[35];?> : <?=$ok_bet[0]['n_note'];?>','message_football.php?s=6');" class="active" id="sport_menu_btn"><?=$lang_member[35];?> <img src="img/bg_m.png" class="img_active" style="display:block;"></a>
        </li>
        <li>
		...
		<li>
			<a href="#"  onClick="goMain('main_lothun.php',this,'<?=$lang_member[36];?> : <?=$ok_bet2[0]['n_note'];?>','message_lotto.php'); parent.leftx.flbet(1);" id="lothun_menu_btn"><?=$lang_member[48];?> <img src="img/bg_m.png" class="img_active"></a>
		</li>
        <li>
        	<a href="#" onClick="goMain('main_game.php',this,'<?=$lang_member[37];?> : <?=$ok_bet3[0]['n_note'];?>','message_game.php'); parent.leftx.flbet(1);" id="games_menu_btn"><?=$lang_member[37];?> <img src="img/bg_m.png" class="img_active"></a>
        </li>
        <li>
        	...
        	<a href="#" onClick="goMain('main_casino_list.php',this,'<?=$lang_member[38];?> : <?=$ok_bet4[0]['n_note'];?>','message_casino.php'); parent.leftx.flbet(1);" id="casino_menu_btn"><?=$lang_member[38];?> <img src="img/bg_m.png" class="img_active"></a>
        </li>
        <li>
        	<a href="#" onClick="goMain('main_transfer.php',this,'<?=$lang_member[35];?> : <?=$ok_bet[0]['n_note'];?>','message_football.php?s=6');" id="transfer_menu_btn"><?=$lang_member[39];?> <img src="img/bg_m.png" class="img_active"></a>
        </li>
        <li>
        	<a href="#"  onClick="goMain('main_affiliate.php',this,'<?=$lang_member[35];?> : <?=$ok_bet[0]['n_note'];?>','message_football.php?s=6');" id="affiliate_menu_btn"><?=$lang_member[49];?><img src="img/bg_m.png" class="img_active"></a>
        </li>
    </ul>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="height:26px; /*background:url(img/bg_top2.png);*/" class="top_time_bar">
  <tr>
