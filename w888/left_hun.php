...
function loadNowPlaying(){
  $("#tb_flotto").load("getFullLotto_hun.php");
}
...
function billPrintPopup(id) {
	// if(id == 3){
 //       newwindow=window.open("http://www.ohoking.com/print_bill_lotto_hun_lao.php?id="+id,"Lothun bill",'width=300px;');
	// }else{
       newwindow=window.open("http://www.ohoking.com/print_bill_lotto_hun.php?id="+id,"Lothun bill",'width=400,height=600');
	// }
...
<table width="185" border="0" cellspacing="1" cellpadding="5">
  <tr class="cw bg_table">
    <td align="center" colspan="3" style="cursor:pointer; border: 0!important;" onClick="$('#tb_blotto').toggle();"><strong><?=$lang_member[580];?></strong> [<?=$lang_member[92];?>]</td>
  </tr>
  <tbody class="cw" style="display:none;" id="tb_blotto">
...
$empay=@explode(',',$_SESSION['m1']['m_lotto_hun_pay1']); 	
$emdis=@explode(',',$_SESSION['m1']['m_lotto_hun_dis1']); 	
	}elseif($_SESSION['m1']['m_lotto_setbet']==2){
$empay=@explode(',',$_SESSION['m1']['m_lotto_hun_pay2']); 	
$emdis=@explode(',',$_SESSION['m1']['m_lotto_hun_dis2']); 	
	}else{
$empay=@explode(',',$_SESSION['m1']['m_lotto_hun_pay3']); 	
$emdis=@explode(',',$_SESSION['m1']['m_lotto_hun_dis3']); 	
	}

   	foreach ($lot_type[$_SESSION['lang']][3] as $x => $value) {
	  if($empay[$x]>0){ ?>
		<tr style="color:#000;">
		  <td align="center" valign="top" bgcolor="#FEFFFF" style="font-size:10px; "><?=$lot_type[$_SESSION['lang']][3][$x];?></td>
...
<table width="185" border="0" cellspacing="1" cellpadding="5" style="margin: auto; box-shadow: #000 0px 0px 1px; color: #FFF;" bgcolor="#6b4f11">
  <tr>
    <td colspan="5" align="center" class="bg_table"><strong><?=$lang_member[43];?></strong></td>
  </tr>
  <tr style="font-size:10px; cursor:pointer;">
    <td width="50%" align="center" valign="top" class="bg_table mb" onClick="menu_bet(1,1)" id="mb1"><strong><?=$lang_member[709];?></strong> <img src="img/bg_m.png" class="img_active3" id="mbl1"></td>
    <td width="50%" align="center" valign="top" class="bg_table mb mb_ac" onClick="menu_bet(2,1)" id="mb2"><strong><?=$lang_member[711];?></strong> <img src="img/bg_m.png" class="img_active3" id="mbl2"></td>
  </tr>
</table>
<div id="box_betlist">
