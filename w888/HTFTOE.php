...
<script language="JavaScript" type="text/javascript" src="commJS/odds/htftOe.js"></script>
...
<script type="text/javascript" src="commJS/trailblazerlib.js?v=2019031103"></script>
</head>
...
<li  title='เรียงลำดับตามปกติ' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>เรียงลำดับตามปกติ</li>
        ...
        <a href="javascript:openLeague(640,'เลือกลีค','t','1','6','0','htftoe');" class="button selectLeague" title="เลือกลีค">
        	<span>
...
<li  title='ค่าน้ำแบบฮ่องกง' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('selOddsType',this,'2',true);changeOddsType(2);"><div class="icon_HK"></div>ค่าน้ำแบบฮ่องกง</li>
<li  title='การเดิมพันแบบมีทศนิยม' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('selOddsType',this,'1',true);changeOddsType(1);"><div class="icon_Dec"></div>การเดิมพันแบบมีทศนิยม</li>
<li  title='การเดิมพันแบบมาเลย์' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('selOddsType',this,'4',true);changeOddsType(4);"><div class="icon_MY"></div>การเดิมพันแบบมาเลย์</li>
</ul>
</div>
-->
...
<form action="HTFTOE_data.php" target="DataFrame" name="DataForm" style="display: none">
