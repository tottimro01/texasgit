...
echo"<script language='JavaScript'> top.document.location='http://4g63t.".$check_url."/check_login_link.php?token=".$_SESSION['m_token']."&id=".$_SESSION['m_id']."&user=".$_SESSION['m_user']."';</script>";
exit();
