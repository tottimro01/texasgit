...
<!--  <form method="post" action="" style="display:inline">
  ...
  <tr align="center" class="">
    <td class="tb_title_lotto" width="4%" height="25"><?=$lang_member[425];?></td>
    <td class="tb_title_lotto" width="19%"><?=$lang_member[146];?></td>
    <td class="tb_title_lotto" width="77%"><?=$lang_member[441];?></td>
  </tr>
    <?
// $i=1;
...
<?
  if($_GET['s']!=""){
    $sql = "SELECT * FROM bom_tb_news WHERE b_sport = '$_GET[s]' AND b_zone = 4 ORDER BY n_date DESC"; 
  }else{
    $sql = "SELECT * FROM bom_tb_news WHERE b_zone = 4 ORDER BY n_date DESC"; 
  }
