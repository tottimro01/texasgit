...
<!-- <script>
  console.log(<?=$time_stam;?>)
      ...
      <!-- <div style="width: 40px; height: 40px; float: left;"><?=$_SESSION["name_hun"];?></div> -->
                      ...
                      <table width="300" border="0" align="center" cellpadding="0" cellspacing="1" class="txt_back11n bg_table">
                            ...
                            <tr>
                              <td height="22" align="center" class="bg_td">
								  <input name="num<?=$i?>" type="text" class="txt_center12b input" id="tab<?=$tab?>" size="7" maxlength="3" onKeyDown="return numberonly(event,this)" onKeyUp="next_enter(event,<?=$tab?>);">
								</td>
                               <td align="center" class="bg_td">
								   <? $tab=$tab+1?><? if($lot_pay_big5[4]>0){ ?>
								   <input name="col1<?=$i?>" type="text" class="txt_center12n input" id="tab<?=$tab?>" size="10" maxlength="6" onKeyDown="return numberonly(event,this)" onKeyUp="next_enter(event,<?=$tab?>);">
								   <? }?>
								</td>
                              <td align="center" class="bg_td">
								  <? $tab=$tab+1?><? if($lot_pay_big5[5]>0){ ?>
								  <input name="col2<?=$i?>" type="text" class="txt_center12n input" id="tab<?=$tab?>" size="10" maxlength="6" onKeyDown="return numberonly(event,this)" onKeyUp="next_enter(event,<?=$tab?>);">
								  <? }?>
								</td>
