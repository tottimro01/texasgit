...
'$view_date','$time_stam',now(),'".$_SESSION['m_id']."','"._bIP()."','$re_ok[ok_id]','$zone','$rob' , '$view_date_bingo','$_SESSION[r_agent_id]' ,'$b_web_from', '$bill_cus_name', '$bill_no','$re_m[bonus_m_id]' , '".$_SESSION['cr_id']."' ,'$af_lothun' ,'$setbet'
); ";
sql_query($sql);
