...
<?}?>
      ...
      <input name="col2money" type="button" class="btn_le" id="col2money" value="<?=$lang_member[525];?>" onClick="window.location.href='main_lothun.php?tlot=2ud&zone_send=<?=$_SESSION["zone_hun"];?>&rob_send=<?=$_SESSION["rob_hun"];?>&name_send=<?=$_SESSION["name_hun"];?>&vvw='+fw" style="width:100px;height:20px;cursor:pointer; margin-top:2px; margin-bottom:2px; line-height:10px; background:#f7c63c; float: left; margin-left: 10px; margin-top: 10px;">
       <input name="col2money" type="button" class="btn_le" id="col2money" value="<?=$lang_member[641];?>" onClick="window.location.href='main_lothun.php?tlot=2ud50&zone_send=<?=$_SESSION["zone_hun"];?>&rob_send=<?=$_SESSION["rob_hun"];?>&name_send=<?=$_SESSION["name_hun"];?>&vvw='+fw" style="width:100px;height:20px;cursor:pointer; margin-top:2px; margin-bottom:2px; line-height:10px; background:#f7c63c; float: left; margin-left: 10px; margin-top: 10px;">
      </td>
  </tr>
  <tr>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <table width="300" border="0" align="center" cellpadding="0" cellspacing="1" class="txt_back11n bg_table">
                            ...
                            <tr>
                              <td align="center"><input name="create_num" type="button" class="btn_le btn_small yellow w50px" id="create_num" value="<?=$lang_member[527];?>" onClick="create_nums()" ></td>
