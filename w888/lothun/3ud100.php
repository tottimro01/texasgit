...
<?}?>
      ...
      <input name="col2money" type="button" class="btn_le btn_small" value="<?=$lang_member[641];?>" onClick="window.location.href='main_lothun.php?tlot=2ud50&zone_send=<?=$_SESSION["zone_hun"];?>&rob_send=<?=$_SESSION["rob_hun"];?>&name_send=<?=$_SESSION["name_hun"];?>&vvw='+fw">
            </th>
