...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="txt_back11n bg_table">
  ...
  <tr align="center" class="tb_title_lotto">
    ...
    <td width="5%" rowspan="4"><?=$lang_member[699];?></td>
  </tr>
  <tr align="center" class="tb_title_lotto">
      <td width="40%" height="25" colspan="8"><?=$lang_member[697];?></td>
    </tr>
    <tr align="center" class="tb_title_lotto">
  ...
  <? $ipt = 0; 
    ...
    <td align="center" class="subtitle2"><b class="cbu">i<?=$io?></b></td>
      <td align="center" class="subtitle2"><?=$bingo['z2_r1_t2u'.$io.'i']?></td>
      <td align="center" class="subtitle2" bgcolor="#ccc"><?=$bingo['z2_r1_t2d'.$io.'i']?></td>
       <td align="center" class="subtitle2"><?=$bingo['z2_r2_t2u'.$io.'i']?></td>
      <td align="center" class="subtitle2" bgcolor="#ccc"><?=$bingo['z2_r2_t2d'.$io.'i']?></td>
       <td align="center" class="subtitle2"><?=$bingo['z2_r3_t2u'.$io.'i']?></td>
      <td align="center" class="subtitle2" bgcolor="#ccc"><?=$bingo['z2_r3_t2d'.$io.'i']?></td>
       <td align="center" class="subtitle2"><?=$bingo['z2_r4_t2u'.$io.'i']?></td>
      <td align="center" class="subtitle2" bgcolor="#ccc"><?=$bingo['z2_r4_t2d'.$io.'i']?></td>
