...
<?}?>
	  ...
	  <td>
         ...
         <table width="100%" cellspacing="2" cellpadding="0" class="lotto_open_table">
          <tr>
            <th width="50%">
		  <input name="col2money" type="button" class="btn_le btn_small" value="<?=$lang_member[644];?>" onClick="window.location.href='main_lothun.php?tlot=2ud&zone_send=<?=$_SESSION["zone_hun"];?>&rob_send=<?=$_SESSION["rob_hun"];?>&name_send=<?=$_SESSION["name_hun"];?>&vvw='+fw">
      <input name="col2money" type="button" class="btn_le btn_small" value="<?=$lang_member[487];?>" onClick="window.location.href='main_lothun.php?tlot=2ud100&zone_send=<?=$_SESSION["zone_hun"];?>&rob_send=<?=$_SESSION["rob_hun"];?>&name_send=<?=$_SESSION["name_hun"];?>&vvw='+fw">
            </th>
                  ...
                  <tbody>
                    <tr>
                      <td height="335" id="vdata"><table width="310" border="0" align="center" cellpadding="0" cellspacing="1" class="txt_back11n bg_table">
                            ...
                            <tr>
                              <td align="center"><input name="numcross" type="button" class="btn_le btn_small yellow w50px" id="numcross" value="<?=$lang_member[492];?>" onClick="fnumcrossx()" ></td>
                              <td align="center"><input name="col1money" type="button" class="btn_le btn_small yellow w50px" id="col1money" value="<?=$lang_member[371];?>" onClick="fcopymoney(1,'tab1')" ></td>
                              <td align="center"><input name="col2money" type="button" class="btn_le btn_small yellow w50px" id="col2money" value="<?=$lang_member[371];?>" onClick="fcopymoney(2,'tab2')" ></td>
                              <td align="center"><input name="col3money" type="button" class="btn_le btn_small yellow w50px" id="col3money" value="<?=$lang_member[371];?>" onClick="fcopymoney(3,'tab3')" ></td>
                              <td>&nbsp;</td>
                            </tr>
...
<input type="hidden" id="func" name="func">
                                ...
                                <input name="btreset" type="button" class="btn_le btn_small danger w60px" id="btreset" value="<?=$lang_member[374];?>" <?=$disabled?>  onClick="clear_txt();">
