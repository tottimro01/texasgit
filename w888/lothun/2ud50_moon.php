...
var myCountdown1 = new Countdown({
      ...
      <input name="col2money" type="button" class="btn_le" id="col2money" value="<?=$lang_member[487];?>" onClick="window.location.href='main_lothun.php?tlot=2ud100&zone_send=<?=$_SESSION["zone_hun"];?>&rob_send=<?=$_SESSION["rob_hun"];?>&vvw='+fw" style="width:100px;height:20px;cursor:pointer; margin-top:2px; margin-bottom:2px; line-height:10px; background:#f7c63c; float: left; margin-left: 10px; margin-top: 10px;">
      </td>
  </tr>
  <tr>
