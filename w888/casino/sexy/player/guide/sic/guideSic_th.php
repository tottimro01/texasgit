...
<body>
	<div class="game_guide" style="">
		<ul class="tag">
			<li id="guideTabGame">ซิกโบคลาสสิก</li>
		...
		<div class="con">
			...
			<div id="guide" class="con_inside">
				<div id="guideGame" style="display: none">
					<h3>ข้อมูลเกม</h3>
					<p>
						ซิคโบหรือไฮโลคือเกมที่เล่นด้วยลูกเต๋า3ลูก โดยที่ผู้เล่นจะต้องทายแต้มของลูกเต๋าหรือแต๋มรวมของลูกเต๋าทั้ง3ลูกวิธีการเล่นนั้นมีอยู่หลายวิธีและผู้เล่นยังสามารถเลือกแทงได้หลายครั้งพร้อมๆกัน
					</p>

					<h3>ใหญ่/เล็ก</h3>
					<p>
						การแทงใหญ่นั้นจะนับแต้มรวมของลูกเต๋าทั้ง3ลูกให้อยู่ระหว่าง 11-17 แต้ม
						การแทงเล็กนั้นจะนับแต้มรวมของลูกเต๋าทั้ง3ลูกให้อยู่ระหว่าง 4-10แต้ม
						หากคะแนนรวมออกมาเป็น 3 หรือ 18 จะไม่ถูกนับ 
						ในกรณีที่เลขบนเต๋าทั้ง3ลูกเป็นเลขเดียวกันทั้งหมด ทั้งใหญ่และเล็กจะไม่ถูกนับว่าชนะ
					</p>

					<h3>คี่/คู่</h3>
					<p>
						การแทง คี่/คู่คือการแทงแต้มรวมของลูกเต๋าทั้ง3ว่าจะออกมาเป็นเลข คี่หรือคู่ หากแต้มรวมออกมาเป็น 5,7,9,11,13,15,17 จะถูกนับว่าเป็นเลขคี่ ในขณะที่ถ้าแต้มรวมออกมาเป็น 4,6,8,10,12,14,16 จะถูกนับว่าเป็นเลขคู่
					</p>
					...
					<h3>ตองเฉพาะ</h3>
					<p>
						ผู้เล่นสามารถเดิมพันเลขตองได้ เช่นถ้าแทงตอง 5ผู้เล่นจะชนะการเดิมพันเมื่อลูกเต๋าออก 5 ทั้ง 3ลูก
					</p>
					...
					<table>
						...
						<tbody>
							...
							<tr>
								<td>ใหญ่</td>
								<td> แต้มรวม 11ถึง17 ไม่นับเลขตอง</td>
								<td>1:1</td>
							</tr>
							<tr>
								<td>เล็ก</td>
							...
							<tr>
								<td>คี่</td>
								<td>แต้มรวม 5, 7, 9, 11, 13, 15, 17 ไม่นับเลขตอง</td>
								<td>1:1</td>
							</tr>
							<tr>
								<td>คู่</td>
								<td>แต้มรวม4, 6, 8, 10, 12, 14, 16 ไม่นับเลขตอง</td>
								<td>1:1</td>
							</tr>
							<tr>
								<td>4 หรือ 17</td>
								<td>แต้มรวม  4 หรือ 17</td>
								<td>1:50</td>
							</tr>
							<tr>
								<td>5 หรือ 16</td>
								<td>แต้มรวม 5 หรือ 16</td>
								<td>1:18</td>
							</tr>
							<tr>
								<td>6 หรือ 15</td>
								<td>แต้มรวม 6 หรือ 15</td>
								<td>1:14</td>
							</tr>
							<tr>
								<td>7 หรือ 14</td>
