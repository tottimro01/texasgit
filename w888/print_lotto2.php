...
foreach ($lot_type[$_SESSION['lang']][1][1] as $x => $value) {  
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class=" txt10">
       ...
       <tr align="center" >
          <td width="30%" align="center" ><?=$lang_member[381];?> <img src="img/arrow-down.png" height="14" ></td>
          <td width="70%" align="center" ><?=$lang_member[563];?> </td>
        </tr>
