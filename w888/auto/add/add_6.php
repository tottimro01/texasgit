...
#################Lang
$arr_lang=array("th","cs","id","ko");
foreach($arr_lang as $lang){
$data=file_get_contents2($server_lang."".$lang.".html?nocache=".urlencode(date("Y-m-d H:i:s")));
include('lang.php');
}


file_get_contents2($server_maxbet_lang."lang.php");
#################Lang Maxbet
$arr_lang=array("th","ch","zhcn","jp","ko","vn","id","mm","en");
foreach($arr_lang as $lang){
 $data=file_get_contents2($server_maxbet_lang."txt/sportsbook_".$lang.".html?nocache=".urlencode(date("Y-m-d H:i:s")));
include('lang_maxbet.php');
}
