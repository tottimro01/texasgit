...
//alert(txt_la);
	$(this).load("ajax_zone.php",{"en":txt_en,"th":txt_th,"my":txt_my,"la":txt_la,"add":"my","by":by });
	$(this).load("ajax_zone.php",{"en":txt_en,"th":txt_th,"my":txt_my,"la":txt_la,"add":"la","by":by });
	$("#saveok_"+id).html("");
	}
...
while($rs=sql_fetch($re)){
  ...
  <tr>
   ...
   <td><input name="txt_my_<?=$x;?>" type="text" id="txt_my_<?=$x;?>"  style="width:100%" value="<?=$rs[my];?>" readonly="readonly" /></td>
