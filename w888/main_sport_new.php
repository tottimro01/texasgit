...
$page_zone = ($_GET["zone"]=="" ? 6 : $_GET["zone"]);
$page_live = ($_GET["live"]=="" ? 0 : $_GET["live"]);
$r_open_live = 1;
$m_open_live = 1;
foreach($_SESSION['arid'] as $rid){
  ...
  if($r_open_page[1]==0 && $r_open_page[2]==0 && $r_open_page[3]==0 && $r_open_page[4]==0 && $r_open_page[5]==0 && $r_open_page[6]==0 ){ 
    include 'ag_close.php'; 
    exit(); 
  } 
  if($page_zone==6){
    if($r_open_page[1]==0 && $r_open_page[2]==0){
      include 'ag_close.php'; 
      exit(); 
    }else if($r_open_page[1]==0 && $page_live==0){
      include 'ag_close.php'; 
      exit(); 
    }else if($r_open_page[2]==0 && $page_live==1){
      include 'ag_close.php'; 
      exit(); 
    }
    ...
    if($r_open_page[5]==0 && $r_open_page[6]==0){
      include 'ag_close.php'; 
      exit(); 
    }else if($r_open_page[5]==0 && $page_live==0){
      include 'ag_close.php'; 
      exit(); 
    }else if($r_open_page[6]==0 && $page_live==1){
      include 'ag_close.php'; 
      exit(); 
    }
  ...
  }else if($page_zone!=1 && $page_zone!=6){
    if($r_open_page[3]==0 && $r_open_page[4]==0){
      include 'ag_close.php'; 
      exit(); 
    }else if($r_open_page[3]==0 && $page_live==0){
      include 'ag_close.php'; 
      exit(); 
    }else if($r_open_page[4]==0 && $page_live==1){
      include 'ag_close.php'; 
      exit(); 
    }
...
if($m_open_page[1]==0 && $m_open_page[2]==0 && $m_open_page[3]==0 && $m_open_page[4]==0 && $m_open_page[5]==0 && $m_open_page[6]==0){ 
  include 'ag_close.php'; 
  exit(); 
}

if($page_zone==6){
  if($m_open_page[1]==0 && $m_open_page[2]==0){
    include 'ag_close.php'; 
    exit(); 
  }else if($m_open_page[1]==0 && $page_live==0){
    include 'ag_close.php'; 
    exit(); 
  }else if($m_open_page[2]==0 && $page_live==1){
    include 'ag_close.php'; 
    exit(); 
  }
  ...
  if($m_open_page[5]==0 && $m_open_page[6]==0){
    include 'ag_close.php'; 
    exit(); 
  }else if($m_open_page[5]==0 && $page_live==0){
    include 'ag_close.php'; 
    exit(); 
  }else if($m_open_page[6]==0 && $page_live==1){
    include 'ag_close.php'; 
    exit(); 
  }
  ...
  if($m_open_page[3]==0 && $m_open_page[4]==0){
    include 'ag_close.php'; 
    exit(); 
  }else if($m_open_page[3]==0 && $page_live==0){
    include 'ag_close.php'; 
    exit(); 
  }else if($m_open_page[4]==0 && $page_live==1){
    include 'ag_close.php'; 
    exit(); 
  }
...
<div id="column1" class="titleBar">
  ...
  <div class="title"><?=$sport_type_today[$_GET["zone"]]?></div>
    <div class="right">
...
var r_open_live = <?=$r_open_live?>;
var m_open_live = <?=$m_open_live?>;
  ...
  if(wl==1){
    ...
    if (JSON.stringify(arr_data) != JSON.stringify(old_arr_data) || ci == 1) {
      ...
      var list_ball_live = [];
        ...
        if((data_ball[k]["b_live"]==1 || data_ball[k]["b_live"]==2 || data_ball[k]["b_live"]==3) && data_ball[k]["b_zone"]==page_zone && r_open_live==1 && m_open_live==1 && sa_open_live==1){
          ...
          if(data_ball[k]["b_add"]!=1 && (data_ball[k]["b_hdc"]==0 && data_ball[k]["b_hdc_1"]==0 && data_ball[k]["b_hdc_2"]==0) && (data_ball[k]["b_goal"]==0 && data_ball[k]["b_goal_1"]==0 && data_ball[k]["b_goal_2"]==0) && (data_ball[k]["b_1x2_1"]==0 && data_ball[k]["b_1x2_2"]==0) && (data_ball[k]["b_odd"]==0 && data_ball[k]["b_even"]==0) && (data_ball[k]["b_1h_hdc"]==0 && data_ball[k]["b_1h_hdc_1"]==0 && data_ball[k]["b_1h_hdc_2"]==0) && (data_ball[k]["b_1h_goal"]==0 && data_ball[k]["b_1h_goal_1"]==0 && data_ball[k]["b_1h_goal_2"]==0) && (data_ball[k]["b_1h_1x2_1"]==0 && data_ball[k]["b_1h_1x2_2"]==0) && (data_ball[k]["b_1h_odd"]==0 && data_ball[k]["b_1h_even"]==0)){
            ...
            //if((page_show==1 && ((data_ball[k]["b_hdc"]!="" && data_ball[k]["b_hdc_1"]!="" && data_ball[k]["b_hdc_2"]!="") || (data_ball[k]["b_goal"]!="" && data_ball[k]["b_goal_1"]!="" && data_ball[k]["b_goal_2"]!="") || (data_ball[k]["b_1x2_1"]>0 && data_ball[k]["b_1x2_x"]>0 && data_ball[k]["b_1x2_2"]>0) || (data_ball[k]["b_1h_hdc"]!="" && data_ball[k]["b_1h_hdc_1"]!="" && data_ball[k]["b_1h_hdc_2"]!="") || (data_ball[k]["b_1h_goal"]!="" && data_ball[k]["b_1h_goal_1"]!="" && data_ball[k]["b_1h_goal_2"]!="") || (data_ball[k]["b_1h_1x2_1"]>0 && data_ball[k]["b_1h_1x2_x"]>0 && data_ball[k]["b_1h_1x2_2"]>0))) || (page_show==2 && ((data_ball[k]["b_1x2_1"]>0 && data_ball[k]["b_1x2_x"]>0 && data_ball[k]["b_1x2_2"]>0) || (data_ball[k]["b_1h_1x2_1"]>0 && data_ball[k]["b_1h_1x2_x"]>0 && data_ball[k]["b_1h_1x2_2"]>0))) || (page_show==3 && ((data_ball[k]["b_odd"]!=0 && data_ball[k]["b_even"]!=0) || (data_ball[k]["b_1h_odd"]!=0 && data_ball[k]["b_1h_even"]!=0)))){
              ...
              if((page_show==3 && data_ball[k]["b_add"]!=1) || (page_show==2 && data_ball[k]["b_add"]!=1)){
                continue;
              }
...
function header_tb(){
  ...
  if(page_show==2){
    ...
    if(dp_mode=="1"){
      ...
      return header1rowsFT(); 
    }else if(dp_mode=="1H"){
      return header1rowsHT(); 
    }else{
      return header2rows();
    }
  }
...
function ball_td(ball_data , old_data){
  if(page_show==2){
    ...
    if(dp_mode=="1"){
      ...
      return td1rowsFT(ball_data , old_data , dp_mode);    
      ...
      return td1rowsHT(ball_data , old_data , dp_mode); 
    }else if(dp_mode=="3"){
