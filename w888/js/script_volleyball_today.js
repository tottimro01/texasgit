...
var _c=15;
var _t;
function Today_Volleyball_List(){
	c=91;
	_c=15;
	clearTimeout(t);
	clearTimeout(_t);
	...
	VolleyballToday.location="data/sport_data.php?sc=vbt&t="+Math.random();
}
...
function load_today(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/volleyball_today_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/volleyball_today_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/volleyball_today_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/volleyball_today_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/volleyball_today_1x2.php?t="+Math.random();
	}else if(file_req==6){
		url = "inc/volleyball_today_kk.php?t="+Math.random();
	}
	$.ajax({
		type: "POST",
		url: url,
...
function Today_Volleyball_Refresh(){ 
	if(document.getElementById("main_today").innerHTML != ""){
		VolleyballTodayRefresh.location ="data/sport_data.php?sc=vbtr&t="+Math.random();
	}	
}
