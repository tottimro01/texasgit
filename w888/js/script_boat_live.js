...
function Live_Boat_List(){
	...
	BoatLive.location="data/boat_live.php?t="+Math.random();
}
...
function load_live(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/boat_live_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/boat_live_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/boat_live_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/boat_live_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/boat_live_1x2.php?t="+Math.random();
	}
...
function Live_Boat_Refresh(){ 
	if(document.getElementById("main_live").innerHTML != ""){
		BoatLiveRefresh.location ="data/boat_live_refresh.php?t="+Math.random();
	}	
}
