...
function Today_Bat_List(){
	...
	BatToday.location="data/sport_data.php?sc=btt&t="+Math.random();
}
...
function load_today(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/bat_today_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/bat_today_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/bat_today_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/bat_today_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/bat_today_1x2.php?t="+Math.random();
	}else if(file_req==6){
		url = "inc/bat_today_kk.php?t="+Math.random();
	}
	$.ajax({
		type: "POST",
		url: url,
...
function Today_Bat_Refresh(){ 
	if(document.getElementById("main_today").innerHTML != ""){
		BatTodayRefresh.location ="data/sport_data.php?sc=bttr&t="+Math.random();
	}	
}
