...
function Live_Basketball_List(){
	...
	BasketballLive.location="data/sport_data.php?sc=bkl&t="+Math.random();
}
...
function load_live(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/line_data.php?sc=bkl1l&t="+Math.random();
	}else if(file_req==2){
		url = "inc/line_data.php?sc=bkl2l&t="+Math.random();
	}else if(file_req==3){
		url = "inc/line_data.php?sc=bklft&t="+Math.random();
	}else if(file_req==4){
		url = "inc/line_data.php?sc=bkl1h&t="+Math.random();
	}else if(file_req==5){
		url = "inc/line_data.php?sc=bkl1x2&t="+Math.random();
	}
...
function timedCount2(lv)
{
	...
	if (c2 <= 0){ 
		...
		if((c2==10 || c2==20) && lv == 1){ 
			Live_Basketball_Refresh(); 
		}
	}
}

function Live_Basketball_Refresh(){ 
	if(document.getElementById("main_live").innerHTML != ""){
		BasketballLiveRefresh.location ="data/sport_data.php?sc=bklr&t="+Math.random();
	}	
}
