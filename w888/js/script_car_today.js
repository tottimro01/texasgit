...
function Today_Car_List(){
	...
	CarToday.location="data/sport_data.php?sc=cat&t="+Math.random();
}
...
function load_today(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/car_today_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/car_today_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/car_today_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/car_today_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/car_today_1x2.php?t="+Math.random();
	}else if(file_req==6){
		url = "inc/car_today_kk.php?t="+Math.random();
	}
	$.ajax({
		type: "POST",
		url: url,
...
function Today_Car_Refresh(){ 
	if(document.getElementById("main_today").innerHTML != ""){
		CarTodayRefresh.location ="data/sport_data.php?sc=catr&t="+Math.random();
	}	
}
