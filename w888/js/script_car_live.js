...
function Live_Car_List(){
	...
	CarLive.location="data/sport_data.php?sc=cal&t="+Math.random();
}
...
function load_live(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/car_live_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/car_live_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/car_live_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/car_live_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/car_live_1x2.php?t="+Math.random();
	}
...
function Live_Car_Refresh(){ 
	if(document.getElementById("main_live").innerHTML != ""){
		CarLiveRefresh.location ="data/sport_data.php?sc=calr&t="+Math.random();
	}	
}
