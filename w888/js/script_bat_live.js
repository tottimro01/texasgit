...
function Live_Bat_List(){
	...
	BatLive.location="data/sport_data.php?sc=btl&t="+Math.random();
}
...
function load_live(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/bat_live_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/bat_live_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/bat_live_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/bat_live_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/bat_live_1x2.php?t="+Math.random();
	}
...
function Live_Bat_Refresh(){ 
	if(document.getElementById("main_live").innerHTML != ""){
		BatLiveRefresh.location ="data/sport_data.php?sc=btlr&t="+Math.random();
	}	
}
