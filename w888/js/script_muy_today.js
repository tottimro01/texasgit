...
function Today_Muy_List(){
	...
	MuyToday.location="data/sport_data.php?sc=mtt&t="+Math.random();
}
...
function load_today(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/muy_today_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/muy_today_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/muy_today_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/muy_today_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/muy_today_1x2.php?t="+Math.random();
	}else if(file_req==6){
		url = "inc/muy_today_kk.php?t="+Math.random();
	}
	$.ajax({
		type: "POST",
		url: url,
...
function Today_Muy_Refresh(){ 
	if(document.getElementById("main_today").innerHTML != ""){
		MuyTodayRefresh.location ="data/sport_data.php?sc=mttr&t="+Math.random();
	}	
}
