...
function Live_Cock_List(){
	...
	CockLive.location="data/sport_data.php?sc=col&t="+Math.random();
}
...
function load_live(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/cock_live_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/cock_live_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/cock_live_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/cock_live_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/cock_live_1x2.php?t="+Math.random();
	}
...
function Live_Cock_Refresh(){ 
	if(document.getElementById("main_live").innerHTML != ""){
		CockLiveRefresh.location ="data/sport_data.php?sc=colr&t="+Math.random();
	}	
}
