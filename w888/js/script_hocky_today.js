...
function Today_Hocky_List(){
	...
	HockyToday.location="data/sport_data.php?sc=hkt&t="+Math.random();
}
...
function load_today(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/hocky_today_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/hocky_today_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/hocky_today_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/hocky_today_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/hocky_today_1x2.php?t="+Math.random();
	}else if(file_req==6){
		url = "inc/hocky_today_kk.php?t="+Math.random();
	}
	$.ajax({
		type: "POST",
		url: url,
...
function Today_Hocky_Refresh(){ 
	if(document.getElementById("main_today").innerHTML != ""){
		HockyTodayRefresh.location ="data/sport_data.php?sc=hktr&t="+Math.random();
	}	
}
