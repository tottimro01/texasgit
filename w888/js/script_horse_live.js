...
function Live_Horse_List(){
	...
	HorseLive.location="data/sport_data.php?sc=hol&t="+Math.random();
}
...
function load_live(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/horse_live_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/horse_live_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/horse_live_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/horse_live_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/horse_live_1x2.php?t="+Math.random();
	}
...
function Live_Horse_Refresh(){ 
	if(document.getElementById("main_live").innerHTML != ""){
		HorseLiveRefresh.location ="data/sport_data.php?sc=holr&t="+Math.random();
	}	
}
