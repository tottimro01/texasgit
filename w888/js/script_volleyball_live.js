...
function Live_Volleyball_List(){
	...
	VolleyballLive.location="data/sport_data.php?sc=vbl&t="+Math.random();
}
...
function load_live(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/volleyball_live_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/volleyball_live_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/volleyball_live_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/volleyball_live_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/volleyball_live_1x2.php?t="+Math.random();
	}
...
function Live_Volleyball_Refresh(){ 
	if(document.getElementById("main_live").innerHTML != ""){
		VolleyballLiveRefresh.location ="data/sport_data.php?sc=vblr&t="+Math.random();
	}	
}
