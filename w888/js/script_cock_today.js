...
function Today_Cock_List(){
	...
	CockToday.location="data/sport_data.php?sc=cot&t="+Math.random();
}
...
function load_today(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/cock_today_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/cock_today_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/cock_today_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/cock_today_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/cock_today_1x2.php?t="+Math.random();
	}else if(file_req==6){
		url = "inc/cock_today_kk.php?t="+Math.random();
	}
	$.ajax({
		type: "POST",
		url: url,
...
function Today_Cock_Refresh(){ 
	if(document.getElementById("main_today").innerHTML != ""){
		CockTodayRefresh.location ="data/sport_data.php?sc=cotr&t="+Math.random();
	}	
}
