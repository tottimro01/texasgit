...
function Live_Ball_List(){
	...
	BallLive.location="data/sport_data.php?sc=fbl&t="+Math.random();
}
...
function load_live(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/line_data.php?sc=fbl1l&t="+Math.random();
	}else if(file_req==2){
		url = "inc/line_data.php?sc=fbl2l&t="+Math.random();
	}else if(file_req==3){
		url = "inc/line_data.php?sc=fblft&t="+Math.random();
	}else if(file_req==4){
		url = "inc/line_data.php?sc=fbl1h&t="+Math.random();
	}else if(file_req==5){
		url = "inc/line_data.php?sc=fbl1x2&t="+Math.random();
	}
...
function Live_Ball_Refresh(){ 
	if(document.getElementById("main_live").innerHTML != ""){
		BallLiveRefresh.location ="data/sport_data.php?sc=fblr&t="+Math.random();
	}	
}
