...
function Today_Ball_List(){
	...
	BallToday.location="data/sport_data.php?sc=fbt&t="+Math.random();
}
...
function load_today(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/line_data.php?sc=fbt1l&t="+Math.random();
	}else if(file_req==2){
		url = "inc/line_data.php?sc=fbt2l&t="+Math.random();
	}else if(file_req==3){
		url = "inc/line_data.php?sc=fbtft&t="+Math.random();
	}else if(file_req==4){
		url = "inc/line_data.php?sc=fbt1h&t="+Math.random();
	}else if(file_req==5){
		url = "inc/line_data.php?sc=fbt1x2&t="+Math.random();
	}else if(file_req==6){
		url = "inc/line_data.php?sc=fbtoe&t="+Math.random();
	}
	$.ajax({
		type: "POST",
		url: url,
...
function Today_Ball_Refresh(){ 
	if(document.getElementById("main_today").innerHTML != ""){
		BallTodayRefresh.location ="data/sport_data.php?sc=fbtr&t="+Math.random();
	}	
}
