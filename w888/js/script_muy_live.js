...
function Live_Muy_List(){
	...
	MuyLive.location="data/sport_data.php?sc=mtl&t="+Math.random();
}
...
function load_live(file_req , nload){
	var url;
	if(file_req==1){
		url = "inc/muy_live_singleLine.php?t="+Math.random();
	}else if(file_req==2){
		url = "inc/muy_live_twoLine.php?t="+Math.random();
	}else if(file_req==3){
		url = "inc/muy_live_fullTime.php?t="+Math.random();
	}else if(file_req==4){
		url = "inc/muy_live_halfTime.php?t="+Math.random();
	}else if(file_req==5){
		url = "inc/muy_live_1x2.php?t="+Math.random();
	}
...
function Live_Muy_Refresh(){ 
	if(document.getElementById("main_live").innerHTML != ""){
		MuyLiveRefresh.location ="data/sport_data.php?sc=mtlr&t="+Math.random();
	}	
}
