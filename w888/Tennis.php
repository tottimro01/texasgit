...
<?  
   $sportID = ($_GET['Sport']=="") ? 44 : $_GET['Sport'];
    switch ($sportID) {
        case 44:  $sportName = $lang_sport[2];     break;
        case 4:   $sportName = $lang_sport[10];  break;
        case 5:   $sportName = $lang_sport[3];      break;
        case 9:   $sportName = $lang_sport[4];   break;
        case 6:   $sportName = $lang_sport[5];  break;
        case 24:  $sportName = $lang_sport[6];   break;
        case 14:  $sportName = $lang_sport[11];          break;
        case 16:  $sportName = $lang_sport[12];          break;
        default:  $sportName = "";          break;
    }

    $_sportMarket = $_GET['Market'];
    switch (strtolower($_sportMarket)) {
        case 'e': $_sportTitle = $sportName . " / " . $lang_sport[64];   break;
        case 't': $_sportTitle = $sportName . " / " . $lang_sport[108];break;
...
var RES_ODD = '<?=$lang_sport[19];?>';
var RES_EVEN = '<?=$lang_sport[20];?>';
...
var RES_MORE_UNDER='<?=$lang_sport[21];?>';
var RES_MORE_OVER='<?=$lang_sport[22];?>';
var RES_MORE_ODD='<?=$lang_sport[19];?>';
var RES_MORE_EVEN='<?=$lang_sport[20];?>';
var RES_MORE_YES="Yes";
var RES_MORE_NO="No";
var RES_MORE_NOTIEBREAK="No Tiebreak";
var RES_MORE_NEITHER='<?=$lang_sport[26];?>';
...
var RES_CloseBanner = '<?=$lang_sport[39];?>';
</script>
...
<body id="Tennis" class="dummy<?=$sportID;?>" onload="OverWriteFormSubmit();refreshAll();checkHasParlay('t','<?=$sportID;?>'); fFrame.leftx._setDefaultOddsType();">
...
<div class="titleBar">
    ...
    <div class="right">
        <a id="b_SwitchToParlay" href="javascript:SwitchToParlay('<?=$sportID;?>');" class="button mark" style="display:none" title="<?=$lang_sport[60];?>"><span><?=$lang_sport[60];?></span></a>
...
<ul id="aSorter_menu" class="submenu">
  ...
  <li  title='<?=$lang_sport[24];?>' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div><?=$lang_sport[24];?></li>
        ...
        <a href="javascript:openLeague(640,'<?=$lang_sport[31];?>','t','<?=$sportID;?>','1,2,3,20','0','Tennis');" class="button selectLeague" title="<?=$lang_sport[31];?>">
            <span>
...
<li  title='<?=$lang_sport[107];?>' onmouseover="onOver(this)" class="oddsLI-2" onmouseout="onOut(this)" onclick="setSelecter('selOddsType',this,'2',true);changeOddsType(2);"><div class="icon_HK"></div><?=$lang_sport[107];?></li>
<li  title='<?=$lang_sport[106];?>' onmouseover="onOver(this)" class="oddsLI-1" onmouseout="onOut(this)" onclick="setSelecter('selOddsType',this,'1',true);changeOddsType(1);"><div class="icon_Dec"></div><?=$lang_sport[106];?></li>
<li  title='<?=$lang_sport[105];?>' onmouseover="onOver(this)" class="oddsLI-4" onmouseout="onOut(this)" onclick="setSelecter('selOddsType',this,'4',true);changeOddsType(4);"><div class="icon_MY"></div><?=$lang_sport[105];?></li>
</ul>
</div>  
...
<!-- <script>console.log(fFrame.LastSelectedSport, '<?=$_GET[Sport];?>')</script> -->
<?
...
?>
<form action="Tennis_data.php" target="DataFrame_L" name="DataForm_L" style="display: none">
    <input type="hidden" name="Sport" value="<?=$sportID;?>" />
    <!-- <input type="hidden" name="Sport" value="44" /> -->
...
<form action="Tennis_data.php" target="DataFrame_D" name="DataForm_D" style="display: none">
    <input type="hidden" name="Sport" value="<?=$sportID;?>" />
    <!-- <input type="hidden" name="Sport" value="44" /> -->
