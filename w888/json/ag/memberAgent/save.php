...
//////////////////////  set format data ////////////////// 
			...
			$sql="INSERT IGNORE INTO  bom_tb_agent (r_open,r_name,	r_phone,r_user,	r_pass,	r_level , r_regis, r_count,r_agent_id,r_sport_share,r_sport_share_live,r_sport_force,r_sport_force_live,r_sport_dis,r_sport_max,r_sport_min,r_sport_step_max,r_sport_step_min,r_sport_nam_tor,r_sport_nam_rong,r_sport_step_day,r_sport_step_paymax,r_sport_step2,r_sport_step_dis,r_lotto_share,r_lotto_force,r_lotto_myshare,r_lotto_open,r_lotto_pay1,r_lotto_dis1,r_lotto_pay2,r_lotto_dis2,r_lotto_pay3,r_lotto_dis3,r_lotto_hun_share,r_lotto_hun_force,r_lotto_hun_myshare,r_lotto_hun_open,r_lotto_hun_pay1,r_lotto_hun_dis1,r_lotto_hun_pay2,r_lotto_hun_dis2,r_lotto_hun_pay3,r_lotto_hun_dis3,r_lotto_hun_set_pay,r_lotto_hun_set_price,r_games_share,r_games_force,r_games_myshare,r_games_dis,r_casino_share,r_casino_force,r_casino_myshare,r_casino_max) values ('$r_open','$name','$phone','$user','$pass',$r_level,now(),$_count,'$r_agent_id','$set_r_sport_share','$set_r_sport_share_live','$set_r_sport_myshare','$set_r_sport_myshare_live','$set_r_sport_dis','$set_r_sport_max','$set_r_sport_min','$set_r_sport_step_max','$set_r_sport_step_min','$set_r_sport_nam_tor','$set_r_sport_nam_rong','$set_r_sport_step_day','$set_r_sport_step_paymax','$set_r_sport_step2','$set_r_sport_step_dis','$set_r_lotto_share','$set_r_lotto_force','$set_r_lotto_myshare','$r_lotto_open','$set_r_lotto_pay1','$set_r_lotto_dis1','$set_r_lotto_pay2','$set_r_lotto_dis2','$set_r_lotto_pay3','$set_r_lotto_dis3','$set_r_lotto_hun_share','$set_r_lotto_hun_force','$set_r_lotto_hun_myshare','$r_lotto_hun_open','$set_r_lotto_hun_pay1','$set_r_lotto_hun_dis1','$set_r_lotto_hun_pay2','$set_r_lotto_hun_dis2','$set_r_lotto_hun_pay3','$set_r_lotto_hun_dis3','$set_r_lotto_hun_set_pay','$set_r_lotto_hun_set_price','$set_r_games_share','$set_r_games_force','$set_r_games_myshare','$set_r_games_dis','$set_r_casino_share','$set_r_casino_force','$set_r_casino_myshare','$set_r_casino_max')";



// 			$sql="INSERT IGNORE INTO  bom_tb_agent (r_open,r_name,	r_phone,r_user,	r_pass,	r_level , r_regis, r_count,r_agent_id,r_sport_share,r_sport_share_live,r_sport_force,r_sport_force_live,r_sport_dis,r_sport_max,r_sport_min,r_sport_step_max,r_sport_step_min,r_sport_nam_tor,r_sport_nam_rong,r_sport_step_day,r_sport_step_paymax,r_sport_step2,r_sport_step_dis,r_lotto_share,r_lotto_force,r_lotto_myshare,r_lotto_pay1,r_lotto_dis1,r_lotto_hun_share,r_lotto_hun_force,r_lotto_hun_myshare,r_lotto_hun_pay1,r_lotto_hun_dis1,r_lotto_hun_set_pay,r_lotto_hun_set_price,r_games_share,r_games_force,r_games_myshare,r_games_dis,r_casino_share,r_casino_force,r_casino_myshare,r_casino_max) values ('$r_open','$name','$phone','$user','$pass',$r_level,now(),$_count,'$r_agent_id','$set_r_sport_share','$set_r_sport_share_live','$set_r_sport_myshare','$set_r_sport_myshare_live','$set_r_sport_dis','$set_r_sport_max','$set_r_sport_min','$set_r_sport_step_max','$set_r_sport_step_min','$set_r_sport_nam_tor','$set_r_sport_nam_rong
// ','$set_r_sport_step_day','$set_r_sport_step_paymax','$set_r_sport_step2','$set_r_sport_step_dis','$set_r_lotto_share','$set_r_lotto_force','$set_r_lotto_myshare','$set_r_lotto_pay1','$set_r_lotto_dis1','$set_r_lotto_hun_share','$set_r_lotto_hun_force','$set_r_lotto_hun_myshare','$set_r_lotto_hun_pay1','$set_r_lotto_hun_dis1','$set_r_lotto_hun_set_pay','$set_r_lotto_hun_set_price','$set_r_games_share','$set_r_games_force','$set_r_games_myshare','$set_r_games_dis','$set_r_casino_share','$set_r_casino_force','$set_r_casino_myshare','$set_r_casino_max')";
