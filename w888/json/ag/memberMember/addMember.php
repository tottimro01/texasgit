        ...
        <form class="form-horizontal" id="createMember_form" method="post" action="" onsubmit="return false;">
            <div class="widget-box no-skin widget-color">
                <div class="widget-header widget-header-blue">
                    <h4 class="widget-title lighter">ข้อมูลสมาชิก</h4>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <div class="input-group clearfix">
                                        ...
                                        <input type="text" id="username" name="username" class="inputEngNum" value="" maxlength="5" placeholder="ชื่อผู้ใช้">
                                    </div>
                                </div>
                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="sport" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix input-group">
                                                    <select class="form-control input-sm sl_sport" id="sport_com" name="sport_com" onclick="generateSL2('0.50',this);">
                                                        <option value="0.00">0.00</option>
                                                    <option value="0.05">0.05</option><option value="0.10">0.10</option><option value="0.15">0.15</option><option value="0.20">0.20</option><option value="0.25">0.25</option><option value="0.30">0.30</option><option value="0.35">0.35</option><option value="0.40">0.40</option><option value="0.45">0.45</option><option value="0.50">0.50</option></select>
                                ...
                                <div id="step" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="stepcom3">ส่วนลด 3-4 คู่ :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix  input-group">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="step_betmin_money">ต่ำสุด/ไม้ :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="step_billmax_money">จ่ายสูงสุด/บิล :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="stepcom5">ส่วนลด 5-6 คู่ :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix  input-group">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="step_max_pair">จำนวนคู่สูงสุด/บิล :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="stepcom7">ส่วนลด 7-8 คู่ :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix  input-group">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="step_min_pair">จำนวนคู่ต่ำสุด/บิล :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="stepcom9">ส่วนลด 9-10 คู่ :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix  input-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="stepcom11">ส่วนลด 11-12 คู่ :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix  input-group">
                                ...
                                <div id="casino" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div class="widget-box">
                                                <div class="widget-header widget-header-flat  text-center">
                                                    <h4 class="widget-title smaller">ม้าแข่ง</h4>
                                                </div>
                                                <div class="widget-body">
                                                    <div class="widget-main">
                                                        <div class="form-group" style="display:none;">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                                ...
                                                                <div class="col-xs-12 col-sm-8 col-md-7">
                                                                    <div class="clearfix">
                                                                        <input type="text" name="rcb_maxtransfer" id="rcb_maxtransfer" class="numeric maxLimit" value="50,000">
                                                                        <span class="text-danger label-sm" id="k_rcb_maxtransfer" data-json="50,000">(&lt;= 50,000) </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
