...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Agent OHOKING</title>
        <meta name="description" content="Login Agent OHOKING page" />
        ...
        <div class="main-container">
            <div class="main-content">
                <div class="">                    
                	...
                	<div class="box-login">
                  <br><br>
						<div class="logo"><img src="assets/images/logo_ohoking.png" alt="OHOKING" width="287px;" ></div>
          ...
          <div>
            <center>
              <div class="form-group" style="margin:auto;">
                <div> <span><strong>แอปพลิเคชั่นที่แนะนำ</strong></span></div>
              </div>
              <div class="form-group" style="margin:auto;">
                <div>
              ...
              <div class="form-group" style="margin:auto;">
                <div class="clearfix text-center"> 
                  Copyright © 2019  
                  <i class="fa fa-envelope-o" aria-hidden="true" style="color:#ffffff;"> : ohoking@gmail.com</i>
