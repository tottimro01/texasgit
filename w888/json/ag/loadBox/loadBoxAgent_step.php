...
$array_data["step_share"] = ($array_data["step_share"] == "") ? intval($r_sport_share[3]) : $array_data["step_share"];  
...
$step_betmin_money_max =  ($array_data["step_betmin_money_max"] == "") ? intval($r_sport_step_max[1]) : intval($array_data["step_betmin_money_max"]);
...
$step_max_pair_min =  ($array_data["step_max_pair_min"] == "") ? $r_sport_step2[2] : intval($array_data["step_max_pair_min"]);
    ...
    $data["arr"]["step"] = $array_data;
        ...
        <div class='form-group'>
                ...
                <div class='col-xs-12 col-sm-6 col-md-6'>
                    <div class='clearfix input-group'>
                        <select class='form-control input-sm sl_step' id='step_share' name='step_share' onchange=\"setKeep('step_share');\">";
                            for($i=$step_share_max;$i<=intval($r_sport_share[3]);$i++)
                            {
                                $sl_row = "";
            ...
            <div class='col-xs-12 col-sm-6 col-md-6'>
                <label class='control-label col-xs-12 col-sm-6 col-md-6 no-padding-right'>
                    ...
                    {$lang_memberAgent[27]} : 
                    <span id='k_step_share' data-json='".$r_sport_share[3]."'>".$array_data["k_step_share"]." </span> %
                </label>
            </div>
        </div>
        ...
        <div class='col-xs-12 col-sm-4 col-md-4'>
            <div class='form-group'>
                <div class='col-xs-12 col-sm-12 col-md-12'> 
                <label class='control-label col-xs-12 col-sm-6 col-md-4 no-padding-right' for='step_betmax_money'>{$lang_memberAgent[41]} :</label>
            ...
            <div class='form-group'>
                <div class='col-xs-12 col-sm-12 col-md-12'>
                <label class='control-label col-sm-6 col-md-4 no-padding-right' for='step_betmin_money'>{$lang_memberAgent[42]} :</label>
                <div class='col-xs-12 col-sm-6 col-md-8'>
                    <div class='clearfix'>
            ...
            <div class='form-group'>
                <div class='col-xs-12 col-sm-12 col-md-12'>
                <label class='control-label col-xs-12 col-sm-6 col-md-4 no-padding-right' for='step_daymax_money'>{$lang_memberAgent[50]} :</label>
                <div class='col-xs-12 col-sm-6 col-md-8'>
                    <div class='clearfix'>
            ...
            <div class='form-group'>
                <div class='col-xs-12 col-sm-12 col-md-12'>
                <label class='control-label col-sm-6 col-md-4 no-padding-right' for='step_billmax_money'>{$lang_memberAgent[51]} :</label>
                <div class='col-xs-12 col-sm-6 col-md-8'>
                    <div class='clearfix'>
        ...
        <div class='col-xs-12 col-sm-4 col-md-4'>
            <div class='form-group'>
                <div class='col-xs-12 col-sm-12 col-md-12'>
                <label class='control-label col-sm-6 col-md-4 no-padding-right' for='step_min_pair'>{$lang_memberAgent[53]} :</label>
                <div class='col-xs-12 col-sm-6 col-md-8'>
                    <div class='clearfix'>
            ...
            <div class='form-group'>
                <div class='col-xs-12 col-sm-12 col-md-12'>
                <label class='control-label col-sm-6 col-md-4 no-padding-right' for='step_max_pair'>{$lang_memberAgent[52]} :</label>
                <div class='col-xs-12 col-sm-6 col-md-8'>
                    <div class='clearfix'>
