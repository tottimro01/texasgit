...
$r_open_agent = $array_data["r_open_agent"];
        ...
        <div class='col-xs-12 col-sm-4 col-md-4'>
            <div class='form-group'>
                 <div class='col-xs-12 col-sm-12'>
                    <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='step_betmax_money'>{$lang_memberMember[35]} :</label>
            ...
            <div class='form-group'>
                <div class='col-xs-12 col-sm-12'>
                    <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='step_betmin_money'>{$lang_memberMember[36]} :</label>
                    <div class='col-xs-8 col-sm-8'>
                        <div class='clearfix'>
                        <input type='text' name='step_betmin_money' id='step_betmin_money' class='numeric minLimit' value='".addCommas($array_data["step_betmin_money"])."' onblur=\"chkMinMax(this,".intval($r_sport_step_min[1]).",".intval($r_sport_step_max[1]).");\">
                        <span class='text-danger label-sm' id='k_step_betmin_money' data-json='".addCommas($r_sport_step_min[1])."'>(".addCommas($r_sport_step_min[1])." - ".addCommas($r_sport_step_max[1]).") </span>
                        </div>
                    </div>
                </div>
            ...
            <div class='form-group'> 
                <div class='col-xs-12 col-sm-12'>
                     <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='step_daymax_money'>{$lang_memberMember[37]} :</label>
                     <div class='col-xs-8 col-sm-8'>
                        <div class='clearfix'>
            ...
            <div class='form-group'> 
                <div class='col-xs-12 col-sm-12'>
                    <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='step_billmax_money'>{$lang_memberMember[38]} :</label>
                    <div class='col-xs-8 col-sm-8'>
                    <div class='clearfix'>
        ...
        <div class='col-xs-12 col-sm-4 col-md-4'>
            <div class='form-group'>
                <div class='col-xs-12 col-sm-12'>
                    <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='step_min_pair'>{$lang_memberMember[46]} :</label>
                    <div class='col-xs-8 col-sm-8'>
            ...
            <div class='form-group'>
                <div class='col-xs-12 col-sm-12'>
                    <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='step_max_pair'>{$lang_memberMember[45]} :</label>
                    <div class='col-xs-8 col-sm-8'>
                        <div class='clearfix input-group'>
