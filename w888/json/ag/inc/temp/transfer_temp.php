...
<div class="row">
    <div class="widget-box hidden-boder " id="reloadTransfer">
        <div class="widget-header widget-header-blue widget-header-flat" style="display:none;">
            <h4 class="widget-title lighter"><strong> <?=$lang_transfer[1];?> </strong></h4>
                    ...
                    <div class="col-xs-12 widthTable">
                        <form class="form-horizontal" id="frmSearchDeposit">
                            <div class="form-group">
                                <label class="col-xs-12 col-sm-2 control-label no-padding-right" style="width:100px"><strong><?=$lang_transfer[2];?> : </strong></label>
                                <div class="col-xs-12 col-sm-3">
                                <input type="text" id="search_input" name="q" placeholder="<?=$lang_transfer[2];?>" value="" class="col-xs-12 col-sm-12">
                                  
                                </div>
                                <div class="col-xs-12 col-sm-2">
                                    <select class="form-control col-xs-12 col-sm-6 input-sm" id="utype" name="utype">
                                        <option value="M"><?=$lang_transfer[3];?></option>
                                        <option value="A"><?=$lang_transfer[4];?></option>
                                    </select>
                                </div>
                                <div class="col-xs-12 col-sm-2">
                                    <button type="button" name="search" id="search" class="btn btn-primary btn-sm" onclick="loadData();">
                                        <span class="ace-icon fa fa-search icon-on-right bigger-110"></span>
                                        <?=$lang_transfer[5];?>                                    </button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="table-responsive">
                            <table id="tbTransfer" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th colspan="2" class="text-center"><?=$lang_transfer[2];?> </th>
                                        ...
                                        <th>
                                            <label>
                                                <input name="yesterdayAll" id="" class="ace ace-checkbox-2" type="checkbox" onclick="allChecked(this,'chkboxYesterday');">
                                                <span class="lbl"></span>
                                            </label>
                                        </th>
                                        <th class="text-center" width="15%">
                                        ...
                                        <th>
                                            <label>
                                                <input name="todayAll" id="" class="ace ace-checkbox-2" type="checkbox" onclick="allChecked(this,'chkboxToday');">
                                                <span class="lbl"></span>
                                            </label>
                                        </th>
                                        <th class="text-center"><?=$lang_transfer[8];?> </th>
                                        <th class="text-center"><?=$lang_transfer[9];?> </th>
                                        <!-- <th class="text-center" >Bet Credit </th> -->
                                        <th class="text-center"> <?=$lang_transfer[10];?>  </th>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="10" align="center"><?=$lang_transfer[11];?></td>
                                    </tr>
                                </tbody>

                                <tfoot style="display:none;">
                                    <tr>
                                        <td colspan="2" align="center"><strong><?=$lang_transfer[12];?></strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" align="right">
                                            <button type="button" class="btn btn-xs btn-primary" onclick="transferMoney(this,'Y','All');">
                                                ...
                                                <span class="bigger-110"> <?=$lang_transfer[13];?></span>
                                            </button>
                                        </td>
                                        <td colspan="2" align="right">
                        ...
                        callback: function(e) {
                            if(e){
                                ...
                                if(statusSent == ''){
                                    ...
                                    if(type == 'Y'){
                                        columFind = 'columYesterday';
                                    }else if(type =='T'){
                                        columFind = 'columToday';
                                    }

                                    $("#tbTransfer").find('.'+columFind+' input[type="checkbox"]:checked').each(function() {
