                ...
                <div class="widget-header widget-header-blue">
                    ...
                    <div class="widget-toolbar " id="manage-btn">
                        <button type="button" class="btn btn-success btn-xs" onclick="saveAgent();">
                            <i class="ace-icon fa fa-floppy-o"></i> <?=$lang_memberAgent[4];?>                        
                        </button>
                        <button type="reset" class="btn btn-danger  btn-xs" onclick="btn_reset();">
                            <span class="fa fa-refresh icon-on-right bigger-110"></span> <?=$lang_memberAgent[5];?>                       
                        </button>
                    </div>
                    ...
                    <div class="widget-main">
                        <div>
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="username"> <?=$lang_memberAgent[9];?> :</label>
                                <div class="col-xs-12 col-sm-4">
                                    <div class="input-group clearfix">
                                        <span class="input-group-addon">
                                            <?=$r_name;?> 
                                        </span>
                                        <input type="text" class="inputEngNum" id="username" name="username" value="" maxlength="5" placeholder="<?=$lang_memberAgent[9];?>">
                                    </div>
                                </div>
                                <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="password"><?=$lang_memberAgent[10];?> :</label>
                                <div class="col-xs-12 col-sm-4">
                                    <div class="clearfix">
                                        <input type="password" name="password" id="password" class="inputEngNum" minlength="6" maxlength="16" placeholder="<?=$lang_memberAgent[10];?>">
                                        <span class="text-danger"><?=$lang_memberAgent[11];?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="name"> <?=$lang_memberAgent[12];?> :</label>
                                <div class="col-xs-12 col-sm-4">
                                    <div class="clearfix">
                                        <input type="text" name="name" id="name" value="" placeholder="<?=$lang_memberAgent[12];?>">
                                    </div>
                                </div>
                                <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="telephone"> <?=$lang_memberAgent[13];?> :</label>
                                <div class="col-xs-12 col-sm-4">
                                    <div class="clearfix">
                                        <input type="tel" id="telephone" name="telephone" value="" placeholder="<?=$lang_memberAgent[13];?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="credit"> <?=$lang_memberAgent[14];?> :</label>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="clearfix">
                                        <input type="text" name="credit" id="credit" value="0.00" class="numeric input-num2digt" placeholder="<?=$lang_memberAgent[14];?>" onblur="calCredit(this,<?=$x_count3;?>);">
                                        <span class="text-danger" id="max_credit" data-json="<?=number_format($x_count3,2);?>">(<?=$lang_memberAgent[67];?> = <?=number_format($x_count3,2);?>) </span>
                                    </div>
                                </div>
                            </div>
                        </div><?php //exit();  ?>
                            ...
                            <div class="tab-content">
                                <div id="soccer" class="tab-pane fade in active">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="clearfix input-group">
                                                        <select class="form-control input-sm sl_soccer" id="today_share" name="today_share" onchange="setKeep('today_share');">
                                                            <?php 
                                                                for($i =0; $i<=intval($r_sport_share[1]); $i++)
                                                                {
                                                                    ?>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="clearfix input-group">
                                                        <select class="form-control input-sm sl_soccer" id="live_share" name="live_share" onchange="setKeep('live_share');">
                                                             <?php 
                                                                for($i =0; $i<=intval($r_sport_share_live[1]); $i++)
                                                                {
                                                                    ?>
                                                                        <option value="<?=$i;?>"><?=$i;?></option>
                                                                    <?
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-4"> 
                                                <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="today_com"><?=$lang_memberAgent[29];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                    ...
                                                    <? for($x=0;$x<=400;$x++){
                                                        ...
                                                        <span class="input-group-addon" id="k_today_com" data-json="<?=intval($r_sport_dis[1]);?>">%</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="torup"><?=$lang_memberAgent[30];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="logup"><?=$lang_memberAgent[31];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-8"> 
                                                    <div class="clearfix">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="live_betmoneymax_pair"><?=$lang_memberAgent[32];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="live_betmax_money"><?=$lang_memberAgent[33];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="live_betmin_money"><?=$lang_memberAgent[66];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="clearfix">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="live_fbetmoneymax_pair"><?=$lang_memberAgent[34];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="live_fbetmax_money"><?=$lang_memberAgent[35];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="live_fbetmin_money"><?=$lang_memberAgent[36];?>  :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="clearfix">
                                ...
                                <div id="sport" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="clearfix input-group">
                                                    <select class="form-control input-sm sl_sport" id="sporttoday_share" name="sporttoday_share" onchange="setKeep('sporttoday_share');">
                                                        <?php 
                                                           for($i =0; $i<=intval($r_sport_share[2]); $i++)
                                                           {
                                                               ?>
                                                                   <option value="<?=$i;?>"><?=$i;?></option>
                                                               <?
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                ...
                                                <?=$lang_memberAgent[27];?> : 
                                                <span id="k_sporttoday_share" data-json="<?=$r_sport_share[2];?>"> <?=$r_sport_share[2];?> </span> %
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="clearfix input-group">
                                                    <select class="form-control input-sm sl_sport" id="sportlive_share" name="sportlive_share" onchange="setKeep('sportlive_share');">
                                                         <?php 
                                                           for($i =0; $i<=intval($r_sport_share_live[2]); $i++)
                                                           {
                                                               ?>
                                                                   <option value="<?=$i;?>"><?=$i;?></option>
                                                               <?
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                <span class="text-danger"><?=$r_name;?></span> 
                                                <?=$lang_memberAgent[27];?> : 
                                                <span id="k_sportlive_share" data-json="<?=$r_sport_share_live[2];?>"> <?=$r_sport_share_live[2];?> </span> %
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="clearfix input-group">
                                                    <select class="form-control input-sm sl_boxing" id="boxingtoday_share" name="boxingtoday_share" onchange="setKeep('boxingtoday_share');">
                                                        <?php 
                                                           for($i =0; $i<=intval($r_sport_share[3]); $i++)
                                                           {
                                                               ?>
                                                                   <option value="<?=$i;?>"><?=$i;?></option>
                                                               <?
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                ...
                                                <?=$lang_memberAgent[27];?> :
                                                <span id="k_boxingtoday_share" data-json="<?=$r_sport_share[3];?>"> <?=$r_sport_share[3];?> </span> %
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="clearfix input-group">
                                                    <select class="form-control input-sm sl_boxing" id="boxinglive_share" name="boxinglive_share" onchange="setKeep('boxinglive_share');">
                                                         <?php 
                                                           for($i =0; $i<=intval($r_sport_share_live[3]); $i++)
                                                           {
                                                               ?>
                                                                   <option value="<?=$i;?>"><?=$i;?></option>
                                                               <?
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                <span class="text-danger"><?=$r_name;?></span> 
                                                <?=$lang_memberAgent[27];?> : 
                                                <span id="k_boxinglive_share" data-json="<?=$r_sport_share_live[3];?>"> <?=$r_sport_share_live[3];?> </span> %
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                       <div class="col-xs-12 col-sm-4 col-md-4">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix"> 
                                                    <input type="text" name="boxing_betmax_money" id="boxing_betmax_money" class="numeric maxLimit input-num2digt" value="<?=addCommas($r_sport_max[8]);?>" onblur="chkMinMax(this,<?=intval($r_sport_min[4]);?>,<?=intval($r_sport_max[8]);?>);">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix">
                                                    <input type="text" name="boxing_betmin_money" id="boxing_betmin_money" class="numeric minLimit input-num2digt" value="<?=addCommas($r_sport_min[4]);?>" onblur="chkMinMax(this,<?=intval($r_sport_min[4]);?>,<?=intval($r_sport_max[8]);?>);">
                                ...
                                <div id="step" class="tab-pane fade">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-inline pull-left">
                                                    ...
                                                    <div id="step_today">
                                                        ...
                                                        <span class="lbl"> <?=$lang_memberAgent[17];?> </span>
                                                    </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="step_share"><?=$lang_memberAgent[43];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="clearfix input-group">
                                                        <select class="form-control input-sm sl_step" id="step_share" name="step_share" onchange="setKeep('step_share');">
                                                            <?php 
                                                                for($i =0; $i<=intval($r_sport_share[4]); $i++)
                                                                {
                                                                    ?>
                                                                        <option value="<?=$i;?>"><?=$i;?></option>
                                                                    <?
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                    <span class="text-danger"><?=$r_name;?> </span> 
                                                    <?=$lang_memberAgent[27];?> : 
                                                    <span id="k_step_share" data-json="<?=$r_sport_share[3];?>"><?=$r_sport_share[4];?> </span> %
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                        <label class="control-label col-sm-6 col-md-4 no-padding-right" for="step_betmin_money">
                                                            <?=$lang_memberAgent[42];?> :
                                                        </label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8">
                                                        <div class="clearfix">
                                                 ...
                                                 <div class="form-group">
                                                 	<div class="col-xs-12 col-sm-12 col-md-12">
                                                		<label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="step_daymax_money"><?=$lang_memberMember[37];?> :</label>
                                                	<div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="clearfix">
                                                ...
                                                <div class="form-group">
                                                	<div class="col-xs-12 col-sm-12 col-md-12">  
                                                		<label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="step_billmax_money"><?=$lang_memberAgent[51];?> :</label>
                                               		<div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <label class="control-label col-sm-6 col-md-4 no-padding-right" for="step_min_pair">
                                                        <?=$lang_memberAgent[53];?> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-6 col-md-8">
                                                        <div class="clearfix">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <label class="control-label col-sm-6 col-md-4 no-padding-right" for="step_max_pair">
                                                        <?=$lang_memberAgent[52];?> :
                                                    </label>
                                                    <div class="col-xs-12 col-sm-6 col-md-8">
                                                        <div class="clearfix">
                                                                ...
                                                                <div class="col-xs-12 col-sm-6 col-md-7 casino_select">
                                                                    <div class="clearfix input-group">
                                                                        <select class="form-control input-sm sl_casino casino_share" id="casino_share<?=$key;?>" name="casino_share<?=$key;?>" onchange="setKeep('casino_share<?=$key;?>'); ">
                                                                            <?php for($i=0;$i<=intval($r_casino_share[$key]);$i++){ ?>
                                                                                <option value="<?=$i;?>"><?=$i;?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                        <span class="input-group-addon">
                                                                        ...
                                                                        <span class="text-danger"><?=$r_name;?> </span> 
                                                                        <?=$lang_memberAgent[27];?> : <span id="k_casino_share<?=$key;?>" class="sl_data" data-json="<?=$r_casino_share[$key];?>">
                                                                                <?=$r_casino_share[$key];?></span> %
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                                ...
                                                                <div class="col-xs-12 col-sm-8 col-md-7">
                                                                    <div class="clearfix casino_Input"> 
                                                                        <input type="text" name="rcb_maxtransfer<?=$key;?>" id="rcb_maxtransfer<?=$key;?>" class="numeric maxLimit input-num2digt" value="<?=number_format($r_casino_max[$key]);?>" onblur="chkMinMax(this,0,<?=$r_casino_max[$key];?>);">
                                                                        <span class="text-danger label-sm maxtransfer" id="k_rcb_maxtransfer" data-json="<?=number_format($r_casino_max[$key]);?>">(0 - <?=number_format($r_casino_max[$key]);?>) </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="widget-main no-padding">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="clearfix input-group">
                                                        <select class="form-control input-sm sl_lotto_share" id="7_lotto_share" name="lotto_share" onchange="setKeep('7_lotto_share');">
                                                             <?php 
                                                                for($i =0; $i<= intval($r_lotto_share[1]); $i++)
                                                                {
                                                                    ?>
                                                                        <option value="<?=$i;?>"><?=$i;?></option>
                                                                    <?
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                    <span class="text-danger"> <?=$r_name;?> </span> 
                                                    <?=$lang_memberAgent[27];?> : <span id="k_7_lotto_share" data-json="<?=$r_lotto_hun_share[1];?>">
                                                            <?=$r_lotto_share[1];?> </span> %
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="widget-box">
                                ...
                                <div id="lotto_set" class="tab-pane fade">
                                    <div class="widget-main no-padding">
                                                ...
                                                <div class="form-inline pull-left">
                                                    <label class="inline">
                                                        <div id="lotto_set_today">
                                                            ...
                                                            <span class="lbl"> <?=$lang_memberAgent[19];?> </span>
                                                        </div>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-2">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="8_lotto_share"><?=$lang_memberAgent[43];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="clearfix input-group">
                                                        ...
                                                        <select class="form-control input-sm sl_lotto_set_share" id="8_lotto_share" name="lotto_share_hun" onchange="setKeep('8_lotto_share');">
                                                            <?php 
                                                                for($i =0; $i<= intval($r_lotto_hun_share[1]); $i++)
                                                                {
                                                                    ?>
                                                                        <option value="<?=$i;?>"><?=$i;?></option>
                                                                    <?
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                    <span class="text-danger"> <?=$r_name;?> </span> 
                                                    <?=$lang_memberAgent[27];?> : <span id="k_8_lotto_share" data-json="<?=$r_lotto_hun_share[1];?>">
                                                            <?=$r_lotto_hun_share[1];?> </span> %
                                                </label>
                                            </div>
                                        </div>
                                   						...
                                   						<tr class="text-center">
                                                            ...
                                                            <td width="30%">
                                                             ...
                                                             <td width="35%">
                                                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                                                     <div class="clearfix  input-group">
                                                                         <select class="form-control input-sm sl_lotto_set_com" id="8_<?=$key;?>_lotto_com1" name="lotto_hun_com1_<?=$key;?>">
                                                                             <?php 
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td width="30%">
                                                             ...
                                                             <td width="35%">
                                                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                                                     <div class="clearfix  input-group">
                                                                         <select class="form-control input-sm sl_lotto_set_com" id="8_<?=$key;?>_lotto_com2" name="lotto_hun_com2_<?=$key;?>">
                                                                             <?php 
                              ...
                              <div class="widget-body">
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td width="30%">
                                                             ...
                                                             <td width="35%">
                                                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                                                     <div class="clearfix  input-group">
                                                                         <select class="form-control input-sm sl_lotto_set_com" id="8_<?=$key;?>_lotto_com3" name="lotto_hun_com3_<?=$key;?>">
                                                                             <?php 
                                                                                for($i=0;$i<=intval($r_lotto_hun_dis2[$key]);$i++)
                                                                                {
                                                                                    $selected = (intval($r_lotto_hun_dis2[$key]) == $i) ? "selected" : "";
                                ...
                                <div id="lotto_lao" class="tab-pane fade">
                                    <div class="widget-main no-padding">
                                                ...
                                                <div class="form-inline pull-left">
                                                    <label class="inline">
                                                        <div id="lotto_lao_today">
                                                            ...
                                                            <span class="lbl"> <?=$lang_memberAgent[20];?> </span>
                                                        </div>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-2">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="9_lotto_share"><?=$lang_memberAgent[43];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="clearfix input-group">
                                                        <select class="form-control input-sm sl_lotto_lao_share" id="9_lotto_share" name="lotto_hun_set_share" onchange="setKeep('9_lotto_share');">
                                                            <?php 
                                                                for($i =0; $i<= intval($r_lotto_hun_set_share[1]); $i++)
                                                                {
                                                                    ?>
                                                                        <option value="<?=$i;?>"><?=$i;?></option>
                                                                    <?
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                    <span class="text-danger"><?=$r_name;?> </span> 
                                                     <?=$lang_memberAgent[27];?> : <span id="k_9_lotto_share" data-json="<?=$r_lotto_hun_set_share[1];?>"> <?=$r_lotto_hun_set_share[1];?> </span> %
                                                </label>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="widget-body">
                                                        ...
                                                        <div class="table-responsive">
                                                                <table class="table table-striped table-bordered table-hover" style="width: 99.9%;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th class="text-center"><?=$lang_memberAgent[58];?></th>
                                                                            <th class="text-center"><?=$lang_memberAgent[59];?></th>
                                                                            <th class="text-center"><?=$lang_memberAgent[60];?></th>
                                                                        </tr>
                                                                    </thead>
                                                                     <tbody>
                                                                        <?php 
                                                                         ...
                                                                         ?>
                                                                             ...
                                                                             <tr class="text-center">
                                                                                    ...
                                                                                    <td width="35%" class="lotto_lao_Input">
                                                                                        <input type="text" name="lot_hun_set_pay<?=$index;?>" id="lot_hun_set_pay<?=$index;?>"  class="numeric maxLimit input-num2digt" value="<?=number_format($r_lotto_hun_set_pay[$index]);?>" onblur="chkMinMax(this,0,<?=$r_lotto_hun_set_pay[$index];?>);">
                                                                                        <span class="text-danger label-sm maxtransfer" id="lot_hun_set_pay_info" data-json="<?=number_format($r_lotto_hun_set_pay[$index]);?>">(0-<?=number_format($r_lotto_hun_set_pay[$index]);?>) </span>
                                                                                    </td>
                                                                                    <?php if($index == 1){ ?>
                                                                                    <td width="35%" rowspan="100%" style="vertical-align: top;" class="lotto_lao_Input">
                                                                                        <input type="text" name="lot_hun_set_price<?=$index;?>" id="lot_hun_set_price<?=$index;?>" class="numeric maxLimit input-num2digt" value="<?=number_format($r_lotto_hun_set_price[$index]);?>" onblur="chkMinMax(this,0,<?=$r_lotto_hun_set_price[$index];?>);">
                                                                                        <span class="text-danger label-sm maxtransfer" id="lot_hun_set_price_info" data-json="<?=number_format($r_lotto_hun_set_price[$index]);?>">(0- <?=number_format($r_lotto_hun_set_price[$index]);?>) </span>
                                                                                    </td>
                                                                                    <?php } ?>
                                                                             </tr>
                                                                             <?php 
                                ...
                                <div id="game" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="clearfix input-group"> 
                                                    <select class="form-control input-sm sl_game" id="game_share" name="game_share" onchange="setKeep('game_share');"> 
                                                        <?php 
                                                            for($i=0;$i<=intval($r_games_share[1]);$i++)
                                                            {
                                                                ?>
                                                                    <option value="<?=$i;?>"><?=$i;?></option>
                                                                <?
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                <span class="text-danger"><?=$r_name;?> </span> 
                                                <?=$lang_memberAgent[27];?> : <span id="k_game_share" data-json="<?=$r_games_share[1];?>">
                                                        <?=$r_games_share[1];?>  </span> %
                                            </label>
                                        </div>
                                    </div>
...
function change_set_min_pair(_min_df,_max_df){
    ...
    $.ajax({
      url: 'inc/temp/memberAgent/create_dis_step.php',
      type: 'POST',
      dataType: 'html',
    ...
    function setMax(game){
        switch (game){
            ...
            case 'boxing' :
                ...
                $('#boxing_com').val($('#boxing_com').children('option:last').val()); 
            ...
            case 'casino' :
                ...
                $( "#casino .casino_select .sl_casino" ).each(function(i,e) {
                     var data = $(this).closest('.casino_select').children('span.sl_data').data('json')
                     $( this ).val(data);
                });      
            break;
            case 'lotto' :
                $( "#lotto #7_lotto_share").val($('#lotto #7_lotto_share > option:last').val()) 
            ...
            break;
            case 'lotto_set' :
            	  $( "#lotto_set #8_lotto_share").val($('#lotto_set #8_lotto_share > option:last').val()) 
            ...
            break;
            case 'lotto_lao' :
            	$( "#lotto_lao #9_lotto_share").val($('#lotto_lao #9_lotto_share > option:last').val()) 
    ...
    function regisCopyUser(){
        pageContentLoader("show");
        $.ajax({
            url: 'inc/temp/memberAgent/copyUser_temp.php',
            type: 'GET',
            dataType: 'json',
            success: function (response) {
               pageContentLoader("hide");
                bootbox.dialog({
                    ...
                    buttons:            
                    {
                        "UserList" :
                        {
                            "label" : "<i class=\"ace-icon fa fa-list-ul bigger-110\"></i> <span class=\"normal\"><?=$lang_memberAgent[64];?></span>",
                        ...
                        "OK" :
                        {
                            "label" : "<i class='fa fa-floppy-o'></i> <span class=\"normal\"><?=$lang_memberAgent[6];?></span>",
                        ...
                        "NO" :
                        {
                            "label" : "<i class='ace-icon glyphicon glyphicon-log-in'></i> <span class=\"normal\"><?=$lang_memberAgent[65];?></span>",
    ...
    function setForce(e,id)
    {
        ...
        $('#'+id+'').empty().append(optionList);
    }

    // function get_userCopyDetail(e)
    // {
    //     let rid = $(e).val();
    //     $.ajax({
    //         url: 'inc/temp/memberAgent/copyUser_getaUserDetail.php',
    //         type: 'POST',
    //         dataType: 'json',
    //         data: {rid: rid},
    //     })
