...
if($_SESSION["uu_use"]!=0)
{
  ...
  $re=sql_query($sql);
  $list_agent = "<option value=''> {$lang_memberAgent[109]} </option>";
  while($rs=sql_fetch($re)){
    $agent_name = ($rs["r_name"] != "") ? $rs["r_name"] : $lang_memberAgent[110];
  ...
  "
    ...
    <div class='widget-box'>
      <div class='widget-header widget-header-blue widget-header-flat'>
        <h4 class='widget-title lighter'><strong> {$lang_memberAgent[6]}  $sql1 <font style='color:#c90000'></font> </strong></h4>
      </div>
              ...
              <div class='col-xs-12'>
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'>
                    <strong>{$lang_memberAgent[63]} : </strong>
                  </label>
                ...
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'>
                    <strong>{$lang_memberAgent[9]} : </strong>
                  </label>
                ...
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'><strong>{$lang_memberAgent[10]} : </strong></label>
                  <div class='col-xs-12 col-sm-5'>
                    <input type='password' id='regis_password' name='regis_password' class='col-xs-12 col-sm-12'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'><strong>{$lang_memberAgent[14]} : </strong></label>
                  <div class='col-xs-12 col-sm-5'>
                    <input type='text' id='regis_credit' name='regis_credit' class='col-xs-12 col-sm-12 numeric input-num2digt' value='0.00' onkeyup=\"calCredit(this,".$x_count3.");\" onblur=\"addDigit(this)\">
                    <br> <span class='text-danger' id='max_credit' data-json='0.00'>(Max = ".number_format($x_count3,2).") </span> 
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'><strong>{$lang_memberAgent[12]} : </strong></label>
                  <div class='col-xs-12 col-sm-5'>
                    <input type='text' id='regis_name' name='regis_name' class='col-xs-12 col-sm-12'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'><strong>{$lang_memberAgent[13]} : </strong></label>
                  <div class='col-xs-12 col-sm-5'>
