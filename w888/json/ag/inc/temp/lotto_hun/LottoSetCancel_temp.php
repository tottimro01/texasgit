 ...
 <!-- <div class="row"> -->
	...
	<div class="col-md-12  top-title-style">
			...
			<div class="zoneGroup">
				...
				<select class="txt_back11n form-control sl-width input-sm sl_soccer l_zone" name="ttype" id="zone" onchange="getRob(this);">
			...
			<div class="robGroup" id="rob" style="display: none;">
				...
				<select class="input-sm" name="ttype" id="trob" onchange="">
                         <option value=""> <?=$lang_lotHun[1];?> </option>                                                                       
               </select>
	...
	<div class="table-responsive">
		<form action="" id="form1" onsubmit="calcel_all(); return false;">	
	 		<table class="m_table bgtable txt_back11n" id="table1">
			 	<thead>
			 		<tr>
			 			<th><?=$lang_lotHun[15];?></th>
			 			<th><?=$lang_lotHun[43];?></th>
			 			<th><?=$lang_lotHun[44];?></th>
			 			<th><?=$lang_lotHun[24];?></th>
			 			<th><?=$lang_lotHun[15];?></th>
			 			<th><?=$lang_lotHun[36];?></th>
			 			<th><?=$lang_lotHun[45];?></th>
			 			<th><?=$lang_lotHun[25];?></th>
			 			<th><?=$lang_lotHun[26];?></th>
			 			<th><?=$lang_lotHun[30];?></th>
			 			<th><?=$lang_lotHun[46];?></th>
			 			<th><?=$lang_lotHun[47];?></th>
			 	...
			 	<tbody>
			 			...
			 			<tr bgcolor="#ffffff" onmouseover="this.bgColor='#FFFF66'" onmouseout="this.bgColor='#ffffff'" height="25">
   						    <td align="center">หวยหุ้นไทย : 3</td>
   						    <td align="center">7664</td>
   						    <td align="center">01/04/2019 11:51:37</td>
   						    <td>aaaa03</td>
   						    ...
   						    <td align="center" style="cursor: pointer;">
								...
								<a href="#" style="color: #d15a47;" onclick="cancel('7664');"><?=$lang_lotHun[46];?></a> 
							</td>
   						    <td align="center">
   						     
								<input type="checkbox" value="7664" name="ckpro[]" class="chk_select">
   						    </td>
   						 </tr>
	...
	<div class="table2-Title">
		<?=$lang_lotHun[27];?> :  26-03-2019 <?=$lang_lotHun[48];?>
	</div>
	<div class="table-responsive">		
			 	...
			 	<thead>
			 		...
			 		<tr>
              			<th width="3%" align="center">No.</th>
               			<th width="5%" align="center"><?=$lang_lotHun[15];?></th>
              			<th width="10%" align="center"><?=$lang_lotHun[43];?></th>
              			<th width="11%" align="center"><?=$lang_lotHun[44];?></th>
           				<th width="9%" align="center"><?=$lang_lotHun[24];?></th>
           				<th width="5%" align="center"><?=$lang_lotHun[15];?></th>
           				<th width="5%" align="center"><?=$lang_lotHun[36];?></th>
           				<th width="7%" align="center"><?=$lang_lotHun[45];?></th>
           				<th width="7%" align="center"><?=$lang_lotHun[25];?></th>
           				<th width="7%" align="center"><?=$lang_lotHun[26];?></th>
           				<th width="7%" align="center"><?=$lang_lotHun[30];?></th>  
             			<th width="9%" align="center"><?=$lang_lotHun[49];?></th>
						<th width="13%" align="center"><?=$lang_lotHun[50];?></th>
          			</tr>
          ...
          <tr bgcolor="#ffffff" onmouseover="this.bgColor='#FFFF66'" onmouseout="this.bgColor='#ffffff'" height="25">
            ...
            <td align="center">2019-04-01 11:56:54</td>
          </tr>
          ...
          <tr bgcolor="#ffffff" onmouseover="this.bgColor='#FFFF66'" onmouseout="this.bgColor='#ffffff'" height="25">
            ...
            <td align="right"  "><span class="cb">0</span></td>
               <td align="center">a</td>
            <td align="center">2019-04-01 11:52:46</td>
          </tr>
...
{
    var variableAry = [];
        variableAry['lang_all'] = '<?=$lang_lotHun[1];?>';
	...
	.done(function(res) {
		...
		for(var i = 0; i< l1; i++)
		{
			html1 += "<tr bgcolor=\"#ffffff\" onmouseover=\"this.bgColor='#FFFF66'\" onmouseout=\"this.bgColor='#ffffff'\" height=\"25\">"+
   						    "<td align=\"center\">"+res["calcel_list"][i]["lot_zone"]+"</td>"+
   						    ...
   						    "<td align=\"center\" style=\"cursor: pointer;\">"+
   						    	"<a href=\"#\" style=\"color: #d15a47;\" onclick=\"cancel('"+res["calcel_list"][i]["play_id"]+"');\"><?=$lang_lotHun[46];?></a>"+ 
							"</td>"+
   						    "<td align=\"center\">"+
		...
		for(var i = 0; i< l2; i++)
		{
			html2 += "<tr bgcolor=\"#ffffff\" onmouseover=\"this.bgColor='#FFFF66'\" onmouseout=\"this.bgColor='#ffffff'\" height=\"25\">"+
        			   ...
        			   "<td align=\"center\">"+res["calceled_list"][i]["lot_zone"]+"</td>"+
