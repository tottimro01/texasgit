                    ...
                    <form class="form-horizontal">
                        <div class="form-group">
                            <div class=" col-xs-12 col-sm-12 col-md-12" style="margin-bottom: 5px;">
                                  <label for=""> <?=$lang_lotHun[15];?> : </label>
                                   ...
                                   <div id="rob" style="display: none;">
                                      <label for=""> <?=$lang_lotHun[21];?> : </label>
                                                ...
                                                <table id="tb_lottoSetMemberList" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <th><?=$lang_lotHun[28];?></th>
                                                            <th><?=$lang_lotHun[29];?></th>
                                                            <th></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    ...
                                                    <thead>
                                                        <tr class="bghead">
                                                            <th colspan="3" align="center">
                                                                <span class="t_name"> <?=$lang_lotHun[23];?> : </span>   
                                                                <select class="txt_back11n  input-sm" id="_view" name="view">
                                                                    <option value="a"><?=$lang_lotHun[31];?></option>
                                                                    <option value="" selected=""><?=$lang_lotHun[1];?></option>
                                                             </select>
                                                            </th>
                                                            <th colspan="4" align="center" id="showuser"><?=$lang_lotHun[22];?></th>
                                                       </tr>
                                                       <tr>
                                                            <th class="text-center"> <?=$lang_lotHun[4];?>  </th>
                                                            <th class="text-center"> User </th>
                                                            <th class="text-center"> <?=$lang_lotHun[25];?> </th>
                                                            <th class="text-center"> <?=$lang_lotHun[26];?> </th>
                                                            <th class="text-center"> <?=$lang_lotHun[30];?> </th>
                                                            <th class="text-center"> <?=$lang_lotHun[28];?> </th>
                                                            <th class="text-center"> <?=$lang_lotHun[29];?> </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
