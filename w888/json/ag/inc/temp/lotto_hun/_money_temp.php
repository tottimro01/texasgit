...
<div class="row">
	<div class="col-md-9">
		<div class="top-title-style"><?=$lang_lotHun[35];?></div>
		<div class="normal-box box-color">
			<div class="row">
			<?php 
				$normal_list = array('3บน','3ล่าง','3โต๊ด','2บน','2ล่าง');
	...
	<div class="col-md-3" >
		<div class="top-title-style"><?=$lang_lotHun[38];?></div>
