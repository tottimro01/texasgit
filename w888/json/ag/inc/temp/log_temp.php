          ...
          <div class="col-xs-12 widthTable">
            ...
            <div class="tabbable">
              <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
                <li class="active">
                  <a data-toggle="tab" href="#home4" aria-expanded="true" onclick="searchLog('loginLog');"><?=$lang_log[3];?></a>
                </li>
                <li class="">
                  <a data-toggle="tab" href="#sub_user" aria-expanded="false" onclick="searchLog('subUserLog');"><?=$lang_log[4];?></a>
                </li>
                <li class="">
                  <a data-toggle="tab" href="#agentLog" aria-expanded="false" onclick="searchLog('agentLog');"><?=$lang_log[5];?></a>
                </li>
                <li class="">
                  <a data-toggle="tab" href="#memberLog" aria-expanded="false" onclick="searchLog('memberLog');"><?=$lang_log[6];?></a>
                </li>  
              </ul>
                ...
                <div id="home4" class="tab-pane active">
                  <div class="table-responsive">
                    <table id="tbLoginLog" class="table table-striped table-bordered table-hover">
                      <thead>
                        <tr>
                          <th class="text-center"> <?=$lang_log[7];?> </th>
                          <th class="text-center"> <?=$lang_log[8];?> </th>
                          <th class="text-center"> <?=$lang_log[9];?> </th>
                          <th class="text-center"> <?=$lang_log[10];?> </th>
                          <th class="text-center"> <?=$lang_log[11];?></th>
                        </tr>
                      </thead>
                      <tbody>
                    ...
                    <div class="table-responsive">
                          <table id="tbSubUserLog" class="table table-striped table-bordered table-hover">
                              <thead>
                                <tr>
                                  <th class="text-center"> <?=$lang_log[7];?> </th>
                                  <th class="text-center"> <?=$lang_log[12];?> </th>
                                  <th class="text-center"> <?=$lang_log[13];?> </th>
                                  <th class="text-center"> <?=$lang_log[8];?> </th>
                                  <th class="text-center"> <?=$lang_log[14];?> </th>
                                  <th class="text-center"> <?=$lang_log[9];?> </th>
                                  <th class="text-center"> <?=$lang_log[11];?> </th>
                                </tr>
                              </thead>
                          ...
                          <table id="tbMemberLog" class="table table-striped table-bordered table-hover">
                              <thead>
                                <tr>
                                  ...
                                  <th class="text-center"> <?=$lang_log[12];?> </th>
                                  <th class="text-center"> <?=$lang_log[13];?> </th>
                                  <th class="text-center"> <?=$lang_log[18];?> </th>
                                  <th class="text-center"> <?=$lang_log[14];?> </th>
                                  <th class="text-center"> <?=$lang_log[9];?> </th>
                                  <th class="text-center"> <?=$lang_log[11];?> </th>
                                </tr>
