...
<?php
  ...
  $re=sql_query($sql);
  $list_member = "<option value=''> {$lang_memberMember[93]} </option>";
  while($rs=sql_fetch($re))
  {
    $member_name = ($rs["m_name"] != "") ? $rs["m_name"] : $lang_memberMember[94];
  ...
  "
    ...
    <div class='widget-box'>
      <div class='widget-header widget-header-blue widget-header-flat'>
        <h4 class='widget-title lighter'><strong> {$lang_memberMember[6]}<font style='color:#c90000'></font> </strong></h4>
      </div>
              ...
              <div class='col-xs-12'>
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'>
                    <strong>{$lang_memberMember[56]} : {$a}</strong>
                  </label>
                ...
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'>
                    <strong>{$lang_memberMember[9]} : </strong>
                  </label>
                ...
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'><strong>{$lang_memberMember[10]} : </strong></label>
                  <div class='col-xs-12 col-sm-5'>
                    <input type='password' id='regis_password' name='regis_password' class='col-xs-12 col-sm-12'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'><strong>{$lang_memberMember[13]} : </strong></label>
                  <div class='col-xs-12 col-sm-5'>
                ...
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'><strong>{$lang_memberMember[12]} : </strong></label>
                  <div class='col-xs-12 col-sm-5'>
                    <input type='text' id='regis_name' name='regis_name' class='col-xs-12 col-sm-12'>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-xs-12 col-sm-4 control-label no-padding-right'><strong>{$lang_memberMember[57]} : </strong></label>
                  <div class='col-xs-12 col-sm-5'>
