  ...
  .head_table .pull-right
  {
    ...
    <div class="widget-box hidden-boder">
        <div class="widget-header  hidden">
            <h4 class="widget-title lighter"><strong> <?=$lang_userList[36];?> </strong></h4>
        ...
        <div class="widget-body" id="loadEditPercent">
            <div class="widget-main">
                        ...
                        <form class="form-horizontal" id="frmEditPersent" name="frmEditPersent" action="" method="post">
                            <div class="table-responsive">
                                ...
                                <table id="" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th class="center"><?=$lang_userList[38];?> </th>
                                            <th class="center"><?=$lang_userList[39];?></th>
                                            <th>&nbsp;&nbsp;<?=$lang_userList[40];?>&nbsp;&nbsp;&nbsp;</th>
                                            <th><?=$lang_userList[41];?></th>
                                            <th class="text-danger"><?=$lang_userList[42];?></th>
                                            <th class="text-danger"><?=$lang_userList[43];?></th>
                                        </tr>
                                    </thead>
                                    ...
                                    <?php 
                                        ...
                                        foreach ($lang_g["list_share"] as $key => $value) {
                                           ?>
                                              ...
                                              <tr>
                                                  <td align="right" style="vertical-align: middle;"><?=$value;?>:</td>
                ...
                <div class="form-group"><br>
                    <strong><?=$lang_userList[61];?> :</strong> <?=$lang_userList[62]." ".$rex["r_user"]." ".$lang_userList[111];?> <br>
                </div>
