...
<div class="widget-box">
    <div class="widget-header widget-header-blue widget-header-flat">
        <h4 class="widget-title lighter"><strong> <?=$lang_userList[24];?> <font style="color:#c90000">[ <?=$user;?> ]</font> </strong></h4>
    </div>
    <div class="widget-body">
        <form class="form-horizontal" id="" action="" method="post">
            <div class="widget-main"><div class="row"><div class="col-xs-12">
                <div class="form-group">
                    <label class="col-xs-3 col-sm-4 control-label no-padding-right"><strong><?=$lang_userList[3];?> :</strong></label>
                ...
                <div class="form-group">
                    <label class="col-xs-3 col-sm-4 control-label no-padding-right"><strong><?=$lang_userList[63];?> : </strong></label>
                    <div class="col-xs-6 col-sm-5">
                        <input type="password" id="password" name="password" class="col-xs-12 col-sm-12">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-3 col-sm-4 control-label no-padding-right"><strong><?=$lang_userList[17];?> : </strong></label>
                    <div class="col-xs-6 col-sm-5">
                ...
                <div class="form-group">
                    <label class="col-xs-3 col-sm-4 control-label no-padding-right"><strong><?=$lang_userList[66];?> : </strong></label>
                    <div class="col-xs-6 col-sm-5">
                        <input type="text" id="name" name="name" class="col-xs-12 col-sm-12">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-3 col-sm-4 control-label no-padding-right"><strong><?=$lang_userList[67];?> : </strong></label>
                    <div class="col-xs-6 col-sm-5">
                        <input type="text" id="tel" name="tel" class="col-xs-12 col-sm-12">
                    </div>
                </div>
            </div></div></div>
        </form>
