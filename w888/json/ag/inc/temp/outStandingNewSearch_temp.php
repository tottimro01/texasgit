...
if(empty($_POST["gametype"])) 
{
	$list = "<tr>
		        <td align=\"\">
		        	<span onclick=\"searchDataByType('sc','','7');\">
		...
		<tr>
		        <td align=\"\">
		        	<span onclick=\"searchDataByType('sp','','7');\">
		        		<a class=\"cur\"> กีฬา </a>
		        	</span>
		        </td>
		...
		<tr>
		        <td align=\"\">
		        	<span onclick=\"searchDataByType('bx','','7');\">
		...
		<tr>
		        <td align=\"\">
		        	<span onclick=\"searchDataByType('st','','7');\">
		        		<a class=\"cur\"> สเต็ป </a>
		        	</span>
		        </td>
		        <td align=\"right\" class=\"lvAll\"> 0.00</td>
		...
		<tr>
		        <td align=\"\">
		        	<span onclick=\"searchDataByType('lg','','7');\">
		        		<a class=\"cur\"> หวย </a>
		        	</span>
		        </td>
		        <td align=\"right\" class=\"lvAll\"> 0.00</td>
		...
		<tr>
		        <td align=\"\">
		        	<span onclick=\"searchDataByType('ls','','7');\">
		...
		<tr>
		        <td align=\"\">
		        	<span onclick=\"searchDataByType('ll','','7');\">
		...
		<tr>
		        <td align=\"\">
		        	<span onclick=\"searchDataByType('gm','','7');\">
		        		<a class=\"cur\"> เกมส์ </a>
		        	</span>
		        </td>
		        <td align=\"right\" class=\"lvAll\"> 0.00</td>
		...
		<tr>
		        <td align=\"\">
		        	<span onclick=\"searchDataByType('cn','','7');\">
...
{
	if(empty($_POST["member"]) && $_POST["level"] == 7) 
	{
		$headMemberList = "<span class=\"label label-yellow arrowed-right arrowed-in\" data-value=\"7\"  onclick=\"searchDataByType('".$_POST["gametype"]."','','');\"><strong></strong></span>";
		...
		$list = "<tr>
					        <td align=\"\"> 
					        	...
					        	<span onclick=\"searchDataByType('".$_POST["gametype"]."','ohoPan','7');\">
	...
	}else if(isset($_POST["member"]) && $_POST["level"] == 7) {

		$headMemberList = "<span class=\"label label-yellow arrowed-right arrowed-in\" data-value=\"8\"  onclick=\"searchDataByType('".$_POST["gametype"]."','ohoPan','7');\"><strong>ohoPan</strong></span>";
		...
		$list = "<tr>
					   <td align=\"\"> 
					   	...
					   	<span onclick=\"searchDataByType('".$_POST["gametype"]."','ohoPan10','8');\">
	...
	}else if(isset($_POST["member"]) && $_POST["level"] == 8) {

			$headMemberList = "<span class=\"label label-yellow arrowed-right arrowed-in\" data-value=\"9\"  onclick=\"searchDataByType('".$_POST["gametype"]."','ohoPan10','8');\"><strong>ohoPan10</strong></span>";
			$option = array(
				"gametype" => $_POST["gametype"],
				"headMemberList" =>  $headMemberList,
				"level" => "9",
											            ...
											            <ul class=\"nav nav-tabs\" id=\"myTab\"> 
											            	<li class=\"active\">
											                    <a data-toggle=\"tab\" href=\"#\">
											                        ...
											                        $game_name <span class=\"badge badge-danger\">1,000.00</span>
											                    </a>
											                </li>
											            </ul>
											            <div class=\"tab-content\">
