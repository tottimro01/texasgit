    ...
    <div class="col-xs-12 col-sm-6">
        <div class="widget-box" id="reloadST">
            <div class="widget-header">
                <h4 class="widget-title"><?=$lang_soccerSummaryStep[2];?></h4>
                ...
                <div class="widget-main no-padding">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th><?=$lang_soccerSummaryStep[3];?></th>
                                    <th><?=$lang_soccerSummaryStep[4];?></th>
                                    <th><?=$lang_soccerSummaryStep[5];?></th>
                                </tr>
                            </thead>
                            <tbody>                               
                                <tr>
                                    <td class="text-left"><strong><?=$lang_soccerSummaryStep[6];?></strong></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="text-left"><strong><?=$lang_soccerSummaryStep[7];?></strong></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="text-left"><strong><?=$lang_soccerSummaryStep[8];?></strong></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="text-left"><strong><?=$lang_soccerSummaryStep[9];?></strong></td>
                                    <td></td>
                                    <td class="text-right">
                                ...
                                <tr>
                                    <td class="text-left"><strong><?=$lang_soccerSummaryStep[10];?></strong></td>
                                    <td></td>
                                    <td class="text-right">
                                ...
                                <tr>
                                    <td class="text-left"><strong><?=$lang_soccerSummaryStep[11];?></strong></td>
                                    <td></td>
                                    <td class="text-right">
