                ...
                <div class="col-xs-12 widthTable">
                    ...
                    <form class="form-horizontal" id="frnAddBank" action="" method="post">
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-2 control-label "><strong> <?=$lang_cashBank[3];?> : </strong></label>
                        ...
                        <div class="form-group">
                            ...
                            <!-- <div class="form-group"> -->
                                 <label class="col-xs-4 col-sm-2 control-label "><strong> <?=$lang_cashBank[10];?> : </strong></label>
                                 <div class="col-xs-12 col-sm-2">
                                     <select class="form-control col-xs-12 col-sm-6" id="bank_province" name="bank_province">   
                                         <option value=""><?=$lang_cashBank[11];?></option>
                                         <?php 
                    ...
                    <div class="table-responsive">
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th class="center"><?=$lang_cashBank[3];?> </th>
                                    <th><?=$lang_cashBank[4];?></th>
                                    <th><?=$lang_cashBank[2];?></th>
                                    <th><?=$lang_cashBank[10];?></th>
                                    <th><?=$lang_cashBank[6];?></th>
                                    <th><?=$lang_cashBank[7];?></th>
                                    <th><?=$lang_cashBank[5];?></th>
                                </tr>
                            </thead>
