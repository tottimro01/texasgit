                    ...
                    <div class="col-xs-12 ">
                        <form class="form-horizontal" id="frmSearchOutstanding">
                            <div class="form-group">
                                <label class="col-xs-3 col-sm-1 control-label"><strong><?=$lang_betReject[3];?> : </strong></label>
                                ...
                                <div class="col-xs-9 col-sm-2" style="">
                                    <select class="form-control col-xs-6 col-sm-6 input-sm" id="stype" name="stype" onchange="getUserBetReject(this);">
                                        <option value=""><?=$lang_betReject[4];?></option>
                                        <option value="sc"><?=$lang_betReject[5];?></option>
                                        <option value="sp"><?=$lang_betReject[6];?></option>
                                        <option value="st"><?=$lang_betReject[7];?></option>
                                    </select>
                                </div>
                                <label class="col-xs-3 col-sm-1 control-label" ><strong><?=$lang_betReject[8];?> : </strong></label>
                        ...
                        <div class="table-responsive">
                            <table id="tbBetReject" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th class="text-strong" style="text-align: left !important;"> <?=$lang_betReject[9];?>  </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
    ...
    <div class="modal-dialog" role="document" style="width:50%">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?=$lang_betReject[10];?> </button>
            </div>
        </div>
    </div>
</div>
