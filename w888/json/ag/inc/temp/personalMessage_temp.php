     ...
     <div class="modal-dialog" role="document" id="divViewLog">
          <div class="modal-content">
               <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><strong> <?=$lang_personalMessage[1];?> <?=$_POST["session"]["AGlang"]; ?> <font style="color:#c90000" id="numrows"> (0)</font></strong> </h4>
               </div>
               <div class="modal-body">
                   <div class="row">
                       <div class="col-xs-12" style="margin-bottom: 5px;">
                            <div class="form-group">
                               <label class="control-label col-xs-2 col-sm-1 " for="username" style="margin-top: 5px;"><strong><?=$lang_personalMessage[2];?>:</strong></label>
                    ...
                    <div class="table-responsive">
                        <table id="tb_personal" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th><?=$lang_personalMessage[4];?></th>
                                    <th><?=$lang_personalMessage[5];?></th>
                                </tr>
                            </thead>
                            <tbody>
                                                                    <tr><td colspan="2"><center><strong> <?=$lang_personalMessage[6];?> </strong></center></td></tr>
                                                            </tbody>
                            <tfoot>
               ...
               <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?=$lang_personalMessage[7];?></button>
               </div>
          </div>
     </div>
</div>
