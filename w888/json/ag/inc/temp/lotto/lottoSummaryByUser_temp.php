                                                   ...
                                                   <thead>
                                                        <tr class="bghead">
                                                            <th colspan="3" align="center">
                                                                <span class="t_name"> <?=$lang_lot[15];?> : </span>   
                                                       ...
                                                       <tr>
                                                            ...
                                                            <th class="text-center"> <?=$lang_lot[17];?> </th>
                                                            <th class="text-center"> <?=$lang_lot[18];?> </th>
                                                            <th class="text-center"> <?=$lang_lot[49];?> </th>
                                                            <th class="text-center"> <?=$lang_lot[20];?> </th>
                                                            <th class="text-center"> <?=$lang_lot[21];?> </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
