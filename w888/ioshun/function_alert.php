...
function noti($uid,$msg,$bgd,$stype){
	...
	$passphrase = 'lothun112233';
	// Put your alert message here:
	$message = $msg;
	////////////////////////////////////////////////////////////////////////////////
	$ctx = stream_context_create();
	stream_context_set_option($ctx, 'ssl', 'local_cert', 'lothun.pem');
...
/*function sm($uid,$msg  ,$bgd , $stype){
    ...
    $message = array("txt" => $message , "bgd" => $bgd , "ntype" => $stype);
