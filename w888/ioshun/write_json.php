...
$jst1=array();
$sql = sql_query("select * from bom_tb_lotto_hun_lock_1 where   h_sum<10 and 	lot_rob=$_POST[rob] order by lot_type asc, h_num asc");
...
$date_ff = json_decode($date_js, true);
$re_fresh=$date_ff["rf"];
