...
<div id="column1" class="titleBar">
  <div class="title">บาสเก็ตบอลวันนี้</div>
    <div class="right">
...
<template id="header_1x2_tmpl">
    <tr class="thead_hdp-ou_single-line">
      <th class="th_time" rowspan="2" title="เวลา"><span>เวลา</span></th>
      <th class="th_event even" rowspan="2" title="รายการ"><span>รายการ</span></th>
      <th class="th_full-time" title="เต็มเวลา" colspan="3"><span>เต็มเวลา</span></th>
      <th class="th_half-time even" title="ครึ่งแรก" colspan="3"><span>ครึ่งแรก</span></th>
      <th class="th_last" rowspan="2"></th>
    </tr>
    <tr>
      <th title="เจ้าบ้านชนะ"><span>เจ้าบ้านชนะ</span></th>
      <th title="เสมอ"><span>เสมอ</span></th>
      <th title="ทีมเยือนชนะ"><span>ทีมเยือนชนะ</span></th>
      <th class="even" title="เจ้าบ้านชนะ"><span>เจ้าบ้านชนะ</span></th>
      <th class="even" title="เสมอ"><span>เสมอ</span></th>
      <th class="even" title="ทีมเยือนชนะ"><span>ทีมเยือนชนะ</span></th>
    </tr>
</template>
<template id="header_oe_tmpl">
    <tr class="thead_hdp-ou_single-line">
      <th class="th_time" rowspan="2" title="เวลา"><span>เวลา</span></th>
      <th class="th_event even" rowspan="2" title="รายการ"><span>รายการ</span></th>
      <th class="th_full-time" title="เต็มเวลา" colspan="2"><span>เต็มเวลา</span></th>
      <th class="th_half-time even" title="ครึ่งแรก" colspan="2"><span>ครึ่งแรก</span></th>
      <th class="th_last" rowspan="2"></th>
    </tr>
    <tr>
      <th title="คี่"><span>คี่</span></th>
      <th title="คู่"><span>คู่</span></th>
      <th class="even" title="คี่"><span>คี่</span></th>
      <th class="even" title="คู่"><span>คู่</span></th>
    </tr>
</template>
...
<template id="leage_tmpl_1x2">
  <tbody>
  <tr valign="middle" style="cursor:pointer">      
    <td class="tabtitle"></td>
    <td colspan="8" class="tabtitle"></td>
  </tr>
  </tbody>
</template>
<template id="leage_tmpl_oe">
  <tbody>
  <tr valign="middle" style="cursor:pointer">      
    <td class="tabtitle"></td>
...
<template id="ball_tmpl_1">
  <tr align="center" class="displayOn">      
...
<template id="ball_tmpl_1x2">
  <tr align="center" class="displayOn">      
    ...
    <td nowrap="nowrap" class="" style="width: 60px;"><a></a></td>
    <td nowrap="nowrap" class="" style="width: 60px;"><a></a></td>
    <td nowrap="nowrap" class="" style="width: 60px;"><a></a></td>
    <td nowrap="nowrap" class="" style="width: 60px;"><a></a></td>
    <td nowrap="nowrap" class="" style="width: 60px;"><a></a></td>
...
<template id="ball_tmpl_oe">
  <tr align="center" class="displayOn">      
    ...
    <td nowrap="nowrap" class="" style="width: 90px;"><a></a></td>
    <td nowrap="nowrap" class="" style="width: 90px;"><a></a></td>
    <td nowrap="nowrap" class="" style="width: 90px;"><a></a></td>
    <td nowrap="nowrap" class="" style="width: 90px;"><a></a></td>
    <td align="center" class="breakLine"><span class="displayOn"></span></td>    
  ...
  if(wl==1){
    ...
    if (JSON.stringify(arr_data) != JSON.stringify(old_arr_data) || ci == 1) {
      ...
      var list_ball_live = [];
        ...
        if((data_ball[k]["b_live"]==1 || data_ball[k]["b_live"]==2 || data_ball[k]["b_live"]==3) && data_ball[k]["b_zone"]==7){
...
function set_table(data , datax , tyx){
  ...
  if(page_show==2){
    var template_header = document.querySelector('#header_1x2_tmpl');
    var template_leage = document.querySelector('#leage_tmpl_1x2');
  }else if(page_show==3){
    var template_header = document.querySelector('#header_oe_tmpl');
    var template_leage = document.querySelector('#leage_tmpl_oe');
  }else{
    if(dp_mode=="1"){
    ...
    var load_tb_ball = document.querySelector("."+lg);
      ...
      for (var k3 in dball) {
        var ball_data = dball[k3].bData;
          ...
          if(page_show==2){
            var template_ball = document.querySelector('#ball_tmpl_1x2');
          }else if(page_show==3){
            var template_ball = document.querySelector('#ball_tmpl_oe');
          }else{
            if(dp_mode=="1"){
              ...
              var template_ball = document.querySelector('#ball_tmpl_2');
            }
          }
          ...
          if(page_show==2){
            set_table_1x2(clone_ball , ball_data);
            if(dball[k3].bBF==""){
            ...
            set_table_oe(clone_ball , ball_data);
            if(dball[k3].bBF==""){
              var elm = document.getElementsByClassName("lge_ball_live"+ball_data["b_zone_id"]);
              $(clone_ball).insertAfter(elm);
            }else{
