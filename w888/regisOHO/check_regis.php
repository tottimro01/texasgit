...
if($rex[m_id]!=""){
	...
	$smsto=$tphone;
	$text="www.lotzx.com User:$tphone     Pass:$tpass";
	$tpass = md5($tpass);
...
,'$rs_mem_use[m_lotto_force_super]' ,'$rs_mem_use[m_lotto_myshare_super]' 
 ...
 ,'$pay_txt','$pay_txt' ,'$pay_txt' ,'$pay_txt' ,'$pay_txt' 
,'$dis_txt_super' ,'$dis_txt_senior' ,'$dis_txt_master' ,'$dis_txt_agent' ,'$dis_txt_member'
...
$_SESSION['HTTP_REFERER'] = "";	
         ...
         top.document.location='../checky_login.php?u=".$tuser."&toke=".($tpass)."';
      </script>";
