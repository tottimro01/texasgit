...
<body>
  <style>
	...
	.input-wrapper .ip input,
	.input-wrapper .ip select {
    	width: 100%;
             ...
             <div id="ccontent" class="contentBox">
                ...
                <p>
                  ...
                  <div class="input-wrapper">
                    ...
                    <span class="ip"><?=$user?> </span>
                  </div>

                  <div class="input-wrapper">
                    <span class="lb">รหัสผ่าน : </span>
                    <span class="ip"><input name="tpass" type="text" class="txt" id="tpass" maxlength="10" required></span>
                  </div>

                  <div class="input-wrapper">
                    <span class="lb">ยืนยันรหัสผ่าน : </span>
                    <span class="ip"><input name="tpassc" type="text" class="txt" id="tpassc" maxlength="10" required></span>
                  </div>

                  <div class="input-wrapper">
                    <span class="lb">เบอร์โทร : </span>
                    <span class="ip"><input name="tphone" type="text" class="txt" id="tphone" size="15" maxlength="10" required onkeydown="return numberonly2(event);"></span>
                  </div>
                  ...
                  <div class="input-wrapper">
                    ...
                    <span class="ip"><input name="tbcode" type="text" class="txt" id="tbcode" maxlength="10" required onkeydown="return numberonly2(event);"></span>
                  </div>
                  ...
                  <div class="input-wrapper">
                    ...
                    <span class="ip"><input name="tbpass" type="text" class="txt" id="tbpass" size="10" maxlength="4" required onkeydown="return numberonly2(event);"></span>
                  </div>
                  ...
                  <div class="input-wrapper">
                    <button name="b_login" id="b_login" class="bt red-bt" onclick="ConfirmRegis();">สมัครสมาชิก</button>
                  </div>
                </form>
