...
var myCountdown1 = new Countdown({
      ...
      <input name="col2money" type="button" class="btn_le btn_small" id="col2money" value="<?=$lang_member[525]?>" onClick="window.location.href='main_lotto.php?tlot=2ud&vvw='+fw">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <table width="300" border="0" align="center" cellpadding="0" cellspacing="1" class="txt_back11n bg_table">
                            ...
                            <tr>
                              <td height="25" colspan="3" align="center" class="tb_title_lotto"><?=$lang_member[411];?></td>
                            </tr>
                            <tr>
                              <td align="center"><input name="create_num" type="button" class="btn_le btn_small w50px yellow" id="create_num" value="<?=$lang_member[527]?>" onClick="create_nums()" ></td>
							...
							?>
                            <tr>
                              <td height="22" align="center" class="bg_td"><input name="num<?=$i?>" type="text" class="txt_center12b input lotnum _<?=$i?>" data-lotbet-row="<?=$i?>" id="tab<?=$tab?>" size="7" maxlength="2" onKeyDown="return numberonly(event,this)" onKeyUp="next_enter(event,<?=$tab?>);"></td>
                               <td align="center" class="bg_td"><? $tab=$tab+1?><? if($lot_pay_big5[4]>0){ ?><input name="col1<?=$i?>" type="text" class="txt_center12n input lotbet 1 _<?=$i?>" data-lotbet-col="1" data-lotbet-row="<?=$i?>" id="tab<?=$tab?>" size="10" maxlength="6" onKeyDown="return numberonly(event,this)" onKeyUp="next_enter(event,<?=$tab?>);"><? }?></td>
