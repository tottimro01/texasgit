...
<!--<script language="JavaScript" type="text/javascript" src="commJS/odds/HTFT_Def.js?v=201109160917"></script>-->
<script language="JavaScript" type="text/javascript" src="commJS/odds/HTFT.js"></script>
...
<body id="HTFT" onload="OverWriteFormSubmit();refreshAll();checkHasParlay('t','1');">
...
<div class="titleBar">
    <div class="title">ครึ่งแรก / เต็มเวลา</div>
    <div class="right">
...
<li  title='เรียงลำดับตามปกติ' onmouseover="onOver(this)" onmouseout="onOut(this)" onclick="setSelecter('aSorter',this,'0',true);"><div class="icon_NO"></div>เรียงลำดับตามปกติ</li>
        ...
        <a href="javascript:openLeague(640,'เลือกลีค','t','1','16','0','HTFT');" class="button selectLeague" title="เลือกลีค">
        	<span>
...
<form action="HTFT_data.php" target="DataFrame_L" name="DataForm_L" style="display: none">
...
<form action="HTFT_data.php" target="DataFrame_D" name="DataForm_D" style="display: none">
