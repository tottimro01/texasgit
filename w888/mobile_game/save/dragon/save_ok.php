...
/*$paywin1=$arr_dragon_pay[$type]+($r1dis/100);
$paywin2=$arr_dragon_pay[$type]+($r2dis/100);
$paywin3=$arr_dragon_pay[$type]+($r3dis/100);
$paywin4=$arr_dragon_pay[$type]+($r4dis/100);
$paywinh=$arr_dragon_pay[$type]+($hdis/100);*/


$paywin1=$arr_dragon_pay[$type];
$paywin2=$arr_dragon_pay[$type];
$paywin3=$arr_dragon_pay[$type];
$paywin4=$arr_dragon_pay[$type];
...
$url_file="../../../games/dragon/json/count_bet.txt";
$js1=array();
