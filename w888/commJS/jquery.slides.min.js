    ...
    a.fn.slides = function(b) {
        return b = a.extend({}, a.fn.slides.option, b), this.each(function() {
            ...
            if (!(2 > e)) {
                ...
                }), b.generatePagination ? (b.prependPagination ? c.prepend("<div class='slides-pagination'><ul class=" + b.paginationClass + "></ul></div>") : c.append("<div class='slides-pagination'><ul class=" + b.paginationClass + "></ul></div>"), d.children().each(function() {
