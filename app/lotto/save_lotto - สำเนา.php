...
$sql="select m_id,m_count,bonus_m_id from bom_tb_member where m_id='".$_SESSION['m_id']."'";
$re_m=sql_array($sql);
if($re_m['m_id']==""){  exit();}
...
$sql="INSERT IGNORE INTO bom_tb_lotto_bill_live (b_date,	b_timestam,	b_datenow ,	m_id	,b_ip	,ok_id	,lot_zone,	lot_rob, b_date_bingo, r_agent_id, b_web_from,b_name,b_no , bonus_m_id, r_id, com_af
) values(
'$view_date','$time_stam',now(),'".$_SESSION['m_id']."','"._bIP()."','$re_ok[ok_id]','$zone','$rob' , '$view_date_bingo','$_SESSION[r_agent_id]' ,'$b_web_from', '$bill_cus_name', '$bill_no','$re_m[bonus_m_id]' , '".$_SESSION['cr_id']."' ,'$af_lotto'
); ";
sql_query($sql);
