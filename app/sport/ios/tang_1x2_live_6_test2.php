...
$url_file=$server_js."txt/json/data_live_6.json";	
...
foreach($arr_zone as $rs){
	...
	foreach($arr_id[md5($rs[b_zone])] as $rss){
		...
		$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["League"]= "Live $rss[b_zone]";
		...
		$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Play_Time"]= "".$rss[b_live_showtime]."";
		$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Play_Score"]= "".$rss[b_t_score_full]."";
		...
		if($rss[b_hdc]!="" and $rss[b_hf]==2){
				...
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Hdc1_FT"]= ""._mtr( $re_m[m_level] ,$rss[b_hdc_1],1,$rss[b_big],$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Hdc2_FT"]= ""._mtr( $re_m[m_level] ,$rss[b_hdc_2],2,$rss[b_big],$se[nam])."";
			...
			if($rss[b_hdc]!="" and $rss[b_hf]==1){
				...
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Hdc1_HT"]= ""._mtr( $re_m[m_level] ,$rss[b_hdc_1],1,$rss[b_big],$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Hdc2_HT"]= ""._mtr( $re_m[m_level] ,$rss[b_hdc_2],2,$rss[b_big],$se[nam])."";
			...
			if($rss[b_goal]!="" and $rss[b_hf]==2){
				...
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Goal1_FT"]=  ""._mtr( $re_m[m_level] ,$rss[b_goal_1],1,$rss[b_big],$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Goal2_FT"]=  ""._mtr( $re_m[m_level] ,$rss[b_goal_2],1,$rss[b_big],$se[nam])."";
			...
			if($rss[b_goal]!="" and $rss[b_hf]==1){
				...
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Goal1_HT"]=  ""._mtr( $re_m[m_level] ,$rss[b_goal_1],1,$rss[b_big],$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Goal2_HT"]=  ""._mtr( $re_m[m_level] ,$rss[b_goal_2],1,$rss[b_big],$se[nam])."";
			...
			if($rss[b_1x2_1]!=0  and $re_m[m_1x2]==1 and $rss[b_hf]==2){
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["X1_FT"]= ""._mtr( $re_m[m_level] ,$rss[b_1x2_1],1,1,$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["XX_FT"]= ""._mtr( $re_m[m_level] ,$rss[b_1x2_x],1,1,$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["X2_FT"]= ""._mtr( $re_m[m_level] ,$rss[b_1x2_2],1,1,$se[nam])."";
			...
			if($rss[b_1x2_1]!=0  and $re_m[m_1x2]==1 and $rss[b_hf]==1){
				...
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["X1_HT"]= ""._mtr( $re_m[m_level] ,$rss[b_1x2_1],1,1,$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["XX_HT"]= ""._mtr( $re_m[m_level] ,$rss[b_1x2_x],1,1,$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["X2_HT"]= ""._mtr( $re_m[m_level] ,$rss[b_1x2_2],1,1,$se[nam])."";
			...
			if($rss[b_odd]!=0  and $re_m[m_1x2]==1 and $rss[b_hf]==2){
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Odd_FT"]= ""._mtr( $re_m[m_level] ,$rss[b_odd],1,1,$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Even_FT"]=""._mtr( $re_m[m_level] ,$rss[b_even],1,1,$se[nam])."";
			...
			if($rss[b_odd]!=0  and $re_m[m_1x2]==1 and $rss[b_hf]==1){
				...
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Odd_HT"]= ""._mtr( $re_m[m_level] ,$rss[b_odd],1,1,$se[nam])."";
				$arrData2[$zone_index][$rss[b_id]][$rss[b_add]]["Even_HT"]=""._mtr( $re_m[m_level] ,$rss[b_even],1,1,$se[nam])."";
