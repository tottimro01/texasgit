...
require ("../inc/function.php");
	...
	$js = "[";
	$sql=sql_query("select * from bom_tb_ball_list where   b_date='$date'  and b_step='2' and  	b_rob='"._rob()."' and b_active='1'  and r_id='1'  order by b_active desc ,  b_top asc, b_top_team asc, b_asc asc, b_date_play asc , 	b_id asc  , b_add asc");
