<?php
  ...
  if($_POST["rule_lang"]!=""){
  	$url_file="../lang/rule/".$_POST["rule_lang"]."_".$ty.".php";    
...
<body style="margin: 0px;">
	<h3 style="width: 50%; float: left; margin-left: 10px;"><?=$_GET["n"]?></h3>
	<form method="POST">
		<select style="float: right; margin: 10px;" name="rule_lang" onchange="window.location.href='rule.php?lg='+this.value+'&ty=<?=$ty?>&n=<?=$_GET[n]?>';">
		...
		<textarea style="width: 90%; height: 90vh; display: block; margin: auto;" name="rule_txt"><? include "../lang/rule/".$_GET["lg"].'_'.$ty.'.php'; ?></textarea>
