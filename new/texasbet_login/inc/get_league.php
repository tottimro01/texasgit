...
<tr>
  <td colspan="3" align="center"><input type="submit" value="<?=$lang_m[2];?>" class="btn_le" onclick="save_leage()" style="width:100px;height:25px;cursor:pointer;">
    <input type="button" value="<?=$lang_m[3];?>" class="btn_le" onClick="show_league();" style="width:100px;height:25px;cursor:pointer; background:#F00;">
    <br>
    <br></td>
</tr>
