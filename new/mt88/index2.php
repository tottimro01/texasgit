...
<div class="box__auth"> 
  ...
  <div class="container content">
    <h1><img src="assest_login/images/logo_ping.gif?v=<?=$cache_img;?>"></h1>
    <div class="row">
...
<?php 
 ...
 $postdata = http_build_query(
  ...
  $temp = file_get_contents('http://wan1991.com/api/get_lottoResult.php', false, $context);

  $lot_rs = json_decode($temp,1);

  // print_r($lot_rs['ed_lot1']);
          ...
          <div class="card border text-center">
            ...
            <div class="card-body  background-card-body  p-1">
              <div class="row">
                <div class="col-6 border-right border-secondary">
                  <p class="title-type text-center m-0"><?=$lang_member[2363]?></p>
                  <p class="number text-center m-0"><?=($ed_lot2_3[0]=="" ? "xxx" : $ed_lot2_3[0])?> 99</p>
                </div>
                <div class="col-6">
                  <p class="title-type text-center m-0"><?=$lang_member[2361]?></p>
