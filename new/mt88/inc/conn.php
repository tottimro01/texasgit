...
function sql_num_sp($sqlSelect){	
 ...
 mysqli_set_charset($conn2, "utf8");
	...
	##################################Sport#############################
	###############################
function sql_query_sp2($sqlSelect){	

	global $hostname_conn4;
	global $username_conn4;
	global $password_conn4;
	global $database_conn4;

 $conn4 = @mysqli_connect($hostname_conn4, $username_conn4, $password_conn4, $database_conn4)or die("No connect");
 mysqli_set_charset($conn4, "utf8");


 $result =  @mysqli_query($conn4, $sqlSelect);
...
###############################
function sql_array_sp2($sqlSelect){	
	global $hostname_conn4;
	global $username_conn4;
	global $password_conn4;
	global $database_conn4;
...
###############################
function sql_num_sp2($sqlSelect){	
