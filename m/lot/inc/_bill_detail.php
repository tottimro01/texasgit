...
?>
{
  "data": [
  <? 
 $n = sql_num("select * from bom_tb_lotto_bill_play_live where bill_id='$bid' and  m_id='$_SESSION[mid]'");
 if($n==0){
 ...
 $sql=sql_query("select * from bom_tb_lotto_bill_play_live where bill_id='$bid' and  m_id='$_SESSION[mid]' order by lot_type asc, play_number asc");
	 }
