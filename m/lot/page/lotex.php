...
<div class="row">
    ...
    <div class="panel-heading">
		<h1 class="panel-title thaisan" align="center" style="font-size:32px; color:#000"><strong><!-- พิเศษ --><?=$lang_special;?></strong></h1>
    </div>
    <div class="panel-body">
        <form name="lotex" method="post" action="main.php?cmd=lotex&subcmd=save" id="lotex" onSubmit="return save_lotto();">
			<div class="row">
            
            <div class="col-xs-12 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- 19 หาง --><?=$lang_l19Harng;?></div>
            <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- เลข --><?=$lang_number;?></div>
            <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- บน --><?=$lang_top1;?></div>
            <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- ล่าง --><?=$lang_bot;?></div>
            ...
            <div class="col-xs-12 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- 6 กลับ --><?=$lang_l6Gub;?></div>
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- เลข --><?=$lang_number;?></div>
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- บน --><?=$lang_top1;?></div>
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- ล่าง --><?=$lang_bot;?></div>
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- หน้า --><?=$lang_Na;?></div>
            <div class="col-xs-3" align="right"><input name="txtLot6g1" type="tel" class="form-control" id="txtLot6g1" style="margin-top:5px; margin-bottom:5px" onKeyPress="checknumber()" maxlength="3"></div>
            <div class="col-xs-3" style="margin-top:5px; margin-bottom:5px"><input name="txtLot6gup1" type="tel" class="form-control" id="txtLot6gup1" onChange="dokeyup(this);" onKeyPress="checknumber()" onKeyUp="dokeyup(this);" maxlength="10"></div>
            <div class="col-xs-3" style="margin-top:5px; margin-bottom:5px"><input name="txtLot6gdown1" type="tel" class="form-control" id="txtLot6gdown1" onChange="dokeyup(this);" onKeyPress="checknumber()" onKeyUp="dokeyup(this);" maxlength="10"></div>
            <div class="col-xs-3" style="margin-top:5px; margin-bottom:5px"><? if($lot_pay_big5[16]>0){ ?><input name="txtLot6gfdown1" type="tel" class="form-control" id="txtLot6gfdown1" onChange="dokeyup(this);" onKeyPress="checknumber()" onKeyUp="dokeyup(this);" maxlength="10"><? } ?></div>
            
            <div class="col-xs-6 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- เลขพี่น้อง --><?=$lang_pheeNongNum;?></div>
            <div class="col-xs-6 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- เลขเบิ้ล --><?=$lang_doubleNumber;?></div>
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- บน --><?=$lang_top1;?></div>
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- ล่าง --><?=$lang_bot;?></div>
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- บน --><?=$lang_top1;?></div>
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center"><!-- ล่าง --><?=$lang_bot;?></div>
            ...
            <? if($lot_pay_big5[8]>0){ ?>
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left"><!-- 1 ตัวบน สูง-ต่ำ --><?=$lang_l1tuaBon1;?></div>
                ...
                <div class="col-xs-2 thaisan" align="left" style="color:#333333; font-size:16px; margin-top:5px"><!-- สูง --><?=$lang_height;?></div>
                <div class="col-xs-2" align="right"><input name="txtLot1top" type="radio" class="form-control" value="L"></div>
                <div class="col-xs-2 thaisan" align="left" style="color:#333333; font-size:16px; margin-top:5px"><!-- ต่ำ --><?=$lang_low;?></div>
                <div class="col-xs-4sths" style="margin-top:5px; margin-bottom:5px"><input name="txtLot11rice" type="tel" class="form-control" id="txtLot11rice" onChange="dokeyup(this);" onKeyPress="checknumber()" onKeyUp="dokeyup(this);" maxlength="10"></div>
                <? } ?>
                
                <? if($lot_pay_big5[9]>0){ ?>
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left"><!-- 2 ตัวบน สูง-ต่ำ --><?=$lang_l2tuaBon1;?></div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
                ...
                <div class="col-xs-2 thaisan" align="left" style="color:#333333; font-size:16px; margin-top:5px"><!-- ต่ำ --><?=$lang_low;?></div>
                <div class="col-xs-4sths" style="margin-top:5px; margin-bottom:5px"><input name="txtLot21rice" type="tel" class="form-control" id="txtLot21rice" onChange="dokeyup(this);" onKeyPress="checknumber()" onKeyUp="dokeyup(this);" maxlength="10"></div>
                <? } ?>
                 
			<? if($lot_pay_big5[10]>0){ ?>
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left"><!-- 3 ตัวบน สูง-ต่ำ --><?=$lang_l3tuaBon1;?></div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
                <div class="col-xs-2" align="right"><input name="txtLot3top" type="radio" class="form-control" value="H"></div>
                <div class="col-xs-2 thaisan" align="left" style="color:#333333; font-size:16px; margin-top:5px"><!-- สูง --><?=$lang_height;?></div>
                <div class="col-xs-2" align="right"><input name="txtLot3top" type="radio" class="form-control" value="L"></div>
                <div class="col-xs-2 thaisan" align="left" style="color:#333333; font-size:16px; margin-top:5px"><!-- ต่ำ --><?=$lang_low;?></div>
                <div class="col-xs-4sths" style="margin-top:5px; margin-bottom:5px"><input name="txtLot31rice" type="tel" class="form-control" id="txtLot31rice" onChange="dokeyup(this);" onKeyPress="checknumber()" onKeyUp="dokeyup(this);" maxlength="10"></div>
                <? } ?>
                
				<? if($lot_pay_big5[11]>0){ ?>
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left"><!-- 2 ตัวล่าง สูง-ต่ำ --><?=$lang_l2tuaBot1;?></div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
                ...
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left"><!-- คี่-คู่ --><?=$lang_oddEven;?></div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
                <div class="col-xs-2" align="right"><input name="txtLottwin" type="radio" class="form-control" value="E"></div>
                <div class="col-xs-2 thaisan" align="left" style="color:#333333; font-size:16px; margin-top:5px"><!-- คี่ --><?=$lang_odd;?></div>
                <div class="col-xs-2" align="right"><input name="txtLottwin" type="radio" class="form-control" value="K"></div>
                <div class="col-xs-2 thaisan" align="left" style="color:#333333; font-size:16px; margin-top:5px"><!-- คู่ --><?=$lang_even;?></div>
                ...
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left"><!-- 2ใน3 --><?=$lang_l2in3;?></div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
                <div class="col-xs-8" align="right"><input name="txtLot2in3" type="tel" class="form-control" id="txtLot2in3" style="margin-top:5px; margin-bottom:5px" onKeyPress="checknumber()" maxlength="2" onKeyUp="chtype('txtLot2in3',2);"></div>
                <div class="col-xs-4sths" style="margin-top:5px; margin-bottom:5px"><input name="txtLot2in3price" type="tel" class="form-control" id="txtLot2in3price" onChange="dokeyup(this);" onKeyPress="checknumber()" onKeyUp="dokeyup(this);" maxlength="10"></div>
                <? } ?>
                
                
                <? if($lot_pay_big5[14]>0){ ?>
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left"><!-- 3ใน4 --><?=$lang_l3in4;?></div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
                <div class="col-xs-8" align="right" style="margin-top:5px; margin-bottom:5px"><input name="txtLot3in4" type="tel" class="form-control" id="txtLot3in4" onKeyPress="checknumber()" maxlength="4" onKeyUp="chtype('txtLot3in4',3);"></div>
                ...
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left"><!-- 3ใน5 --><?=$lang_l3in5;?></div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
                <div class="col-xs-8" align="right" style="margin-top:5px; margin-bottom:5px"><input name="txtLot3in5" type="tel" class="form-control" id="txtLot3in5" onKeyPress="checknumber()" maxlength="5" onKeyUp="chtype('txtLot3in5',3);"></div>
                ...
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left"><!-- เลขปักหลัก --><?=$lang_puglug;?></div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
				<? if($lot_pay_big5[21]>0){ ?>
                <div class="col-xs-4sths thaisan" style="color:#333333; font-size:16px; margin-top:5px" align="right"><!-- หลักหน่วย --><?=$lang_l1digits;?> : </div>
                ...
                <div class="col-xs-4sths thaisan" style="color:#333333; font-size:16px; margin-top:5px" align="right"><!-- หลักสิบ --><?=$lang_l2digits;?> : </div>
                <div class="col-xs-4sths" style="margin-top:5px">
                ...
                <? } ?>
                <? if($lot_pay_big5[23]>0){ ?>
                <div class="col-xs-4sths thaisan" style="color:#333333; font-size:16px; margin-top:5px; margin-bottom:5px" align="right"><!-- หลักร้อย --><?=$lang_l3digits;?> : </div>
                <div class="col-xs-4sths" style="margin-top:5px; margin-bottom:5px">
                	<select class="form-control" id="txtHund" name="txtHund">
                    	<option value="">---</option>
                    	<? for($k=0;$k<10;$k++){ ?>
                ...
                <div class="col-xs-4sths" style="margin-top:5px; margin-bottom:5px"><input name="txtHundprice" type="tel" class="form-control" id="txtHundprice" onChange="dokeyup(this);" onKeyPress="checknumber()" onKeyUp="dokeyup(this);" maxlength="10"></div>
                <? } ?>
                <? } ?>
                
                <div class="col-xs-8ths"><button class="btn btn-warning btn-block thaisan" type="submit" style="margin-top:10px"  id="btsave"><strong><i class="fa fa-floppy-o"></i> <!-- บันทึกข้อมูล --><?=$lang_save;?></strong></button></div>
            	<div class="col-xs-4ths"><button class="btn btn-danger btn-block thaisan"  type="button" onClick="clear_txt();" style="margin-top:10px"   id="btreset" ><strong><!-- ยกเลิก --><?=$lang_cancel;?></strong></button></div>
<script>
function clear_txt(){
	$("#lotex").trigger("reset");
	<? if($lot_pay_big5[13]>0){ ?>
