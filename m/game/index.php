  ...
  <div class="loader"></div>
    <div class="container">
      ...
      <form class="form-signin" name="login">
        ...
        <input type="text" name="txtUser" id="txtUser" class="form-control form-group-lg" placeholder="ชื่อผู้ใช้งาน" required autofocus style="background-color:#FFFF99">
        
        <label for="psw" class="sr-only">รหัสผ่าน</label>
        <input type="password" name="txtPsw" id="txtPsw" class="form-control form-group-lg" placeholder="รหัสผ่าน" required style="margin-top:1px;background-color:#FFFF99">
        
        <span id="mySpanLogin" class="thaisan" style="padding:1px; font-size:10px"></span>
        
        <button class="btn btn-lg btn-warning btn-block thaisan" type="button" style="margin-top:0px" OnClick="JavaScript:doCallAjaxLogin();"><strong><span class="glyphicon glyphicon-off"></span> เข้าสู่ระบบ</strong></button>
      </form>
