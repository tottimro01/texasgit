...
if($_SESSION[bocklogin]>=5){
   echo "<span style='color:#FFF'/><b><i class='fa fa-times-circle'></i></b> ระงับ!!! เนื่องจากเข้าระบบผิดเกินจำกัด</span>";
     exit();
}
	...
	if(trim($strUsername) == "")
	{
		echo "<span style='color:#FFF'/><b><i class='fa fa-times-circle'></i></b> โปรดระบุชื่อผู้ใช้งาน</span>";
		exit();
	}
	
	if(trim($strPassword) == "")
	{
		echo "<span style='color:#FFF'/><b><i class='fa fa-times-circle'></i></b> โปรดระบุรหัสผ่าน</span>";
		exit();
	}
...
if($jsmm["open"]==0){
		...
		echo "<span style='color:#FFF'/><b><i class='fa fa-times-circle'></i></b> กำลังอยู่ในการ ซ่อมบำรุง ประมาน 45 นาที</span>";
		exit();
...
if($c_log>0){
echo "<span style='color:#FFF'/><b><i class='fa fa-times-circle'></i></b> มีผู้ใช้งานอยู่ กรุณารอ 2 นาที</span>";
exit();
	}
	###################ห้ามเข้าซ้อน	
...
if($re[m_active]!=1){
		echo "<span style='color:#FFF'/><b><i class='fa fa-times-circle'></i></b> คุณถูกระงับการใช้งานกรุณาติดต่อผู้ดูแล</span>";
		exit();
}else{
############################################
@session_start();
