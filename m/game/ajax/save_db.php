...
$bet_new= round((1000/$hpay[$type_lot]),2);
$x_sum=$x_sum*$bet_new;	
	}
...
#######################################################LOG
	 $sql="select play_id from  bom_tb_lotto_bill_play  where m_id='$_SESSION[mid]' and  play_number='$q_num' and  ok_id='$re_ok[ok_id]' and  lot_type='$type_lot' and b_total='$x_sum' order by  play_id desc limit 1  ";
	 $rex=sql_array($sql);
	 $tosum=-$x_sum;
	 $tosum2=$x_sum-$adis;
