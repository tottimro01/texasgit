...
$("#fack_count2").load('../bacarat2/fack_count.php');
   }, 5000);
   $.ajaxSetup({ cache: false });
...
//$(this).load('../bacarat2/_process.php?t='+Math.random());
	}
...
<hr>
<span id="fack_count2"></span>


<?
$url_file="/home/lotto/domains/555king.com/public_html/bacarat/json/bacarat_time.txt";
$bet_time=time();
$js1=array();
#####################################Lock LOTTO
...
$url_file="/home/lotto/domains/555king.com/public_html/bacarat/json/bacarat_win.txt";
$ok1='baca';
$ok2='baca';
$ok3='baca';
$ok4='baca';
