...
?>
    <?
    $sql="select * from bom_tb_hilo_bill_play where m_id='$_SESSION[mid]' and bill_id='$bet_id'  order by play_id desc limit 100";
	$num=sql_num($sql);
	if($num>0){
	?>
...
<table width="185" border="0" cellspacing="1" cellpadding="3" class="bg_table" >
  <tr>
<td height="25" align="center" colspan="3" class="txt_white12btitle"><span id="s_type"><strong class="cw">ไฮโล</strong></span></td>  
  </tr>
