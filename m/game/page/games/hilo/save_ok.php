...
$rex=sql_array($sql);
	...
	$sql="INSERT IGNORE INTO  bom_tb_from_bonus_hilo  (	play_id,	b_date_bingo	,b_total	,fb_com,	m_id	,m_from, bill_id) values ( '$rex[play_id]',now(),'$sumbet','$xx_bonus','$rex[m_id]' ,'$_SESSION[m_from]','$bet_id') ";
	sql_query($sql);
	#######################################################อัพเดทเงินสมาชิก
