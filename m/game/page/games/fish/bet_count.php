...
<tr>
  <td width="33%" align="right">'.number_format($a1+$b1).'</td>
  <td width="33%" align="right">'.number_format($a2+$b2).'</td>
  <td width="33%" align="right">'.number_format($a3+$b3).'</td>
</tr>
<tr>
  <td width="33%" align="right">'.number_format($a4+$b4).'</td>
  <td width="33%" align="right">'.number_format($a5+$b5).'</td>
  <td width="33%" align="right">'.number_format($a6+$b6).'</td>
</tr>
</table>';
