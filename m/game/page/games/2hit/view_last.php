...
?>
    <?
    $sql="select * from bom_tb_color_bill_play where m_id='$_SESSION[mid]' and bill_id='$bet_id'  order by play_id desc limit 100";
	$num=sql_num($sql);
	if($num>0){
	?>
...
<tr>
<td height="25" align="center" colspan="3" class="txt_white12btitle"><span id="s_type"><strong class="cw">เสื้อแดง-เสื้อเหลือง</strong></span></td>  
  </tr>
