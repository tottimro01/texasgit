...
if($n==$n2){
	...
	if($arr[0]==8 and $arr[2]!=7 and $hack[$arr[0]]>0){
		...
		//3ตัวเลข
		//no_h($arr[2]);
		echo "ออกอะไรก็ได้โดยที่ไม่ใช่สูงและต้องไม่มีเลข $arr[2]<br>";
		...
		//3สูง
		//no_h($arr[2]);
		echo "ออกอะไรก็ได้โดยที่ไม่ใช่สูงและต้องไม่มีเลข $arr[0]<br>";
		$ex_sc1 = array("3"=>3,"2"=>2,"1"=>1);
		unset($ex_sc1[$arr[0]]);
		$ex_sc2 = array("4"=>4,"1"=>1,"2"=>2);
		unset($ex_sc2[$arr[0]]);
		...
		//3ตัวเลข
		//no_l($arr[2]);
		echo "ออกอะไรก็ได้โดยที่ไม่ใช่ต่ำและต้องไม่มีเลข $arr[2]<br>";
		...
		//3ต่ำ
		//no_l($arr[2]);
		echo "ออกอะไรก็ได้โดยที่ไม่ใช่ต่ำและต้องไม่มีเลข $arr[0]<br>";
		$ex_sc1 = array("4"=>4,"5"=>5,"6"=>6);
		unset($ex_sc1[$arr[0]]);
		$ex_sc2 = array("3"=>3,"4"=>4,"5"=>5);
		unset($ex_sc2[$arr[0]]);
		...
		//3สูง
		//no_l($arr[1]);
		echo "ออกสูงและต้องไม่มีเลข $arr[1]<br>";
		$ex_sc1 = array("4"=>4,"5"=>5,"6"=>6);
		unset($ex_sc1[$arr[1]]);
		...
		//3ต่ำ
		//no_h($arr[1]);
		echo "ออกต่ำและต้องไม่มีเลข $arr[1]<br>";
		$ex_sc1 = array("3"=>3,"2"=>2,"1"=>1);
		unset($ex_sc1[$arr[1]]);
		$ex_sc2 = array("4"=>4,"1"=>1,"2"=>2);
		unset($ex_sc2[$arr[1]]);
...
<table width="100%" border="1" cellspacing="1" cellpadding="5">
  <tbody>
    <tr>
      ...
      <td width="11%" align="center">ต่ำ</td>
      <td width="11%" align="center">สูง</td>
      <td width="11%" align="center">11ไฮโล</td>
    </tr>
    <tr>
    <? for($i=1;$i<=9;$i++){ ?>
...
<input type="button" value="คำนวณ" onClick="setCal();" name="cal" id="cal">
<br>
<div id="token"></div>