...
<div class="row">
    ...
    <div class="panel-body">
        <form name="lotex" method="post" action="main.php?cmd=lotex&subcmd=save" id="lotex" onSubmit="return save_lotto();">
            ...
            <div class="col-xs-12 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">6 กลับ</div>
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">เลข</div>
            ...
            <div class="col-xs-3 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">หน้า</div>
			...
			<? if($lot_pay_big5[10]>0){ ?>
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left">3 ตัวบน สูง-ต่ำ</div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
                ...
                <div class="col-xs-2 thaisan" align="left" style="color:#333333; font-size:16px; margin-top:5px">ต่ำ</div>
                <div class="col-xs-4sths" style="margin-top:5px; margin-bottom:5px"><input name="txtLot3topprice" type="tel" class="form-control" id="txtLot3topprice" onChange="dokeyup(this);" onKeyPress="checknumber()" onKeyUp="dokeyup(this);" maxlength="10"></div>
                <? } ?>
                ...
                <div class="col-xs-8 thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="left">2ใน3</div>
                <div class="col-xs-4sths thaisan" style="background-color:#666666;font-size:16px;padding-top:10px; padding-bottom:10px;" align="center">&nbsp;</div>
                ...
                <div class="col-xs-4sths thaisan" style="color:#333333; font-size:16px; margin-top:5px; margin-bottom:5px" align="right">หลักร้อย : </div>
