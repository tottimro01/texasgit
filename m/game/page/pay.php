<table class="table table-striped table-bordered" cellspacing="0" width="100%" style="color:#333333;">
        <thead style="background-color:goldenrod; color: #6A4806" class="thaisan">
            <tr>	
                    <th style="white-space:nowrap"><center><?=$lang_lot[29];?></center></th>
                    <th style="white-space:nowrap"><center><?=$lang_m[48];?></center></th>
                    <th style="white-space:nowrap"><center><?=$lang_x[15];?></center></th>
                </tr>
        </thead>
     <? 
 ################Config Member
