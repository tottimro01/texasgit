    ...
    <nav>
        <ul class="list-unstyled main-menu">
          ...
          <span class="thaisan" style="color: #fff">เครดิตที่ได้รับ</span><span class="thaisan" style="float:right; color:#66CC00"><?=number_format($_SESSION['mcredit']);?> บาท</span><br>
           ...
           <li class="thaisan"><a href="main.php?cmd=pay">อัตราจ่าย <span class="icon"></span></a></li>
          <li class="thaisan"><a href="main.php?cmd=fullnumber">เลขเต็ม <span class="icon"></span></a></li>
          <li class="thaisan"><a href="main.php">ผลหวย <span class="icon"></span></a></li>
...
<div class="panel panel-default">
	<div class="panel-heading">
    	<h1 class="panel-title thaisan" align="center" style="font-size:32px; color:#000"><strong>ผลสลากกินแบ่งรัฐบาล</strong></h1>
    </div>
	...
	<div class="panel-body">
        <div class="row">
            <div class="col-xs-6">
                  <div class="panel panel-default" style="border:1px solid gold">
                    <div class="panel-heading" style="background-color:goldenrod; color: #6A4806">
                      <h3 class="panel-title thaisan" style="font-size:20px" align="center">รางวัลที่ 1</h3>
                    </div>
            ...
            <div class="col-xs-6">
                  <div class="panel panel-default" style="border:1px solid gold">
                    <div class="panel-heading" style="background-color:goldenrod; color: #6A4806">
                      <h3 class="panel-title thaisan" style="font-size:20px" align="center">เลขท้าย 2 ตัว</h3>
                    </div>
                    <div class="panel-body" align="center">
            ...
            <div class="col-xs-6">
                  <div class="panel panel-default" style="border:1px solid gold">
                    <div class="panel-heading" style="background-color:goldenrod; color: #6A4806">
                      <h3 class="panel-title thaisan" style="font-size:20px" align="center">3 ล่างหน้า</h3>
                    </div>
                    <div class="panel-body" align="center">
            ...
            <div class="col-xs-6">
                  <div class="panel panel-default" style="border:1px solid gold">
                    <div class="panel-heading" style="background-color:goldenrod; color: #6A4806">
                      <h3 class="panel-title thaisan" style="font-size:20px" align="center">3 ล่าง</h3>
                    </div>
                    <div class="panel-body" align="center">
                      <span class="label label-success" style="font-size:20px"><?=($ex[4] == "") ? "" : $ex[4];?></span> <span class="label label-success" style="font-size:20px"><?=($ex[4] == "") ? "" : $ex[4];?></span>
                    </div>
                  </div>	
            </div>
        </div>
