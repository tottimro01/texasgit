...
$(document).on('click','#BtncolId_0',function(){
	...
	for(var i=0; i<unique.length; i++)
	{
		...
		if(unique[i].length==1)
		{
			...
			$('.bingoNumber:eq( '+i+' )').closest('tr').children('td:eq( 3 )').children('input').val('');	
	...
	var numi=0;
		...
		for( var i=0;i<6;i++)
		{
			html += '<tr class=\'BetInput\'>'+
      		'<td style="width:25%;"><span><input type="tel"  class="rowId_'+i+' colId_0 bingoNumber" maxlength="3" onkeyup="checkBingLength(this)"></span><span>=</span> </td>'+
      		'<td style="width:25%;"><input type="tel" maxlength="12" class="rowId_'+i+' colId_1 bingoPrice"></td>'+
      		'<td style="width:25%;"><input type="tel" maxlength="12" class="rowId_'+i+' colId_2 bingoPrice"></td>'+
      		'<td style="width:25%;"><input type="tel" maxlength="12" class="rowId_'+i+' colId_3 bingoPrice" ></td>'+
      		'</tr>';
