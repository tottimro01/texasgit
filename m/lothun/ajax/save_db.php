...
sql_query($sql);
			...
			########################จำกัดต่อ 1 เลข
			$url_file_5a="../../../json/lotto_hun/".$_POST[zone]."/number/m_".$type_lot."_".$q_num."_".$_SESSION['mid'].".json";
...
$lotset=_cut_iset($_POST[rob], $_SESSION[lotset]);
...
#######################################################LOG
	...
	#######################################################LOG
								...
								$_SESSION[count_sum]=$_SESSION[count_sum]+($x_sum*$rex["lot_i_count"]);
								$_SESSION[count_dis]=$_SESSION[count_dis]+($adis*$rex["lot_i_count"]);
								$_SESSION[count_dis1]=$_SESSION[count_dis1]+($ar1dis*$rex["lot_i_count"]);
								$_SESSION[count_dis2]=$_SESSION[count_dis2]+($ar2dis*$rex["lot_i_count"]);
								$_SESSION[count_dis3]=$_SESSION[count_dis3]+($ar3dis*$rex["lot_i_count"]);
								$_SESSION[count_dis4]=$_SESSION[count_dis4]+($ar4dis*$rex["lot_i_count"]);
								
								$_SESSION[xcount]=$_SESSION[xcount]-($x_sum*$rex["lot_i_count"]);		
