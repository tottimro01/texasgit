  ...
  <div class="loader"></div>
    <div class="container">
      ...
      <form class="form-signin" name="login">
        ...
        <label for="user" class="sr-only"><?=$lang_member[128];?></label>
        ...
        <label for="psw" class="sr-only"><?=$lang_member[73];?></label>
        ...
        <button class="btn btn-lg btn-warning btn-block thaisan" type="button" style="margin-top:0px" OnClick="JavaScript:doCallAjaxLogin();"><strong><span class="glyphicon glyphicon-off"></span> <?=$lang_member[2151];?></strong></button>
      </form>
