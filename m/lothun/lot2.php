...
<div class="row">
	...
	<div class="panel-heading">
		<h1 class="panel-title thaisan" align="center" style="font-size:32px; color:#000"><strong>2 ตัว บน-ล่าง</strong></h1>
    </div>
    ...
    <div class="panel-body">
      <div class="row">
       ...
       <div class="col-xs-4 thaisan" align="center" style="background-color:#333333; font-size:14px; padding-top:10px; padding-bottom:10px; border-right:1px solid #FFFFFF; margin-bottom:5px">เลข</div>
          <div class="col-xs-4 thaisan" align="center" style="background-color:#666666; font-size:14px; padding-top:10px; padding-bottom:10px; border-right:1px solid #FFFFFF; margin-bottom:5px">
