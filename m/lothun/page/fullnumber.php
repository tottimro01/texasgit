...
$url_file9="../../../json/lotto_hun/1/limit.json";		
$d_bet=file_get_contents2($url_file9);
$k_bet = json_decode2($d_bet, true);
#print_r($k_bet);

$url_file1="../../../json/lotto_hun/1/limit_rid/".$_SESSION['crid1'].".json";		
$d_bet1=file_get_contents2($url_file1);
$k_bet1 = json_decode2($d_bet1, true);

$url_file2="../../../json/lotto_hun/1/limit_rid/".$_SESSION['crid2'].".json";		
$d_bet2=file_get_contents2($url_file2);
$k_bet2 = json_decode2($d_bet2, true);

$url_file3="../../../json/lotto_hun/1/limit_rid/".$_SESSION['crid3'].".json";		
$d_bet3=file_get_contents2($url_file3);
$k_bet3 = json_decode2($d_bet3, true);

$url_file4="../../../json/lotto_hun/1/limit_rid/".$_SESSION['crid4'].".json";		
...
<div class="row">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h1 class="panel-title thaisan" align="center" style="font-size:32px; color:#000"><strong><?=$lang_member[414];?> <?=$arr_zone[1]?></strong></h1>
    </div>
...
$url_file9="../../../json/lotto_hun/2/limit.json";		
$d_bet=file_get_contents2($url_file9);
$k_bet = json_decode2($d_bet, true);
#print_r($k_bet);

$url_file1="../../../json/lotto_hun/2/limit_rid/".$_SESSION['crid1'].".json";		
$d_bet1=file_get_contents2($url_file1);
$k_bet1 = json_decode2($d_bet1, true);

$url_file2="../../../json/lotto_hun/2/limit_rid/".$_SESSION['crid2'].".json";		
$d_bet2=file_get_contents2($url_file2);
$k_bet2 = json_decode2($d_bet2, true);

$url_file3="../../../json/lotto_hun/2/limit_rid/".$_SESSION['crid3'].".json";		
$d_bet3=file_get_contents2($url_file3);
$k_bet3 = json_decode2($d_bet3, true);

$url_file4="../../../json/lotto_hun/2/limit_rid/".$_SESSION['crid4'].".json";		
$d_bet4=file_get_contents2($url_file4);
$k_bet4 = json_decode2($d_bet4, true);
?>
<div class="row">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h1 class="panel-title thaisan" align="center" style="font-size:32px; color:#000"><strong><?=$lang_member[414];?> <?=$arr_zone[2]?></strong></h1>
    </div>
    <div class="panel-body">
      <div class="row">
