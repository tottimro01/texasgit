...
<div class="row">
	...
	<div class="panel-heading">
		<h1 class="panel-title thaisan" align="center" style="font-size:32px; color:#000"><strong><i class="fa fa-cog"></i> <?=$lang_member[45];?></strong></h1>
    </div>
...
<div class="bs-example thaisan">
    <div class="alert alert-danger fade in">
        ...
        <strong><i class="fa fa-times-circle"></i> <?=$lang_member[2349];?>!</strong> <?=$lang_member[2350];?>
    </div>
</div>
<?
...
<div class="bs-example thaisan">
    <div class="alert alert-danger fade in">
        <a href="#" class="close" data-dismiss="alert">&times;</a>
        <strong><i class="fa fa-times-circle"></i> <?=$lang_member[2349];?>!</strong> <?=$lang_member[2237];?>
    </div>
</div>
<?
...
<div class="bs-example thaisan">
    <div class="alert alert-danger fade in">
        <a href="#" class="close" data-dismiss="alert">&times;</a>
        <strong><i class="fa fa-times-circle"></i> <?=$lang_member[2349];?>!</strong> <?=$lang_member[1048];?>
    </div>
</div>
<?
}else{
...
<div class="bs-example thaisan">
    <div class="alert alert-success fade in">
        <a href="#" class="close" data-dismiss="alert">&times;</a>
        <strong><i class="fa fa-check-circle"></i> <?=$lang_member[2349];?>!</strong>
    </div>
</div>
<?
}
...
?>
		<form name="changepsw" method="post" id="changepsw" action="main.php?cmd=changepsw&subcmd=save">
        	...
        	<button class="btn btn-lg btn-warning btn-block thaisan" type="submit" style="margin-top:0px"><strong><i class="fa fa-floppy-o"></i> <?=$lang_member[121];?></strong></button>
