...
<?=$title_set?>
<table width="100%" border="0" cellspacing="2" cellpadding="0" class="table-bordered table-hover" style="min-width: 950px;">
  <tr class="rightbox bg-blue-gradient" style="height: 40px;" >
    <td width="14%" align="center" ><b class="cb">
      3บน
      </b></td>
    <td width="14%"  align="center" ><b class="cb">
      3ล่าง
...
?>
        <tr class="cu" id="tb<?=$type;?>tr<?=$c_num;?>" data-sum="<?=$g_sum?>" onClick="window.open('main.php?p=lotto_money2&g_p=lotto&d=<?=$_GET[d]?>&mset=<?=$_GET[mset]?>&number=<?=$c_num;?>&type=<?=$type;?>&bingo=&asc=3' , '_blank');">
...
*/
    ...
    foreach ($lot_typeArry as $x_type => $value) {
