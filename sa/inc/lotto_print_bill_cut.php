...
############ หาเลข
$s_num=array();
for($x=1;$x<=count($lot_type["th"][1]);$x++){	
	   if(!in_array($lot_type["th"][1][$x], $lot_type_not["th"][1])){ 
...
<table width="750" border="0" cellspacing="2" cellpadding="0" class="ball">
 <tr  bgcolor="#fed38f" >
    <td width="16%" align="center" ><strong><?=$lot_type["th"][1][1];?></strong></td>
    <td width="16%"  align="center" ><strong><?=$lot_type["th"][1][2];?></strong></td>
    <td width="16%"  align="center" ><strong><?=$lot_type["th"][1][3];?></strong></td>
    <td width="16%"  align="center" ><strong><?=$lot_type["th"][1][4];?></strong></td>
    <td width="16%"  align="center" ><strong><?=$lot_type["th"][1][5];?></strong></td>
...
?>
   ...
   <? }}}?>
	...
	# $exbet=explode(',',$re_c[con_bet]);
	 for($x_type=6;$x_type<=count($lot_type["th"][1]);$x_type++){
		 		   if(!in_array($lot_type["th"][1][$x_type], $lot_type_not["th"][1])){ 
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="ball">
       <tr >
        <td colspan="2" align="center" ><b ><?=$lot_type["th"][1][$x_type];?></b></td>
        </tr>
       <tr  bgcolor="#fed38f" >
        <td width="30%" align="center" >เลข</td>
        <td width="70%" align="center" >ยอด</td>
