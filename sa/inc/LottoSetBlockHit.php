          ...
          <form action="inc/lothun_print_bill_cut.php" id="main_form" target="_blank">
                    <div class="row setBlockRow" style="padding: 10px;">
                         ...
                         <div class="mb-4 col-sm-4 col-xs-12 ">
                            ...
                            <select class="form-control lot_sl" style="width: calc(100% - 80px);" id="l_zone" name="l_zone" onchange="set_type(this.value); set_rob(this.value); get_data();">
                         ...
                         <div class="mb-4 col-sm-4 col-xs-12 rob">
                            ...
                            <select class="form-control lot_sl" style="width: calc(100% - 80px);" name="l_rob" id="l_rob"  onchange="get_data();">
...
function submit_data( type ){
  ...
  $.ajax({
    url: 'inc/lottoSetBlockHitSave.php',
    type: 'POST',
    dataType: 'json',
    data: data,
  })
...
function get_data(type="")
{
  ...
  var data = $("#main_form").serializeArray();
   ...
   // $("input#tsum").val("");  
  $.ajax({
    url: 'inc/lottoSetBlockHit_get_Data.php',
    type: 'POST',
    dataType: 'json',
    data: data,
  })
  .done(function(res) {
    ...
    for(var i=0; i < l; i++)
    {
      html+="<tr>"+
             ...
             "<td class=\"vaign_m\">"+
             	"<button type='button' class='btn btn-danger btn-sm' id='btn_del' onclick=\"delete_data('"+res["list"][i]["_nothit_num"]+"',"+res["list"][i]["_lot_type"]+","+res["list"][i]["lot_rob"]+")\">"+
