...
if($_POST["username"] == '' || $_POST["name"] == '' || $_POST["tcurrency"] == '')
{
	$data = array(
	...
	// เปิดปิด
		...
		//football sport step 
			...
			$set_r_sport_myshare = "myshare,".(intval($max_share_config)-intval($_POST["today_share"])).",".(intval($max_share_config)-intval($_POST["sporttoday_share"])).",".(intval($max_share_config)-intval($_POST["boxingtoday_share"])).",".(intval($max_share_config)-intval($_POST["step_share"]));
			$set_r_sport_myshare_live = "myshare,".(intval($max_share_config)-intval($_POST["live_share"])).",".(intval($max_share_config)-intval($_POST["sportlive_share"])).",".(intval($max_share_config)-intval($_POST["boxinglive_share"]));  

			$set_r_sport_force = "force,".(intval($max_share_config)-intval($_POST["today_share"])).",".(intval($max_share_config)-intval($_POST["sporttoday_share"])).",".(intval($max_share_config)-intval($_POST["boxingtoday_share"])).",".(intval($max_share_config)-intval($_POST["step_share"]));
			$set_r_sport_force_live = "force,".(intval($max_share_config)-intval($_POST["live_share"])).",".(intval($max_share_config)-intval($_POST["sportlive_share"])).",".(intval($max_share_config)-intval($_POST["boxinglive_share"]));  
		...
		// lotto 
			...
			foreach ($lot_type[$_SESSION["AGlang"]][1] as $key => $value) {
				...
				$set_r_lotto_myshare .= ",".(intval($max_share_config)-intval($_POST["lotto_share"]));
				$set_r_lotto_force .= ",".(intval($max_share_config)-intval($_POST["lotto_share"]));
			}
		...
		// lotto_hun 
			...
			foreach ($lot_type[$_SESSION["AGlang"]][3] as $key => $value) {
				...
				$set_r_lotto_hun_myshare .= ",".(intval($max_share_config)-intval($_POST["lotto_share_hun"]));
				$set_r_lotto_hun_force .= ",".(intval($max_share_config)-intval($_POST["lotto_share_hun"]));
			}
			...
			foreach ($lang_g["setpay"] as $key => $value) {
				...
				$set_r_lotto_hun_set_myshare .= ",".(intval($max_share_config)-intval($_POST["lotto_hun_set_share"]));
			}

			// game 
			$set_r_games_share = "share,".$_POST["game_share"]; 
			$set_r_games_myshare = "myshare,".(intval($max_share_config)-intval($_POST["game_share"]));
			$set_r_games_force = "force,".(intval($max_share_config)-intval($_POST["game_share"]));
		...
		// casino 
			...
			foreach ($lang_g["casino_share"] as $key => $value) {
				...
				$set_r_casino_myshare .= ",".(intval($max_share_config)-intval($_POST["casino_share".$key]));
				$set_r_casino_force .= ",".(intval($max_share_config)-intval($_POST["casino_share".$key]));		
		...
		$xy['lotto']['set_r_lotto_max'] = $set_r_lotto_max;
		$xy['lotto']['set_r_lotto_min'] = $set_r_lotto_min;
		...
		$xy['lotto_hun']['set_r_lotto_hun_max'] = $set_r_lotto_hun_max;
		$xy['lotto_hun']['set_r_lotto_hun_min'] = $set_r_lotto_hun_min;
		...
		$sql="update bom_tb_agent set r_open = '".$r_open."', r_currency = '".$tcurrency."', r_name = '".$name."', r_phone = '".$telephone."' ,r_sport_share = '".$set_r_sport_share."' ,r_sport_share_live = '".$set_r_sport_share_live."' ,r_sport_dis = '".$set_r_sport_dis."' ,r_sport_max = '".$set_r_sport_max."' ,r_sport_min = '".$set_r_sport_min."' ,r_sport_step_max = '".$set_r_sport_step_max."' ,r_sport_step_min = '".$set_r_sport_step_min."' ,r_sport_step_day = '".$set_r_sport_step_day."' ,r_sport_step_paymax = '".$set_r_sport_step_paymax."' ,r_sport_step2 = '".$set_r_sport_step2."' ,r_sport_step_dis = '".$set_r_sport_step_dis."' ,r_lotto_share = '".$set_r_lotto_share."'  ,r_lotto_open = '".$r_lotto_open."' ,r_lotto_max = '".$set_r_lotto_max."',r_lotto_min = '".$set_r_lotto_min."',r_lotto_pay1 = '".$set_r_lotto_pay1."' ,r_lotto_dis1 = '".$set_r_lotto_dis1."' ,r_lotto_pay2 = '".$set_r_lotto_pay2."' ,r_lotto_dis2 = '".$set_r_lotto_dis2."',r_lotto_pay3 = '".$set_r_lotto_pay3."' ,r_lotto_dis3 = '".$set_r_lotto_dis3."',r_lotto_hun_share = '".$set_r_lotto_hun_share."' ,r_lotto_hun_open = '".$r_lotto_hun_open."' ,r_lotto_hun_max = '".$set_r_lotto_hun_max."',r_lotto_hun_min = '".$set_r_lotto_hun_min."',r_lotto_hun_pay1 = '".$set_r_lotto_hun_pay1."' ,r_lotto_hun_dis1 = '".$set_r_lotto_hun_dis1."' ,r_lotto_hun_pay2 = '".$set_r_lotto_hun_pay2."' ,r_lotto_hun_dis2 = '".$set_r_lotto_hun_dis2."' ,r_lotto_hun_pay3 = '".$set_r_lotto_hun_pay3."' ,r_lotto_hun_dis3 = '".$set_r_lotto_hun_dis3."' ,r_lotto_hun_set_share = '".$set_r_lotto_hun_set_share."',r_lotto_hun_set_pay = '".$set_r_lotto_hun_set_pay."' ,r_lotto_hun_set_price = '".$set_r_lotto_hun_set_price."' ,r_games_share = '".$set_r_games_share."'  ,r_games_dis = '".$set_r_games_dis."',r_games_max = '".$set_r_games_max."' ,r_games_min = '".$set_r_games_min."' ,r_casino_share = '".$set_r_casino_share."' ,r_casino_max = '".$set_r_casino_max."' ,r_casino_min = '".$set_r_casino_min."' ,r_casino_dis = '".$set_r_casino_dis."' ,r_casino_open = '".$set_r_casino_open."' where r_id='".$id."' "; 
			...
			if($query)
			{
				...
				$sql1 = "UPDATE `bom_tb_agent` SET r_currency = '".$tcurrency."' where r_agent_id like '%*".$id."*%'";
				$query = sql_query($sql1); 

				$sql1 = "UPDATE `bom_tb_member` SET m_currency = '".$tcurrency."' where m_agent_id like '%*".$id."*%'";
				$query = sql_query($sql1); 
