...
<div class="row">
    <div class="widget-box hidden-boder" id="reloadUserList">
        <div class="widget-header widget-header-blue widget-header-flat" style="display:none;">
            <h4 class="widget-title lighter"><strong> <?=$lang_ag[82];?> </strong></h4>
                        ...
                        <form class="form-horizontal" id="frmSearch" onsubmit="return false;">
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-2">
                                    <input type="text" id="username" name="username" value="<?=$_POST["fuser"];?>" class="col-xs-12 col-sm-12" placeholder="username">
                                </div>
                               <!--  <div class="col-xs-4 col-sm-2">
                                ...
                                <div class="col-xs-12 col-sm-2">
                                    <select class="form-control input-sm col-xs-6 col-sm-6" id="list_sort" name="list_sort">
                                        ...
                                        <option value="3"><?=$lang_ag[458];?></option>
                                        <option value="4"><?=$lang_ag[460];?></option>
                                    </select>
                                </div>
                                <!-- จำนวนสูงสุดต่อหน้า -->
                                <label class="control-label col-xs-12 col-sm-2 col-md-1 no-padding-right xs-mt-10"><?=$lang_ag[1170];?> :</label>
                                ...
                                <div class="col-xs-12 col-sm-2">
                                    <button type="button" name="search" id="search" class="btn btn-primary btn-sm btn-search" onclick="searchUserList(this);">
...
<script type="text/javascript">
    ...
    function editCredit(e,id,futype,oldCredit,edType){
            ...
            success: function (response) {
                ...
                bootbox.dialog({
                    ...
                    buttons:            
                    {
                        "OK" :
                        {
                            "label" : "<i class='ace-icon fa fa-check '></i> <?=$lang_ag[178];?>",
                            "className" : "btn-sm btn-primary",
                            "callback": function(e) {
                                
                                if($("#newCredit").val() == ''){
                                    dialogError("<?=$lang_ag[7];?>");
                                    return false;
                                }
                        ...
                        "NO" :
                        {
                            "label" : "<i class='ace-icon fa fa-close'></i> <?=$lang_ag[256];?>",
    ...
    function changePaswd(user,id,futype,e){
        var _btn = e;
        $(_btn).attr("disabled", "true");
        $.ajax({
            ...
            success: function (response) {
                ...
                bootbox.dialog({
                    ...
                    buttons:            
                    {
                        "OK" :
                        {
                            "label" : "<i class='fa fa-floppy-o'></i> <?=$lang_ag[102];?>",
                        ...
                        "NO" :
                        {
                            "label" : "<i class='ace-icon glyphicon glyphicon-log-in'></i> <?=$lang_ag[284];?>",
                            "className" : "btn-sm btn-primary",
                            "callback": function(e) {
                                $(_btn).removeAttr('disabled');
                            }
            ...
            success: function (response) {
                ...
                bootbox.dialog({
                    ...
                    buttons:            
                    {
                        "OK" :
                        {
                            "label" : "<i class='fa fa-floppy-o'></i> <?=$lang_ag[513];?>",
                            "className" : "btn-sm btn-success",
                            "callback": function(e) {
