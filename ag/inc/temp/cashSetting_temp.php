            ...
            <div class="">
                <h4 class="widget-title lighter smaller">
                    ...
                    <label class="widget-toolbar no-border">
                        <input name="show_member" id="show_member" class="ace ace-switch ace-switch-6" type="checkbox" value="Y"<? if($rs_cset["r_open_transfer"]==1){ ?> checked="checked"<? } ?> onchange="setDefault();">
                        <span class="lbl">&nbsp;&nbsp;</span>
                    </label>
                </h4>
            </div>
...
<script type="text/javascript">
    ...
    function setDefault()
    {
        ...
        if($(e).is(':checked'))
        {
            ...
            $('#deposit_open').val($('#deposit_open').children('option:first').val()); 
            $("#deposit_min").val("10.00");
            $("#deposit_max").val("100,000.00");
            
            $('#withdrawal_open').val($('#withdrawal_open').children('option:first').val()); 
            $("#withdrawal_min").val("10.00");
            $("#withdrawal_max").val("100,000.00");
            $("#withdrawal_count").val("10");
        }
    }
