...
<div class="row">
    ...
    <div class="widget-box hidden-boder " id="reloadRobot">
        ...
        <div class="widget-header widget-header-blue widget-header-flat" style="display:none;">
            ...
            <h4 class="widget-title lighter"><strong> <?=$lang_ag[132];?> </strong></h4>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4 col-sm-1" style="width:100px">
                                    ...
                                    <select class="form-control col-xs-12 col-sm-6 input-sm" id="vtype" name="vtype" width="20">
                                        ...
                                        <option value="T"><?=$lang_ag[1405];?></option>

                                        <option value="L"><?=$lang_ag[771];?></option>

                                        <option value="A"><?=$lang_ag[773];?></option>
                                ...
                                <div class="col-xs-12 col-sm-2">
                                    ...
                                    <input type="text" id="vuser" name="vuser" placeholder="<?=$lang_ag[1396];?>" value="" class="col-xs-12 col-sm-12">
                                ...
                                <div class="col-xs-12 col-sm-2">
                                    ...
                                    <select class="form-control col-xs-12 col-sm-6 input-sm" id="sort" name="sort">
                                        ...
                                        <option value=""> <?=$lang_ag[773];?> </option>

                                        <option value="1"> <?=$lang_ag[776];?> </option>

                                        <option value="2"> <?=$lang_ag[778];?> </option>

                                        <option value="3"> <?=$lang_ag[779];?> </option>

                                        <option value="4"> <?=$lang_ag[781];?> </option>
                                ...
                                <div class="col-xs-12 col-sm-1">
                                    ...
                                    <button type="button" name="search" id="search" class="btn btn-primary btn-sm btn-search" onclick="searchRobot(this);">
                            ...
                            <table id="tbRobot" class="table table-striped table-bordered table-hover">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center"><?=$lang_ag[782];?> </th>

                                        <th class="text-center"><?=$lang_ag[745];?> </th>

                                        <th class="text-center"><?=$lang_ag[746];?> </th>

                                        <th class="text-center">HF </th>

                                        <th class="text-center"><?=$lang_ag[205];?> </th>
                                        ...
                                        <th class="text-center"><?=$lang_ag[1406];?> </th>
