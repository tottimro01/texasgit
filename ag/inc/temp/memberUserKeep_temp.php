...
<div class="row">
  <div class="widget-box hidden-boder" id="relodUKeep">
    <div class="widget-header widget-header-blue widget-header-flat hidden">
      <h4 class="widget-title lighter"><strong><?=$lang_ag[86];?></strong></h4>
          ...
          <div class="col-xs-12">
            ...
            <form class="form-horizontal" id="frmSearch" onsubmit="return false;">
              <div class="form-group">
                <label class="control-label col-xs-12 col-sm-1 no-padding-right" for="username"><strong><?=$lang_ag[326];?>:</strong></label>
                ...
                <!-- จำนวนสูงสุดต่อหน้า -->
                <label class="control-label col-xs-4 col-sm-2 col-md-1 no-padding-right"><?=$lang_ag[1170];?> :</label>
                <div class="col-xs-8 col-sm-1 col-md-1 mobile-padding">
                ...
                <div class="col-xs-12 col-sm-2">
                  <button type="button" name="search" id="search" class="btn btn-primary btn-sm btn-search" onclick="getUKeep(this);">
...
<script type="text/javascript">
  ...
  function setSl(game,user,id,futype){
    ...
    var confirm = '<h5><?=$lang_ag[465];?> <strong>'+ title[0] +'</strong> = <strong>'+ $('#'+user+'_'+game).val() +'</strong> ?</h5>';
    bootbox.dialog({
      size : '',
      message : confirm,
      buttons: 
  ...
  function setAllSl(game,value){
    ...
    if(value == 'min'){
      ...
      val     = 0;
      confirm = '<h5><?=$lang_ag[465];?> <strong>' + name +'</strong> = <strong> <?=$lang_ag[467];?> </strong> ?</h5>';
    }else if(value == 'max'){
      // confirm = '<h5>Please confirm change percent <strong>'+ game +'</strong> to <strong> max receive </strong> ?</h5>';
      val     = 100;
      confirm = '<h5><?=$lang_ag[465];?> <strong>' + name +'</strong> = <strong> <?=$lang_ag[140];?> </strong> ?</h5>';
    }
    bootbox.dialog({
      size : '',
      message : confirm,
