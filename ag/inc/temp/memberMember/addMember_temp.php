                                ...
                                <div class="widget-box">
                                  ...
                                  <div class="widget-body">
                                    <div class="widget-main">
                                      ...
                                      <?php 
                                            // $r_casino_min[$key] = ($r_casino_min[$key] < $casino_min[$key]) ? $casino_min[$key] : $r_casino_min[$key];
                                       ?>
                                      <div class="form-group">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            ...
                                            <tr>
                                              <th class="text-center">
                                                <div style="text-align: left; padding-left: 15px; float: left;">
                                                  <input type="checkbox" class="ace" id="lotto_chk1_all" name="lotto_chk1_all" checked="" style="height: 23px;" onchange="close_lotto_all('#lotto_chk1_all','1','lotto')">
                                                   <span class="lbl">  </span>
                                                </div>
                                                ...
                                                foreach ($data["lotto_type"] as $key => $value) {
                                                    ...
                                                    ?>
                                                        <tr class="text-left">
                                                             <td width="35%">
                                                                <?
                                                                 $lot_chk = ($r_lotto_pay1[$key] != 0) ? "checked=\"\"" : "";
                                                                ?>
                                        ...
                                        <table class="table table-bordered table-hover">
                                          <thead>
                                            ...
                                            <tr>
                                              <th class="text-center">
                                                <div style="text-align: left; padding-left: 15px; float: left;">
                                                  <input type="checkbox" class="ace" id="lotto_chk2_all" name="lotto_chk2_all" checked="" style="height: 23px;" onchange="close_lotto_all('#lotto_chk2_all','2','lotto')">
                                                   <span class="lbl">  </span>
                                                </div>
                                                <?=$lang_ag[177];?>
                                              </th>
                                                ...
                                                foreach ($data["lotto_type"] as $key => $value) {
                                                    ...
                                                    ?>
                                                        <tr class="text-left">
                                                            <td width="35%">
                                                                <?
                                                                 $lot_chk = ($r_lotto_pay2[$key] != 0) ? "checked=\"\"" : "";
                                                                ?>
                                                                <label style="text-align: left; padding-left: 15px;">
                                        ...
                                        <table class="table table-bordered table-hover">
                                          <thead>
                                            ...
                                            <tr>
                                              <th class="text-center">
                                                <div style="text-align: left; padding-left: 15px; float: left;">
                                                  <input type="checkbox" class="ace" id="lotto_chk3_all" name="lotto_chk3_all" checked="" style="height: 23px;" onchange="close_lotto_all('#lotto_chk3_all','3','lotto')">
                                                   <span class="lbl">  </span>
                                                </div>
                                                <?=$lang_ag[177];?>
                                              </th>
                                                ...
                                                foreach ($data["lotto_type"] as $key => $value) {
                                                    ...
                                                    ?>
                                                        <tr class="text-left">
                                                             <td width="35%">
                                                                <?
                                                                 $lot_chk = ($r_lotto_pay3[$key] != 0) ? "checked=\"\"" : "";
                                                                ?>
                                                                <label style="text-align: left; padding-left: 15px;">
                              ...
                              <div class="table-responsive">
                                  <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                      ...
                                      <tr>
                                        <th class="text-center">
                                            <div style="text-align: left; padding-left: 15px; float: left;">
                                              <input type="checkbox" class="ace" id="lotto_hun_chk1_all" name="lotto_hun_chk1_all" checked="" style="height: 23px;" onchange="close_lotto_all('#lotto_hun_chk1_all','1','lotto_hun')">
                                               <span class="lbl">  </span>
                                            </div>
                                                <?=$lang_ag[177];?>
                                        </th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="text-left">
                                      <td width="35%">
                                        <?
                                         $lot_chk = ($r_lotto_hun_pay1[$key] != 0) ? "checked=\"\"" : "";
                                        ?>
                                        <label style="text-align: left; padding-left: 15px;">
                                      ...
                                      <td width="35%">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                          <div class="clearfix  input-group">
                                            <!-- <select class="form-control input-sm sl_lotto_set_pay" id="8_<?=$key;?>_lotto_hun_com1" name="lotto_hun_com1_<?=$key;?>"> -->
                                              <select class="form-control input-sm sl_lotto_set_pay" id="lotto_hun_com1_<?=$key;?>" name="lotto_hun_com1_<?=$key;?>">
                                              <?php 
                                            ...
                                            <span class="input-group-addon" id="k_8_<?=$key;?>_lotto_hun_com1" data-json="<?=intval($r_lotto_hun_dis1[$key]);?>">%</span>
                                          </div>
                                        </div>
                                      </td>
                                    </tr>
                              ...
                              <div class="table-responsive">
                                  <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                      ...
                                      <tr>
                                        <th class="text-center">
                                            <div style="text-align: left; padding-left: 15px; float: left;">
                                              <input type="checkbox" class="ace" id="lotto_hun_chk2_all" name="lotto_hun_chk2_all" checked="" style="height: 23px;" onchange="close_lotto_all('#lotto_hun_chk2_all','2','lotto_hun')">
                                               <span class="lbl">  </span>
                                            </div>
                                                <?=$lang_ag[177];?>
                                        </th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="text-left">
                                      <td width="35%">
                                        <?
                                         $lot_chk = ($r_lotto_hun_pay2[$key] != 0) ? "checked=\"\"" : "";
                                        ?>
                                        <label style="text-align: left; padding-left: 15px;">
                                      ...
                                      <td width="35%">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                          <div class="clearfix  input-group">
                                            <select class="form-control input-sm sl_lotto_set_pay" id="lotto_hun_com2_<?=$key;?>" name="lotto_hun_com2_<?=$key;?>">
                                              <?php 
                                            ...
                                            <span class="input-group-addon" id="k_8_<?=$key;?>_lotto_hun_com2" data-json="<?=intval($r_lotto_hun_dis2[$key]);?>">%</span>
                                          </div>
                                        </div>
                                      </td>
                                    </tr>
                                  ...
                                  <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                      ...
                                      <tr>
                                        <th class="text-center">
                                            <div style="text-align: left; padding-left: 15px; float: left;">
                                              <input type="checkbox" class="ace" id="lotto_hun_chk3_all" name="lotto_hun_chk3_all" checked="" style="height: 23px;" onchange="close_lotto_all('#lotto_hun_chk3_all','3','lotto_hun')">
                                               <span class="lbl">  </span>
                                            </div>
                                            <?=$lang_ag[177];?>
                                        </th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="text-left">
                                      ...
                                      <td width="35%">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                          <div class="clearfix  input-group">
                                            <select class="form-control input-sm sl_lotto_set_pay" id="lotto_hun_com3_<?=$key;?>" name="lotto_hun_com3_<?=$key;?>">
                                              <?php 
                                            ...
                                            <span class="input-group-addon" id="k_8_<?=$key;?>_lotto_hun_com3" data-json="<?=intval($r_lotto_hun_dis3[$key]);?>">%</span>
                                          </div>
                                        </div>
                                      </td>
                                    </tr>
  ...
  function setMax(game){
    switch (game){
      ...
      case 'lotto_set' :
        ...
        $( "#lotto_set .maxLimit:not([readonly=\"readonly\"]" ).each(function() {
                    var data = $( this ).closest('td').children('.maxtransfer').data('json')
                    $( this ).val(data);
        });
        $( "#lotto_set .sl_lotto_set_com:not(\".block_select\")" ).each(function() {
            $(this).val($(this).children('option:last').val())
        });
      break;
