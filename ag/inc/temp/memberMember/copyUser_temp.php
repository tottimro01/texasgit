          ...
          <div class='widget-main'>
            <div class='row'>
                ...
                <div class='form-group copy-group'>
                  ...
                  <div class='col-xs-12 col-sm-6'>
                    <input type='text' id='regis_credit' name='regis_credit' class='input-num2digt' value='0.00'  class='col-xs-12 col-sm-12 numeric' onkeyup=\"calCredit(this,".$x_count3.");\" onblur=\"addDigit(this)\" style=\"width: 90%!important;\">
