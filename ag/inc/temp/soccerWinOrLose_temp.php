...
<div class="row">
    <div class="widget-box hidden-boder" id="reloadWinLoseByTeam">
        <div class="widget-header widget-header-blue widget-header-flat hidden">
            <h4 class="widget-title lighter"><strong> <?=$lang_ag[123];?> </strong></h4>
                    ...
                    <div class="col-xs-12 widthTable">
                        <form class="form-horizontal" id="soccerWinLoseByTeamForm">
                            <div class="form-group">                           
                                <label class="control-label col-xs-12 col-sm-1 no-padding-right" for="username"><?=$lang_ag[1401];?> :</label>
                        ...
                        <div class="table-responsive">
                            <table id="tb_winLoseByTeam" class="table table-striped table-bordered table-hover text-center">
                                <thead>
                                    <tr>
                                        <th rowspan="2"><strong><?=$lang_ag[745];?></strong></th>
                                        <th rowspan="2"><strong><?=$lang_ag[746];?></strong></th>
                                        <th rowspan="2"><strong><?=$lang_ag[1402];?></strong></th>
                                        <th><strong><?=$lang_ag[727];?></strong></th>
                                        <th><strong><?=$lang_ag[731];?></strong></th>
                                        <th rowspan="2"><strong><?=$lang_ag[210];?></strong></th>
                                        <th rowspan="2"><strong><?=$lang_ag[197];?></strong></th>
                                    </tr>
                                    <tr>
                                        <th><strong><?=$lang_ag[429];?></strong></th>
                                        <th><strong><?=$lang_ag[429];?></strong></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr><td colspan="7" class="text-danger"><?=$lang_ag[1];?></td></tr>
                                </tbody>
                                <tfoot>
                                    <tr><td colspan="2"><strong><?=$lang_ag[197];?></strong></td>
...
<script type="text/javascript">    
    ...
    function getDetail(param){
        ...
        newwin = window.open('soccerWinOrLoseDetail?params='+param,'winorlossteam', setting);        
