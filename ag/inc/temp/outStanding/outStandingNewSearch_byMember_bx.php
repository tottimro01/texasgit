...
$list = "<tr>
			            ...
			            <ul class=\"nav nav-tabs\" id=\"myTab\"> 
			            	<li class=\"active\">
			                    <a data-toggle=\"tab\" href=\"#\">
			                        ...
			                        ".$lang_g["bet_type"]["bx"]."   <span id=\"sum_panal\" class=\"badge badge-danger\">0.00</span>
			                    </a>
			                </li>
			            </ul>
	...
	$no = 1;
$sum = 0;
$sql_bill = sql_query("select * from bom_tb_football_bill_live where m_id = '$re_member[m_id]' and b_confirm != 1  and b_accept=1 and b_zone = 1 and b_numstep = 1 and b_status = 5 order by bill_id desc");
