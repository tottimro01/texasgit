...
if($rs_bill_play['b_time_play']!=""){ 
 ...
 if( ($rs_bill_play['b_big']==1 and $rs_bill_play['play_type']==1) or  ($rs_bill_play['b_big']==1 and $rs_bill_play['play_type']==11)  ){
			...
			if($rs_bill_play['play_type']==2 or $rs_bill_play['play_type']==12){$tn="$w1".$team_2." ".$del.$rs_bill_play['play_bet']."$w2";}
			else{$tn="$w1".$team_1." ".$del.$rs_bill_play['play_bet']."$w2";} 
			//echo $tn;
...
$list .= "
			                                            	<font color=\"blue\">".$sport_man[$rs_bill_play['play_type']]."</font>
			                                            	".$tn."
			                                            	<font color=\"blue\"><strong> ".$live."</strong></font>
			                                                    <br>
			                                                <font color=\"".($rs_bill_play['b_big']==1 ? "red" : "")."\">".$team_1."</font> -vs-
			                                                <font color=\"".($rs_bill_play['b_big']==2 ? "red" : "")."\">".$team_2."</font>
			                                                	<br>
			                                                <font color=\"red\">".$leage." @ ".$rs_bill_play['b_date']."</font> 
			                                          ";
?>