...
sum(
 ...
 from bom_tb_football_bill_live where r_agent_id like '%*".$_SESSION['r_id']."*%'  and b_confirm != 1  and b_accept=1  and b_status=5 and b_numstep=1 and  b_zone!=1  and  b_zone!=6   ";
$rs1=sql_array($sql);
