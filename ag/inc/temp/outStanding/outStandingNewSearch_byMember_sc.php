			            ...
			            <ul class=\"nav nav-tabs\" id=\"myTab\"> 
			            	<li class=\"active\">
			                    <a data-toggle=\"tab\" href=\"#\">
			                        ...
			                        ".$lang_g["bet_type"]["sc"]."  <span id=\"sum_panal\" class=\"badge badge-danger\">0.00</span>
			                    </a>
			                </li>
			            </ul>
			                    ...
			                    <div class=\"table-responsive\">
			                        <table id=\"tbSoccer\" class=\"table table-striped table-bordered table-hover\">
			                            <thead>
			                                ...
			                                <tr>
			                                    <th align=\"center\"> $lang_ag[238] </th>
...
$no = 1;
$sum = 0;
$sql = "select * from bom_tb_football_bill_live where m_id = '$re_member[m_id]' and b_confirm != 1 and b_accept=1 and b_zone = 6 and b_numstep = 1 and b_status = 5 order by bill_id desc";
$sql_bill = sql_query($sql);
