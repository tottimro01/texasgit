...
$option = array(
      ...
      "q_fn" =>  "loadData('".$_POST["gametype"]."','".$re_agent["r_id"]."','".$re_agent["r_level"]."');",
      "level" => $re_agent["r_level"],
      "suser" => "",
      "usertype" =>  "A",
      "gametype" =>  $gametype,
      "gametype_name" =>  $lang_g["bet_type"][$_POST["gametype"]],
      "_lv" =>  $_lv,
      "_id" =>  $_id,
    );
         ...
         ###################  load agent ################
          ...
          include("inc_ag.php");
            ...
            $list .= "<tr>
                            ...
                            <td align=\"right\">  "._cbp($psum1,2)."</td>
                            <td align=\"right\">  "._cbp($psum2,2)."</td>
                            <td align=\"right\">  "._cbp($psum3,2)."</td>
                            <td align=\"right\">  "._cbp($psum4,2)."</td>
                            <td align=\"right\">  "._cbp($psum5,2)."</td>
                            <td align=\"right\">  "._cbp($psum6,2)."</td>
                            <td align=\"right\">  "._cbp($psum7,2)."</td>
                            <td align=\"right\">  "._cbp($psum8,2)."</td>
                      </tr>";
