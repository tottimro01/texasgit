...
$no = 1;
$sum = 0;
$sql_bill = sql_query("select * from bom_tb_football_bill where m_id = '$re_member[m_id]' and b_accept=1 and b_zone = 6 and b_numstep = 1 and b_status <> 5 and  STR_TO_DATE(b_date,'%d-%m-%Y') BETWEEN '$edate' and '$ddate' order by bill_id desc");
...
$mcom=$rs_bill['b_pay'];
      ...
      <tr class='text-right'>
        ...
        <td class='text-center'>
          ...
          <span>".$sport_type[$rs_bill_play["b_zone"]]."</span><br><span>".$rs_bill["b_datenow"]."</span><br>
        </td><td>";
...
require("list_bill_play.php");
        ...
        <td class='text-center'>
          <span class='num'>".number_format($rs_bill["b_sum_pay"] , 2)."</span><br>
          <span>".$rs_bill_play["play_view"]."</span><br></td>
        <td>
