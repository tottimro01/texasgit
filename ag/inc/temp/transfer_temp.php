                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="15%">
                                            <?=$lang_ag[1182];?><br>
                                            <font class="red">[<?=date("d-m-Y",strtotime("-1 day"));?>]</font>
                                        </th>
                                        <th>
                                            <label>
                                        ...
                                        <th class="text-center" width="15%">
                                            <?=$lang_ag[1184];?><br>
                                            <font class="red">[<?=date("d-m-Y");?>]</font>
                                        </th>
                                        <th>
                                            <label>
                                ...
                                <tfoot style="display:none;">
                                    <tr>
                                        ...
                                        <td align="right" class="">
                                            <strong><span id="sumYesterday">0.00</span></strong> 
                                        </td>
                                        <td></td>
                                        <td align="right" class="">
                                            <strong><span id="sumToday">0.00</span></strong>
                                        </td>
                                        <td></td>
                                        <td align="right" class="">
                                            <strong><span id="sumCashBalance">0.00</span></strong>
                                        </td>
                                        <td align="right" class="">
                                            <strong><span id="sumOutstanding">0.00</span></strong>
                                        </td>
                                        <td align="right" class="">
                                            <strong><span id="sumGivenCredit">0.00</span></strong>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
...
function loadData(page=1)
{
    ...
    .done(function(response){
        ...
        $("#sumYesterday").text("").append(response.total.sumYesterday);
        $("#sumToday").text("").append(response.total.sumToday);
        $("#sumCashBalance").text("").append(response.total.sumCashBalance);
        $("#sumOutstanding").text("").append(response.total.sumOutstanding);
        $("#sumGivenCredit").text("").append(response.total.sumGivenCredit);
...
function clickPage(page)
{
    ...
    function transferMoney_byuser(now,id,u_type)
    {
        bootbox.dialog({
                            ...
                            if(e){
                                ...
                                if(statusSent == ''){
                                    ...
                                    $("#tbTransfer").find('input[type="checkbox"]:checked.'+columFind).each(function() {
                                        ...
                                        if($(this).data('usertype') == "A")
                                        {
                                            id_list_A.push($(this).data('id'));  
                                        }else{
                                            id_list_M.push($(this).data('id'));  
                                        }
