...
// $rtype = "m_count_de";
// $sql = "select sum($rtype) as xtotal from bom_tb_member where  r_id = '".$_POST["session"]["r_id"]."'";
// $re5 = sql_array($sql);
            ...
            <div class="widget-box no-skin widget-color">
                <div class="widget-header widget-header-blue">
                    ...
                    <div class="widget-toolbar no-border">
                        <button type="button" class="btn btn-xs btn-white bigger btn-info btn-bold" onclick="regisCopyUser(this);return false;">
                            <span class="normal">
                                <?=$lang_ag[1911];?>  
                            </span>
                            <span class="mobile">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <div class="input-group clearfix" style="width: 100%;">
                                        ...
                                        <input type="text" class="inputEngNum" id="username" name="username" value="" maxlength="5" placeholder="<?=$lang_ag[1396];?>" style="width: 100%;">
                                    </div>
                                </div>
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-8">
                                              ...
                                              <div class="col-xs-12 col-sm-6 col-md-6">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                    ...
                                                    <div class="clearfix">
                                                        <select class="form-control sl-width input-sm sl_soccer" id="r_nam" name="r_nam" data-nam="0" onchange="setKeep('r_nam'); setExNam(this)" style=" float: left;"> 
                                                            <?php 
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                              ...
                                                              <div class="col-xs-12 col-sm-8 col-md-7">
                                                                <div class="clearfix casino_Input">
                                                                  ...
                                                                  <span class="text-danger label-sm maxtransfer" id="k_rcb_mintransfer" data-json="<?=number_format($r_casino_min[$key]);?>">(<?=number_format($r_casino_min[$key]);?> - <?=number_format($max_betmin_money);?>) </span>
                                                                </div>
                                                              </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="widget-main no-padding">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-2">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="7_lotto_share"><?=$lang_ag[567];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="clearfix input-group">
