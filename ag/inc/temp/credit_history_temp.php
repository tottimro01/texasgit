          ...
          <div class="col-xs-12 widthTable">
            <form class="form-horizontal" id="sch_form">
              <div class="form-group">                           
                ...
                <div class="col-xs-12 col-sm-2">
                  ...
                  <a href="#" onclick="getMenu('credit_history','?id=3&lv=2&up_r_agent_id=*1*3*&sdate=29-07-2019&edate=29-07-2019');" type="button" id="back" class="btn btn-primary btn-sm btn-search"><?=$lang_ag[716];?></a>
                </div>
              </div>
            </form>
            <div class="clearfix">
            ...
            <div class="table-responsive">
              <table id="tbUserList" class="table table-bordered" style="width: 100%;">
                <thead>
                  <tr>
                    <th colspan="5" id="head_title" style="text-align: left !important; background: #f7f7f7; color: #b68700;"><?=$lang_ag[693];?> 2019-04-30 00:00 - 2019-04-30 23:59</th>
                  </tr> 
                  <tr>
                    <th></th>
                    <th>username</th>
