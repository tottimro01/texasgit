                           ...
                           <form method="post" id="form_bill" action="<?=$main_url;?>/inc/temp/sport_bill/recive_bill.php">
                            <table id="tbSportBill" class="table table-striped table-bordered table-hover text-center">
                                ...
                                <tbody id="loadData">   
                                 ...
                                 <tfoot>
                                  <tr>
                                    <td colspan="4"><strong><?=$lang_ag[197];?></strong></td>
          ...
          <table class="input-inline text-center" style="width: 100%;">
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="hidden-xs"> <?=$currency_list[$_POST["session"]["r_currency"]];?></td>
                  </tr>
                  <tr>
                      <td><?=$lang_ag[191];?></td>
                  ...
                  <tr>
                      ...
                      <td>
                         <button type="button" class="btn btn1 btn-primary  print-button" id="pbtn" onclick="recive_bill2();">
...
function check_countdown(val){
  if(val==0){
    ...
    document.getElementById('timer').innerHTML = 00 + ":" + 1;
    startTimer();
  }
}
...
function startTimer() {
  ...
  if(m>0 || s>0){
    ...
    var w = window.open('<?=$main_url;?>inc/temp/sport_bill/recive_bill.php','Popup_Window','scrollbars=yes,resizable=yes,width=350,height=400');
        ...
        $("#pbtn").html("<i class=\"fa fa-print\" aria-hidden=\"true\"></i> <?=$lang_ag[2178];?>");
