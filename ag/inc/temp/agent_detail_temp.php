...
?>
<link rel="stylesheet" href="assets/css/custom/agent_detail_temp.css">
            ...
            <div class="widget-box no-skin widget-color">
                <div class="widget-header widget-header-blue">
                    ...
                    <div class="widget-toolbar "> 
                        ...
                        <a onclick="getMenu('userList','?page=<?=$_POST["page"];?>&fuser=<?=$_POST["fuser"];?>');">
                    ...
                    <div class="widget-main">
                        <div>
                            <div class="form-group"> 
                                <label class="control-label col-xs-4 col-sm-2 no-padding-right" for="username"> <?=$lang_ag[1396];?> :</label>
                                <div class="col-xs-8 col-sm-4">
                                    <div class="input-group clearfix col-xs-12">
                                        <input type="text" id="username" name="username" value="<?=$rs["r_user"];?>" placeholder="<?=$lang_ag[1396];?>" class="inputEngNum" readonly="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group"> 
                                <label class="control-label col-xs-4 col-sm-2 no-padding-right" for="name"> <?=$lang_ag[405];?> :</label>
                                <div class="col-xs-8 col-sm-4">
                                    <div class="clearfix">
                                        <input type="hidden" id="id" name="id" value="<?=$rs["r_id"];?>">
                                        <input type="text" name="name" id="name" value="<?=$rs["r_name"];?>" placeholder="<?=$lang_ag[405];?>">
                                    </div>
                                </div>
                                <label class="control-label col-xs-4 col-sm-2 no-padding-right" for="telephone"> <?=$lang_ag[596];?> :</label>
                                <div class="col-xs-8 col-sm-4">
                                    <div class="clearfix">
                                        <input type="tel" id="telephone" name="telephone" value="<?=$rs["r_phone"];?>" placeholder="<?=$lang_ag[596];?>">
                                    </div>
                                </div>
                            </div>
                        </div>
...
var r_lotto_max_max = <?=json_encode($r_lotto_max_max);?>;
var r_lotto_min_max = <?=json_encode($r_lotto_min_max);?>;
...
var r_lotto_hun_max_max = <?=json_encode($r_lotto_hun_max_max);?>;
var r_lotto_hun_min_max = <?=json_encode($r_lotto_hun_min_max);?>;
...
var r_casino_open = <?=json_encode($r_casino_open);?>;
var r_casino_max = <?=json_encode($r_casino_max);?>;
var r_casino_min = <?=json_encode($r_casino_min);?>;
var r_casino_dis = <?=json_encode($r_casino_dis);?>;
...
var check_casino_min = <?=json_encode($check_r_casino_min);?>;
var check_casino_dis = <?=json_encode($check_r_casino_dis);?>;
...
var boxing_ary = {
    ...
    "r_name" : "<?=$r_name;?>",
    "boxing_com_max" : "<?=$boxing_com_max;?>",
    "boxingtoday_share_max" : "<?=$boxingtoday_share_max;?>",
    "boxinglive_share_max" : "<?=$boxinglive_share_max;?>",
...
var lotto_ary = {
  ...
  "r_lotto_max" : <?=$r_lotto_max[1];?>,
  "r_lotto_min" : <?=$r_lotto_min[1];?>,
  ...
  "r_lotto_max_max" : r_lotto_max_max,
  "r_lotto_min_max" : r_lotto_min_max,
...
var lottoSet_ary = {
  ...
  "r_lotto_hun_max" : <?=$r_lotto_hun_max[1];?>,
  "r_lotto_hun_min" : <?=$r_lotto_hun_min[1];?>,
  ...
  "r_lotto_hun_open" : r_lotto_hun_open,
   "r_lotto_hun_max_max" : r_lotto_hun_max_max,
  "r_lotto_hun_min_max" : r_lotto_hun_min_max,
...
var game_active_ary = {
  ...
  "game_max" :"<?=$r_games_max[1];?>",
  "game_min" :"<?=$r_games_min[1];?>",
  "game_share_max" : "<?=$game_share_max;?>",
  "game_com_max" : "<?=$game_com_max;?>",
  "game_max_max" : "<?=$game_max_max;?>",
  "game_min_max" : "<?=$game_min_max;?>",
...
var casino_ary = {
  ...
  "rcb_mintransfer" : r_casino_min,
  "casino_open" : r_casino_open,
  "casino_com" : r_casino_dis,
  "casino_share" : r_casino_share,
  "casino_myshare" : r_casino_myshare,
  "r_name" : "<?=$r_name;?>",
  "check_casino_max" : check_casino_max,
  "check_casino_min" : check_casino_min,
  "check_casino_dis" : check_casino_dis,
