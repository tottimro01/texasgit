...
if($_POST['q']!=""){
 ...
 $sql="select 
  ...
  from bom_tb_lotto_bill_play_live where    ok_id='$ok_id' and lot_type != 31 and r_agent_id like '%*$r_id*%' and r_id != '$r_id'    and b_accept=1 and play_status=7  and play_timestam>'$lock_time'   $ww  order by play_id desc    limit 500   ";
$re=sql_query($sql);
while($rs=sql_fetch($re)){
$sum10a=$rs[r1];
$sum10b=-$rs[r2];
$sum10c=$rs[r1]-$rs[r2];
	...
	$data["calcel_list"][] = array(
		'play_id' => $rs["play_id"],
		'lot_zone' => $lot_zone[$_SESSION["AGlang"]]["zone"][$rs["lot_zone"]],
 ...
 $sql="select 
  ...
  from bom_tb_lotto_bill_play_live where    ok_id='$ok_id' and lot_type != 31  and r_id = '$r_id'    and b_accept=1 and play_status=7  and play_timestam>'$lock_time'   $ww  order by play_id desc    limit 500   ";
$re=sql_query($sql);
while($rs=sql_fetch($re)){
$sum10a=$rs[r1];
$sum10b=-$rs[r2];
