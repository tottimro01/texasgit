...
else
{
  ...
  if($num_user == 0)
  {
    ...
    //football sport step 
      ...
      $set_m_nam_ok =  intval(str_replace(",","",$r_nam))-intval(str_replace(",","",$_POST["r_nam"]));
...
// "max,".intval(str_replace(",","",$_POST["lotto_share_hun_betmax_money"])).",0";
    // casino 
      ...
      $r_id = intval($_SESSION["rid"]);


      $sql="INSERT IGNORE INTO  bom_tb_member (m_open,m_currency,m_name,m_phone,m_user,m_pass,  m_level , m_regis, m_count,m_count_de,m_agent_id,r_id,m_sport_dis,m_sport_max,m_sport_min,m_nam,m_sport_step_max,m_sport_step_min,m_sport_step_day,m_sport_step_paymax,m_sport_step2,m_sport_step_dis,m_lotto_open,m_lotto_max,m_lotto_min,m_lotto_pay1,m_lotto_dis1,m_lotto_pay2,m_lotto_dis2,m_lotto_pay3,m_lotto_dis3,m_lotto_hun_open,m_lotto_hun_max,m_lotto_hun_min,m_lotto_hun_pay1,m_lotto_hun_dis1,m_lotto_hun_pay2,m_lotto_hun_dis2,m_lotto_hun_pay3,m_lotto_hun_dis3,m_lotto_hun_set_pay,m_lotto_hun_set_price,m_games_dis,m_games_max,m_games_min,m_casino_max,m_casino_min,m_casino_dis,m_casino_open,bank_id,m_b_pass) values ('$m_open','".$_SESSION["r_currency"]."','$name','$phone','$user','$pass',$m_level,now(),$_count,$_count,'$m_agent_id','$r_id','$set_m_sport_dis','$set_m_sport_max','$set_m_sport_min','$set_m_nam','$set_m_sport_step_max','$set_m_sport_step_min','$set_m_sport_step_day','$set_m_sport_step_paymax','$set_m_sport_step2','$set_m_sport_step_dis','$m_lotto_open','$set_m_lotto_max','$set_m_lotto_min','$set_m_lotto_pay1','$set_m_lotto_dis1','$set_m_lotto_pay2','$set_m_lotto_dis2','$set_m_lotto_pay3','$set_m_lotto_dis3','$m_lotto_hun_open','$set_m_lotto_hun_max','$set_m_lotto_hun_min','$set_m_lotto_hun_pay1','$set_m_lotto_hun_dis1','$set_m_lotto_hun_pay2','$set_m_lotto_hun_dis2','$set_m_lotto_hun_pay3','$set_m_lotto_hun_dis3','$set_m_lotto_hun_set_pay','$set_m_lotto_hun_set_price','$set_m_games_dis','$set_m_games_max','$set_m_games_min','$set_m_casino_max','$set_m_casino_min','$set_m_casino_dis','$set_m_casino_open','$bank_id','$m_b_pass')";
      $rs = sql_query_return_id($sql);
	  
	  #################API####################
	  #Sexy
	  #$url=$x_process.'api/sexy/createMember.php?u='.$user.'&c='.$_SESSION["r_currency"];
	 # file_get_contents2($url);
      ...
      if($rs['rs'])
      {
        ...
        if(intval($_count) > 0)
        {
            ...
            now(),'"._bIP()."', '4', '".$rs['last']."','$r_id','$m_agent_id','$_SESSION[r_agent_id]',
            '$from' ,'$pay','$pay','เอเยนต์สร้างสมาชิก',
            'CIN',$bap_by_type,'$bap_by_id') ";
            sql_query($sql);  
            ######################LOG ใหม่ 
        }
