...
$r_casino_max   = explode(",", $_SESSION["agent_data"]["r_casino_max"]);
    ...
    $sport_betmoneymax_pair_max =  ($array_data["sport_betmoneymax_pair_max"] == "") ? intval($r_sport_min[3]) : intval($array_data["sport_betmoneymax_pair_max"]);
    $sport_betmax_money_max =  ($array_data["sport_betmax_money_max"] == "") ? intval($r_sport_min[3]) : intval($array_data["sport_betmax_money_max"]);
    $sport_betmin_money_max =  ($array_data["sport_betmin_money_max"] == "") ? intval($max_betmin_money) : intval($array_data["sport_betmin_money_max"]);
    ...
    <div class='form-group'>
       <div class='col-xs-12 col-sm-4 col-md-4'>
        ...
        <div class='col-xs-12 col-sm-4 col-md-4'>
            ...
            <div class='col-xs-12 col-sm-6 col-md-8'>
                <div class='clearfix'>
                    <input type='text' name='sport_betmin_money' id='sport_betmin_money' class='numeric minLimit input-num2digt' value='".addCommas($array_data["sport_betmin_money"])."' onblur=\"chkMinMax(this,".intval($r_sport_min[3]).",".intval($sport_betmin_money_max).");\">
