...
$r_casino_max   = explode(",", $_SESSION["agent_data"]["r_casino_max"]);
    ...
    $boxing_betmoneymax_pair_max =  ($array_data["boxing_betmoneymax_pair_max"] == "") ? intval($r_sport_min[4]) : intval($array_data["boxing_betmoneymax_pair_max"]);
    ...
    $boxing_betmin_money_max =  ($array_data["boxing_betmin_money_max"] == "") ? intval($max_betmin_money) : intval($array_data["boxing_betmin_money_max"]);

    $sporttoday_share_max =  ($array_data["boxingtoday_share_max"] == "") ? 0 : intval($array_data["boxingtoday_share_max"]);
    $sportlive_share_max =  ($array_data["boxinglive_share_max"] == "") ? 0 : intval($array_data["boxinglive_share_max"]);
    ...
    <div class='form-group'>
       <div class='col-xs-12 col-sm-4 col-md-4'>
        ...
        <div class='col-xs-12 col-sm-4 col-md-4'>
            ...
            <div class='col-xs-12 col-sm-6 col-md-8'>
                <div class='clearfix'>
                    <input type='text' name='boxing_betmin_money' id='boxing_betmin_money' class='numeric minLimit input-num2digt' value='".addCommas($array_data["boxing_betmin_money"])."' onblur=\"chkMinMax(this,".intval($r_sport_min[4]).",".intval($boxing_betmin_money_max).");\">
