					...
					<tbody>";
                                    ...
                                    foreach ($data["lotto_type"] as $key => $value) {
                                      ...
                                      <td width='35%' class='lotto_lao_Input'>
                                        <input type='text' name='lot_hun_set_pay".$index."' id='lot_hun_set_pay".$index."' class='numeric maxLimit input-num2digt' value='".addCommas($array_data["lot_hun_set_pay"][$index])."' onblur=\"chkMinMax(this,0,".$r_lotto_hun_set_pay[$index].");\">
                                     ...
                                     if($index == 1){
                                        ...
                                        <input type='text' name='lot_hun_set_price".$index."' id='lot_hun_set_price".$index."' class='numeric maxLimit' value='".addCommas($array_data["lot_hun_set_price"][$index])."' onblur=\"chkMinMax(this,".$r_lotto_hun_set_price[$index].",".$max_betmin_money.");\">
                                        <span class='text-danger label-sm maxtransfer di-b' id='lot_hun_set_price_info' data-json='".$r_lotto_hun_set_price[$index]."'>(".addCommas($r_lotto_hun_set_price[$index])." - ".addCommas($max_betmin_money).") </span>
                                      </td>";
                                    } 
                                    $data["temp"] .="</tr>";
								   }
