...
$r_casino_max   = explode(",", $_SESSION["agent_data"]["r_casino_max"]);
    ...
    $array_data["r_lotto_max_max"] = ($array_data["r_lotto_max_max"] == "" || $array_data["r_lotto_max_max"] == 0) ? intval($r_lotto_min[1]) : $array_data["r_lotto_max_max"];
    $array_data["r_lotto_min_max"] = ($array_data["r_lotto_min_max"] == "" || $array_data["r_lotto_min_max"] == 0) ? intval($max_betmin_money) : $array_data["r_lotto_min_max"];
    ...
    // $array_data["r_lotto_min_max"] = ($array_data["r_lotto_min_max"] < intval($r_lotto_min[1]) ) ? intval($r_lotto_min[1]) : $array_data["r_lotto_min_max"];
    ...
    <div class='form-group'>
	    ...
	    <div class='col-xs-12 col-sm-6 col-md-2'>
	        <label class='control-label col-xs-12 col-sm-12 col-md-12 no-padding-right'>
	            ...
	            {$lang_ag[1402]} : <span id='k_7_lotto_share' data-json='".$r_sport_share[1]."'> ".$array_data["k_7_lotto_share"]." </span> %
	        </label>
	    </div>
      ...
      <div class='col-xs-12 col-sm-6 col-md-4'>
        ...
        <div class='col-xs-12 col-sm-6 col-md-8'>
          <div class='clearfix'> 
            <input type='text' name='lotto_betmax_money' id='lotto_betmax_money' class='numeric input-num2digt no-margin-top' value='".addCommas($array_data["r_lotto_max"])."' onblur=\"chkMinMax(this,".$array_data["r_lotto_max_max"].",".$r_lotto_max[1].");\">
            <span class='text-danger label-sm span_block' id='k_lotto_betmax_money' data-json='".addCommas($r_lotto_max[1])."'>( ".addCommas($array_data["r_lotto_max_max"])." - ".addCommas($r_lotto_max[1]).") </span>
          </div>
        </div>
      </div>
      ...
      <div class='col-xs-12 col-sm-6 col-md-4'>
           ...
           <div class='col-xs-12 col-sm-6 col-md-8'>
             <div class='clearfix'> 
               <input type='text' name='lotto_betmin_money' id='lotto_betmin_money' class='numeric input-num2digt no-margin-top' value='".addCommas($array_data["r_lotto_min"])."' onblur=\"chkMinMax(this,".$r_lotto_min[1].",".$array_data["r_lotto_min_max"].");\">
               <span class='text-danger label-sm span_block' id='k_lotto_betmin_money' data-json='".addCommas($r_lotto_min[1])."'>(".addCommas($r_lotto_min[1])." - ".addCommas($array_data["r_lotto_min_max"]).") </span>
             </div>
           </div>
      </div>
