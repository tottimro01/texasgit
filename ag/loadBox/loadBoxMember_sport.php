...
$sport_live_active = ($array_data["sport_live_active"] == 1) ? "checked=''" : "";
  ...
  <div class='form-group'>
    <div class='col-xs-12 col-sm-4'>
        <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='sport_com'>{$lang_ag[210]} :</label>
...
<div class='form-group'>
    <div class='col-xs-12 col-sm-4'>
        <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='sport_betmoneymax_pair'>{$lang_ag[1409]} :</label>
        <div class='col-xs-8 col-sm-8'>
            <div class='clearfix'>
                <input type='text' name='sport_betmoneymax_pair' id='sport_betmoneymax_pair' class='numeric maxLimit' value='".addCommas($array_data["sport_betmoneymax_pair"])."' onblur=\"chkMinMax(this,".intval($r_sport_min[3]).",".intval($r_sport_max[5]).");\">
                <span class='text-danger' id='k_sport_betmoneymax_pair' data-json='".addCommas($r_sport_max[5])."'>(".addCommas($r_sport_min[3])." - ".addCommas($r_sport_max[5]).") </span>
            </div>
        </div>
    </div>
    <div class='col-xs-12 col-sm-4'>
        <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='sport_betmax_money'>{$lang_ag[831]}  :</label>
        <div class='col-xs-8 col-sm-8'>
            <div class='clearfix'>
    ...
    <div class='col-xs-12 col-sm-4'>
        <label class='control-label col-xs-4 col-sm-4 no-padding-right' for='sport_betmin_money'>{$lang_ag[1410]} :</label>
        <div class='col-xs-8 col-sm-8'>
            <div class='clearfix'>
                <input type='text' name='sport_betmin_money' id='sport_betmin_money' class='numeric minLimit' value='".addCommas($array_data["sport_betmin_money"])."' onblur=\"chkMinMax(this,".intval($r_sport_min[3]).",".intval($max_betmin_money).");\">
                <span class='text-danger label-sm' id='k_sport_betmin_money' data-json='".addCommas($r_sport_min[3])."'>(".addCommas($r_sport_min[3])." - ".addCommas($max_betmin_money).") </span>
            </div>
        </div>
    </div>
</div>
