        ...
        <form class="form-horizontal" id="createAgent_form" method="post" action="" onsubmit="return false;">
            <div class="widget-box no-skin widget-color">
                <div class="widget-header widget-header-blue">
                    <h4 class="widget-title lighter"><?=$lang_ag[870];?></h4>
                    ...
                    <div class="widget-main">
                        <div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <div class="input-group clearfix">
                                        ...
                                        <input type="text" class="inputEngNum" id="username" name="username" value="" maxlength="5" placeholder="<?=$lang_ag[1396];?>">
                                    </div>
                                </div>
                                <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="password"><?=$lang_ag[1393];?> :</label>
                                <div class="col-xs-12 col-sm-4">
                                    <div class="clearfix">
                                        <input type="password" name="password" id="password" class="inputEngNum" minlength="6" maxlength="16" placeholder="<?=$lang_ag[1393];?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <div class="clearfix">
                                        <input type="text" name="name" id="name" value="" placeholder="<?=$lang_ag[405];?>">
                                    </div>
                                </div>
                                <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="telephone"> <?=$lang_ag[596];?> :</label>
                                <div class="col-xs-12 col-sm-4">
                                    <div class="clearfix">
                                        <input type="tel" id="telephone" name="telephone" value="" placeholder="<?=$lang_ag[596];?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="clearfix">
                                        <input type="text" name="credit" id="credit" value="0.00" class="numeric input-num2digt" placeholder="<?=$lang_ag[423];?>" onblur="calCredit(this,<?=$x_count3;?>);">
                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div id="soccer" class="tab-pane fade in active">
                                        ...
                                        <div class="form-group">
                                           <div class="col-xs-12 col-sm-6 col-md-6"> 
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="today_share"><?=$lang_ag[877];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="live_share"><?=$lang_ag[880];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="clearfix input-group">
                                ...
                                <div id="sport" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-6 col-md-6"> 
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="sporttoday_share"><?=$lang_ag[877];?> :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="clearfix input-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="sportlive_share"><?=$lang_ag[880];?> :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="clearfix input-group">
                                ...
                                <div id="boxing" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-6 col-md-6"> 
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="boxingtoday_share"><?=$lang_ag[1091];?> :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="clearfix input-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="boxinglive_share"><?=$lang_ag[1092];?> :</label>
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="clearfix input-group">
                                    ...
                                    <div class="form-group">
                                       <div class="col-xs-12 col-sm-4 col-md-4">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix">
                                                    <input type="text" name="boxing_betmoneymax_pair" id="boxing_betmoneymax_pair" class="numeric maxLimit input-num2digt" value="<?=addCommas($r_sport_max[7]);?>" onblur="chkMinMax(this,<?=intval($r_sport_min[4]);?>,<?=intval($r_sport_max[7]);?>);">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8">
                                                <div class="clearfix">
                                                    <input type="text" name="boxing_betmin_money" id="boxing_betmin_money" class="numeric minLimit input-num2digt" value="<?=addCommas($r_sport_min[4]);?>" onblur="chkMinMax(this,<?=intval($r_sport_min[4]);?>,<?=intval($max_betmin_money);?>);">
                                ...
                                <div id="step" class="tab-pane fade">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-4">
                                                ...
                                                <div class="form-group">
                                                  <div class="col-xs-12 col-sm-12 col-md-12">  
                                                    <label class="control-label col-xs-12 col-sm-6 col-md-4 no-padding-right" for="step_billmax_money"><?=$lang_ag[814];?> :</label>
                                                  <div class="col-xs-12 col-sm-6 col-md-8">
                                                    <div class="clearfix">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                                ...
                                                                <div class="col-xs-12 col-sm-6 col-md-7 casino_select">
                                                                    <div class="clearfix input-group">
                                                                        ...
                                                                        <span class="text-danger"><?=$r_name;?> </span> 
                                                                        <?=$lang_ag[1402];?> : <span id="k_casino_share<?=$key;?>" class="sl_data" data-json="<?=$r_casino_share[$key];?>">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                                ...
                                                                <div class="col-xs-12 col-sm-8 col-md-7">
                                                                    <div class="clearfix casino_Input"> 
                                                                        <input type="text" name="rcb_maxtransfer<?=$key;?>" id="rcb_maxtransfer<?=$key;?>" class="numeric maxLimit input-num2digt" value="<?=number_format($r_casino_max[$key]);?>" onblur="chkMinMax(this,<?=$r_casino_min[$key];?>,<?=$r_casino_max[$key];?>);">
                                    ...
                                    <div class="widget-main no-padding">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-4 col-md-2">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right" for="7_lotto_share"><?=$lang_ag[1408];?> :</label>
                                                <div class="col-xs-12 col-sm-6 col-md-6">
                                                    <div class="clearfix input-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-2">
                                                <label class="control-label col-xs-12 col-sm-12 col-md-12 no-padding-right">
                                                    <span class="text-danger"> <?=$r_name;?> </span> 
                                                    <?=$lang_ag[1402];?> : <span id="k_7_lotto_share" data-json="<?=$r_lotto_hun_share[1];?>">
                                ...
                                <div id="lotto_set" class="tab-pane fade">
                                    <div class="widget-main no-padding">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-2">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-12 no-padding-right">
                                                    <span class="text-danger"> <?=$r_name;?> </span> 
                                                    <?=$lang_ag[1402];?> : <span id="k_8_lotto_share" data-json="<?=$r_lotto_hun_share[1];?>">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-8">
                                                  <div class="clearfix">
                                                    <input type="text" name="lotto_share_hun_betmin_money" id="lotto_share_hun_betmin_money" class="numeric input-num2digt no-margin-top" value="<?=number_format($r_lotto_hun_min[1]);?>" onblur="chkMinMax(this,<?=$r_lotto_hun_min[1];?>,<?=$r_lotto_hun_max[1];?>);">
                                    ...
                                    <div class="widget-main no-padding">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                    <span class="text-danger"><?=$r_name;?> </span> 
                                                     <?=$lang_ag[1402];?> : <span id="k_9_lotto_share" data-json="<?=$r_lotto_hun_set_share[1];?>"> <?=$r_lotto_hun_set_share[1];?> </span> %
                                                </label>
                                            </div>
                                        </div>
                                                                         ...
                                                                         ?>
                                                                             ...
                                                                             <tr class="text-center">
                                                                                    ...
                                                                                    <td width="35%" class="lotto_lao_Input">
                                                                                        ...
                                                                                        <span class="text-danger label-sm maxtransfer di-b" id="lot_hun_set_pay_info" data-json="<?=number_format($r_lotto_hun_set_pay[$index]);?>">(0-<?=number_format($r_lotto_hun_set_pay[$index]);?>) </span>
                                                                                    </td>
                                                                                    <?php if($index == 1){ ?>
                                                                                    <td width="35%" rowspan="100%" style="vertical-align: top;" class="lotto_lao_Input">
                                                                                        <input type="text" name="lot_hun_set_price<?=$index;?>" id="lot_hun_set_price<?=$index;?>" class="numeric maxLimit input-num2digt" value="<?=number_format($r_lotto_hun_set_price[$index]);?>" onblur="chkMinMax(this,<?=$r_lotto_hun_set_price[$index];?>,<?=$r_lotto_hun_set_price_max;?>);">
                                                                                        <span class="text-danger label-sm maxtransfer di-b" id="lot_hun_set_price_info" data-json="<?=number_format($r_lotto_hun_set_price[$index]);?>">(<?=number_format($r_lotto_hun_set_price[$index]);?> - <?=number_format($r_lotto_hun_set_price_max);?>) </span>
                                                                                    </td>
                                                                                    <?php } ?>
                                                                             </tr>
                                                                             <?php 
                                ...
                                <div id="game" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label class="control-label col-xs-12 col-sm-6 col-md-6 no-padding-right">
                                                <span class="text-danger"><?=$r_name;?> </span> 
                                                <?=$lang_ag[1402];?> : <span id="k_game_share" data-json="<?=$r_games_share[1];?>">
               ...
               pageContentLoader("hide");
                bootbox.dialog({
                    ...
                    buttons:            
                    {
                        "UserList" :
                        {
                            "label" : "<i class=\"ace-icon fa fa-list-ul bigger-110\"></i> <span class=\"normal\"><?=$lang_ag[82];?></span>",
                        ...
                        "OK" :
                        {
                            "label" : "<i class='fa fa-floppy-o'></i> <span class=\"normal\"><?=$lang_ag[513];;?></span>",
                        ...
                        "NO" :
                        {
                            "label" : "<i class='ace-icon glyphicon glyphicon-log-in'></i> <span class=\"normal\"><?=$lang_ag[284];?></span>",
