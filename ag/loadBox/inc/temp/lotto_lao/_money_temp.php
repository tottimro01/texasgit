...
<div class="row">
                        ...
                        <form class="form-horizontal" id="" method="post">
                            ...
                            <div class="form-group" style="padding:5px 15px;">   
                                    <div class="mobile-padding input-box button-box" style="float: left;">                              
                                    <label class="control-label text-left label-1"  style="min-width: 80px;" for="l_zone"><?=$lang_ag[1657];?> : </label>
                                    <select class="input-sm lot_sl" style="height:30px; min-width: 100px;" id="l_zone" name="l_zone" onchange="set_rob(this.value);">
                                    ...
                                    <div class="mobile-padding input-box button-box hun_btn" style="float: left;">  
