...
$sql="select 
  ...
  from bom_tb_lotto_bill_play_live where    ok_id='$ok_id'  and r_agent_id like '%*$rs[r_id]*%'    and b_accept=1   ";
  $re1=sql_array($sql);
...
$sql="select 
  ...
  from bom_tb_lotto_bill_play_live where    ok_id='$ok_id'  and r_id = '$r_id'    and b_accept=1  order by lot_type asc , play_number asc    ";
$re=sql_query($sql);
while($rs=sql_fetch($re)){
$s2_a[$rs["m_id"]][]=$rs['r1'];
$s2_b[$rs["m_id"]][]=$rs['r2'];
