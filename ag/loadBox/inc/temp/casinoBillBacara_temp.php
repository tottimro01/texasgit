        ...
        <div class="row" style="padding-bottom: 20px;">
          ...
          <div class="col-xs-6">
            <div id="title<?=($tb_no-1)?>" class="title">
              <span class="tbls"><?=$lang_ag[1681];?> <?=$tb_no?> : </span>
            ...
            <div class="betTbls" id="betTbl<?=($tb_no-1)?>">
              <div class="pp">
                <span class="tblP">Player Pair</span><br>
                <span class="bets" id="ppB<?=($tb_no-1)?>" title="Bet on Player Pair">0.00</span><br>
                <span class="wins" id="ppW<?=($tb_no-1)?>" title="Win on Player Pair">( 0.00 )</span>
              </div>
              <div class="t">
              ...
              <div class="bp">
                <span class="tblB">Banker Pair</span><br>
                <span class="bets" id="bpB<?=($tb_no-1)?>" title="Bet on Banker Pair">0.00</span><br>
                <span class="wins" id="bpW<?=($tb_no-1)?>" title="Win on Banker Pair">( 0.00 )</span>
              </div>
              <div class="p">
                <span class="tblP">Player</span><br>
                <span class="bets" id="pB<?=($tb_no-1)?>" title="Bet on Player">0.00</span><br>
                <span class="wins" id="pW<?=($tb_no-1)?>" title="Win on Player">( 0.00 )</span>
              </div>
              <div class="b">
                <span class="tblB">Banker</span><br>
                <span class="bets" id="bB<?=($tb_no-1)?>" title="Bet on Banker">0.00</span><br>
                <span class="wins" id="bW<?=($tb_no-1)?>" title="Win on Banker">( 0.00 )</span>
              </div>
            </div>
          </div>
        <? $tb_no++; } ?>
...
function setSummary(e) {
    var n = e.gId.length;
    if (n > 0)
        for (var t = 0; n > t; t++) "0" == e.gId[t] || null == e.gId[t] ? (document.getElementById("info" + t).innerHTML = "[ Closed ]", document.getElementById("ppB" + t).innerHTML = "0.00", document.getElementById("ppW" + t).innerHTML = "( 0.00 )", document.getElementById("tB" + t).innerHTML = "0.00", document.getElementById("tW" + t).innerHTML = "( 0.00 )", document.getElementById("bpB" + t).innerHTML = "0.00", document.getElementById("bpW" + t).innerHTML = "( 0.00 )", document.getElementById("pB" + t).innerHTML = "0.00", document.getElementById("pW" + t).innerHTML = "( 0.00 )", document.getElementById("bB" + t).innerHTML = "0.00", document.getElementById("bW" + t).innerHTML = "( 0.00 )") : (document.getElementById("info" + t).innerHTML = 'Game ID # <span id="gid' + t + '" class="gids"></span> at <span id="time' + t + '" class="times"></span> <span id="st' + t + '"></span>', document.getElementById("gid" + t).innerHTML = e.gId[t], document.getElementById("time" + t).innerHTML = e.time[t], document.getElementById("st" + t).innerHTML = "[ " + stLt[e.st[t] - 1] + " ]", document.getElementById("ppB" + t).innerHTML = e.pp[t], document.getElementById("ppW" + t).innerHTML = "( " + addCommas(parseFloat(11 * parseFloat(delCommas(e.pp[t]))).toFixed(2)) + " )", document.getElementById("tB" + t).innerHTML = e.t[t], document.getElementById("tW" + t).innerHTML = "( " + addCommas(parseFloat(8 * parseFloat(delCommas(e.t[t]))).toFixed(2)) + " )", document.getElementById("bpB" + t).innerHTML = e.bp[t], document.getElementById("bpW" + t).innerHTML = "( " + addCommas(parseFloat(11 * parseFloat(delCommas(e.bp[t]))).toFixed(2)) + " )", document.getElementById("pB" + t).innerHTML = e.p[t], document.getElementById("pW" + t).innerHTML = "( " + addCommas(e.p[t]) + " )", document.getElementById("bB" + t).innerHTML = e.b[t], document.getElementById("bW" + t).innerHTML = "( " + addCommas(parseFloat(.95 * parseFloat(delCommas(e.b[t]))).toFixed(2)) + " )")
}
...
function getSummaryAj() {
    ...
    null != e ? (url = "dbSummary.php", e.onreadystatechange = function() {
