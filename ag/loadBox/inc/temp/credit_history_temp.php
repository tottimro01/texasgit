            ...
            <form class="form-horizontal" id="sch_form">
              <div class="form-group">                           
                ...
                <div class="col-xs-12 col-sm-2">
                  ...
                  <a href="#" onclick="getMenu('credit_history','?id=3&lv=2&up_r_agent_id=*1*3*&sdate=29-07-2019&edate=29-07-2019');" type="button" id="back" class="btn btn-primary btn-sm"><?=$lang_ag[716];?></a>
                </div>
              </div>
            </form>
            <div class="clearfix">
