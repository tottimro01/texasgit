...
END
 ...
 from bom_tb_games_bill_play where m_id = '".$rs['m_id']."'  and b_accept=1           and  b_date BETWEEN '$e' and '$d'   ";
$rs4=sql_array($sql);
if($gm!=""){
$s1d=$rs4['t1'];
$r1d=$rs4['r1'];
...
END
 ...
 from bom_tb_casino_bill_play where m_id = '".$rs['m_id']."'  and b_accept=1     and  play_datenow BETWEEN '$edate' and '$ddate'";
$rs5=sql_array($sql);
if($cn!=""){
$s1e=$rs5['t1'];
$r1e=$rs5['r1'];
