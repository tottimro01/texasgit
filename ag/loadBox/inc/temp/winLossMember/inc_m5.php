...
END
 ...
 from bom_tb_games_bill_play where m_id = '".$rs_m['m_id']."'  and b_accept=1     and  b_date BETWEEN '$e' and '$d'     ";
$rs7=sql_array($sql);
...
END
 ...
 from bom_tb_casino_bill_play where m_id = '".$rs_m['m_id']."'  and b_accept=1     and  play_datenow BETWEEN '$edate' and '$ddate'";
$rs8=sql_array($sql);
