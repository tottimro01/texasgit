...
,sum(br_bonus_1) as bonus
 from bom_tb_football_bill where  	  b_accept=1   $c_date and r_agent_id = '$r_agent_id'  $type $bet  $shop  $qq   $xmid $xbill  $b_out";
	$ree1=sql_array($sql);
...
,sum(br_bonus_1) as bonus
 from bom_tb_football_bill_live where  	  b_accept=1   $c_date and r_agent_id = '$r_agent_id'  $type $bet  $shop  $qq   $xmid $xbill  $b_out";
