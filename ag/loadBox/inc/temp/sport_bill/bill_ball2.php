         ...
         <td>
            <table width="100%" cellpadding="0" cellspacing="0" class="team">
               <tr>
                  ...
                  <td width="56%" align="right"><?=$lang[0];?>  : <?=$ree[bill_id];?> [<?  if($ree[b_accept]==1){
               ...
               <tr>
                  ...
                  <td width="56%" align="right"><?=$lang[1];?> : <?=$jmb[m_user];?>&nbsp;</td>
               </tr>
            </table>
         </td>
      </tr>
                        ...
                        <td>
                           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="team" style=" <?=$cancel_bill?>">
                              <tr>
                                 ...
                                 <? if($rss[b_big]==2){echo'*';}?> 
                                [ <?=date("H:i",$reb[b_date_play]);?> ]<?=$live;?><span style="float:right;">[<?=$ball_type3[$rss[play_status]];?>]</span>
                                 </td>
                              </tr>
                              <tr>
...
<? }?>
               ...
               <td  align="right" height="25px">
                  <table width="100%" cellpadding="0" cellspacing="0" class="team">
                     <tr>
                        ...
                        <td width="40%" align="right"><?=$lang[4];?>  : <?=number_format($ree[b_total]);?>&nbsp;<?=$lang[13];?></td>
                     </tr>
                  </table>
               </td>
            </tr>
            <tr>
               <td  align="right" height="25px">
                  <table width="100%" cellpadding="0" cellspacing="0" class="team">
                     <tr>
                        <td align="right"><?=$lang[5];?>  : <?=number_format(0);?>&nbsp;<?=$lang[13];?></b></td>
                     </tr>
                  </table>
               </td>
            </tr>
            <tr>
               <td  align="right" height="25px">
                  <table width="100%" cellpadding="0" cellspacing="0" class="team">
                     <tr>
                        <td align="right"><?=$lang[6];?>  : <?=number_format($ree[b_total]);?>&nbsp;<?=$lang[13];?></b></td>
                     </tr>
                  </table>
               </td>
            </tr>
            ...
            <tr>
               <td  align="right" class="team"><?=$lang[7];?> : <?=number_format($ree[b_total]);?>&nbsp;<?=$lang[13];?></td>
            </tr>
...
<table width="100%" cellpadding="0" cellspacing="0" class="team">
                     <tr>
                        <td width="30%" align="left"><? if($ree[b_numstep]>1){?> <?=$lang[11];?> <b><?=$ree[b_numstep];?></b><? }else{?><?=$lang[12];?><? }?></td>
                        <td width="60%" align="right"><strong><?=$lang[14];?>   :  <span class="cr"> <?=number_format($ree[b_total]*$ree[b_sum_pay]);?> </span> <?=$lang[13];?></strong></td>
                     </tr>
                  </table></td>
            </tr>
            
            <tr>
               <td  align="center" class="font12" ><b><?=$lang[8];?> : 
               <?
               if($ree[b_web_from]==2){
				   echo'win.zusbet.com';
			   }else{
