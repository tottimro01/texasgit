...
if( $gametype=="sc"){
	$total="b_sum";
	$dis1="  b_pay ";
	$where="bom_tb_football_bill_live where m_id='".$rs['m_id']."'  and b_accept=1  and b_status=5 and b_numstep=1 and  b_zone=6";
	$r33=" br_pay_".$ag_level." - b_pay ";	
}elseif( $gametype=="sp"){
	$total="b_sum";
	$dis1="  b_pay ";
	$where="bom_tb_football_bill_live where m_id='".$rs['m_id']."'  and b_accept=1  and b_status=5 and b_numstep=1 and  b_zone!=1 and  b_zone!=6";
	$r33=" br_pay_".$ag_level." - b_pay ";		
}elseif( $gametype=="bx"){
	$total="b_sum";
	$dis1="  b_pay ";
	$where="bom_tb_football_bill_live where m_id='".$rs['m_id']."'  and b_accept=1  and b_status=5 and b_numstep=1 and  b_zone=1 ";
	$r33=" br_pay_".$ag_level." - b_pay ";			
}elseif( $gametype=="st"){
	$total="b_sum";
	$dis1="  b_pay ";
	$where="bom_tb_football_bill_live where m_id='".$rs['m_id']."'  and b_accept=1  and b_status=5 and b_numstep>1  ";
	$r33=" br_pay_".$ag_level." - b_pay ";			
}elseif( $gametype=="lg"){
	$total="b_total";
	$dis1="  b_total - b_pay ";
