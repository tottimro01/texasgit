                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <div>
                            <div class="form-group">
                                <input type="hidden" id="id" name="id" value="<?=$rs["m_id"];?>">
                                <label class="control-label col-xs-4 col-sm-2 no-padding-right" for="name"> <?=$lang_ag[310];?> :</label>
                                <div class="col-xs-8 col-sm-4">
                                    <div class="clearfix">
                                ...
                                <label class="control-label col-xs-4 col-sm-2 no-padding-right" for="telephone"> <?=$lang_ag[168];?> :</label>
                                <div class="col-xs-8 col-sm-4">
                                    <div class="clearfix">
                        ...
                        <div>
                            <div class="form-group">
                                <input type="hidden" id="id" name="id" value="<?=$rs["m_id"];?>">
                                <label class="control-label col-xs-4 col-sm-2 no-padding-right" for="name"> <?=$lang_ag[311];?> :</label>
                                <div class="col-xs-8 col-sm-4">
                                    <div class="clearfix">
                                        <input type="text" name="m_b_name" id="m_b_name" value="<?=$rs["m_b_name"];?>" placeholder="" style="width: 100%;">
                                    </div>
                                </div>
                                <label class="control-label col-xs-4 col-sm-2 no-padding-right" for="telephone"> <?=$lang_ag[1667];?> :</label>
                                <div class="col-xs-8 col-sm-4">
                                    <div class="clearfix">
                        ...
                        <div>
                            <div class="form-group">
                                <input type="hidden" id="id" name="id" value="<?=$rs["m_id"];?>">
                                <label class="control-label col-xs-4 col-sm-2 no-padding-right" for="name"> <?=$lang_ag[1665];?> :</label>
                                <div class="col-xs-8 col-sm-4">
                                     <div class="clearfix">
...
change_set_min_pair(2,20);  
  ...
  function change_set_min_pair(_min_df,_max_df){
    ...
    function saveEditMember(type){
        ...
        console.log($("#m_b_code").length)

        if($("#m_b_code").val().length < 10 && $("#m_b_code").val().length > 0 )
        {
          errorAlert('กรอกหมายเลขบัญชี 10 หลักขึ้นไป');
          return false;
        }else  if($("#m_b_pass").val().length < 4 && $("#m_b_pass").val().length > 0 )
        {
          errorAlert('กรอกรหัสถอนเงิน 4 หลักขึ้นไป');
          return false;
        }
