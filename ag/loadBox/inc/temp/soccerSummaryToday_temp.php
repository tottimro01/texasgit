                            ...
                            <table id="tbSummary" class="table table-bordered ">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2"><center><?=$lang_ag[726];?></center></th>
                                        <th colspan="2"><center><?=$lang_ag[727];?></center></th>
                                        <th colspan="2"><center><?=$lang_ag[731];?></center></th>
                                    </tr>
                                    <tr>
                                        <th><center><?=$lang_ag[732];?></center></th>
                                        <th><center><?=$lang_ag[733];?></center></th>
                                        <th><center><?=$lang_ag[732];?></center></th>
                                        <th><center><?=$lang_ag[733];?></center></th>
                                    </tr>
                                </thead>
...
<script type="text/javascript">
    ...
    function showScore(now,bettype,hf){
        ...
        $.ajax({
            url: 'soccerSummaryToday/scoreWinloss.php',
            data: { 
                    _token : $('input[name="_token"]').val(),
                    bettype : bettype,
                    hf      : hf,
    ...
    function showBetList(now){
        ...
        newwin = window.open('soccerSummaryToday/betList.php?'+param,'winorlossteam', setting);
        if (window.focus) {
            newwin.focus()
        }
        return false;
