                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4 col-sm-2">
                                    <select class="form-control col-xs-12 col-sm-6 input-sm" id="slSport" onchange="getLeague();">
                                        ...
                                        <option value="bk"><?=$lang_ag[1439];?></option>                                            
                                        <option value="af"><?=$lang_ag[1440];?></option>                                            
                                        <option value="tn"><?=$lang_ag[1441];?></option>                                            
                                        <option value="ic"><?=$lang_ag[1442];?></option>                                            
                                        <option value="bb"><?=$lang_ag[1443];?></option>                                            
                                        <option value="vb"><?=$lang_ag[1444];?></option>                                            
                                        <option value="bt"><?=$lang_ag[1445];?></option>                                            
                                        <option value="my"><?=$lang_ag[860];?></option>                                             
                                    </select>
                                </div>
...
<script type="text/javascript">
    ...
    function getLeague(sdate){
        ...
        .done(function(response) {
            slLeague += '<option value="" selected=""><?=$lang_ag[174];?></option>';
            if(response.status){
