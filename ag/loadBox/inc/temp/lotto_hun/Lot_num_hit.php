...
<? if($_POST[type]==1 or $_POST[type]==2  or $_POST[type]==3 or $_POST[type]==14 or $_POST[type]==15 or $_POST[type]==16  or $_POST[type]==17  or $_POST[type]==20  or $_POST[type]==66){?>
 <input name="tnumber" placeholder="<?=$lang_ag[174];?>" type="text" class="txt_back11n center" id="tnumber" size="8" maxlength="3" onKeyDown="return numberonly(event,this)"/>
<? }elseif($_POST[type]==4 or $_POST[type]==5  or $_POST[type]==13 or $_POST[type]==18   or $_POST[type]==24 or $_POST[type]==55 ){?>
 <input name="tnumber" placeholder="<?=$lang_ag[174];?>" type="text" class="txt_back11n center" id="tnumber" size="8" maxlength="2" onKeyDown="return numberonly(event,this)"/>
<? }elseif($_POST[type]==6 or $_POST[type]==7 or $_POST[type]==19  or $_POST[type]==21   or $_POST[type]==22   or $_POST[type]==23){?>
 <input name="tnumber" placeholder="<?=$lang_ag[174];?>" type="text" class="txt_back11n center" id="tnumber" size="8" maxlength="1" onKeyDown="return numberonly(event,this)"/>
...
<? }else if($_POST[type]==26 || $_POST[type]==27 || $_POST[type]==25){
	?>
		 <input name="tnumber" placeholder="<?=$lang_ag[174];?>" type="text" class="txt_back11n center" id="tnumber" size="8" maxlength="4" onKeyDown="return numberonly(event,this)"/>
	<?
} ?>
