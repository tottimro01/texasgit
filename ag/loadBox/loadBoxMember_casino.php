  ...
  $data["temp"] .= "</select>
              ...
              <div class='col-xs-12 col-sm-12 col-md-12'>
                ...
                <div class='col-xs-12 col-sm-8 col-md-7'>
                  <div class='clearfix casino_Input'>
                    <input type='text' name='rcb_maxtransfer{$key}' id='rcb_maxtransfer{$key}' class='numeric maxLimit' value='".addCommas($array_data["rcb_maxtransfer"][$key])."' onblur=\"chkMinMax(this,".$r_casino_min[$key].",".$r_casino_max[$key].");\">
                    <span class='text-danger label-sm maxtransfer' id='k_rcb_maxtransfer' data-json='".number_format($r_casino_max[$key])."'>(".number_format($r_casino_min[$key])." - ".number_format($r_casino_max[$key]).") </span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class='form-group'>
              <div class='col-xs-12 col-sm-12 col-md-12'>
                ...
                <div class='col-xs-12 col-sm-8 col-md-7'>
                  <div class='clearfix casino_Input'>
                    <input type='text' name='rcb_mintransfer{$key}' id='rcb_mintransfer{$key}' class='numeric maxLimit input-num2digt' value='".addCommas($array_data["rcb_mintransfer"][$key])."' onblur=\"chkMinMax(this,".$r_casino_min[$key].",".$max_betmin_money.");\">
