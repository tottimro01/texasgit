             ...
             $list.= "<tr>
              ...
              $list.= "<td>
                          ...
                          <div class='ace-settings-item center chk-g'>
                            <input type='checkbox' class='ace ace-checkbox-2 chk_{$rs['r_id']}_a' disabled='disabled' id=\"{$rs['r_user']}_{$key}_active\" {$chk} onchange=\"setCHK('{$key}','{$rs['r_user']}','{$rs['r_id']}','ag',this)\" >
                            <label class='lbl' for='ace-settings-navbar'></label>
                          </div>
        ...
        $pagi_data["load"]  = "mix"; 
            ...
            while($rs=sql_fetch($re)){
                ...
                $list.= "<td>
                            ...
                            <div class='ace-settings-item center chk-g'>
                              <input type='checkbox' class='ace ace-checkbox-2 chk_{$rs['m_id']}_m' disabled='disabled' id=\"{$rs['m_user']}_{$key}_active\" {$chk} onchange=\"setCHK('{$key}','{$rs['m_user']}','{$rs['m_id']}','m',this)\"  >
                              <label class='lbl' for='ace-settings-navbar'></label>
                            </div>
