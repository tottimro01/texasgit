 ...
 if($_SESSION["AGlang"]==""){
  ...
  $head = "
    <tr>
      ...
      <th rowspan='3' style='min-width:100px;' class='center'>{$lang_ag[1390]} </th>
      <th rowspan='3' style='min-width:200px;'> {$lang_ag[1396]} </th>
      <th colspan='100%'><center> {$lang_ag[464]} </center></th>
    </tr>
    <tr>";
                    ...
                    <table width='100%'>
                      <thead>
                        <tr>
                          <th></th>
                          <td>
                            <button type='button' class='btn btn-light btn-success btn-block btn-xs ck_setup_".$key."' onclick=\"setAllSl('setup_".$key."','min');\" disabled='disabled'>{$lang_ag[1397]}</button>
                          </td>
                          <td>
                            <button type='button' class='btn btn-light btn-success btn-block btn-xs ck_setup_".$key."' onclick=\"setAllSl('setup_".$key."','max');\" disabled='disabled'>{$lang_ag[1398]}</button>
                          </td>
                        </tr>
                     </thead>
                   </table>
