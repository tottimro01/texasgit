...
if($r_open[6] != 0)
{
  ...
  }else if($ex_boxing_betmin_money > $max_betmin_money || $ex_boxing_betmin_money < $r_sport_min[3] || !is_numeric($ex_boxing_betmin_money)){
...
if($r_open[7] != 0)
{
  if($ex_step_betmax_money > $r_sport_step_max[1] || $ex_step_betmax_money < $r_sport_step_min[1] || !is_numeric($ex_step_betmax_money)){
    ...
    warningInput(3,$lang_ag[637],"step_betmin_money");
...
if($r_open[8] != 0)
{
  if($ex_lotto_betmax_money > $r_lotto_max[1] || $ex_lotto_betmax_money < 0 || !is_numeric($ex_lotto_betmax_money)){
    ...
    warningInput(4,$lang_ag[642],"lotto_betmax_money");
      ...
      foreach ($lot_type[$_SESSION["AGlang"]][1] as $key => $value) {
        ...
        if($ex_lotto_com1 > $r_lotto_dis1[$key] || $ex_lotto_com1 < 0 || !is_numeric($ex_lotto_com1)){
          warningInput(4,"".$ex_lotto_com1.">".$r_lotto_dis1[$key].$lang_ag[663].$value.$lang_ag[661],"7_".$key."_lotto_com1");
        }
        ...
        if($ex_lotto_com2 > $r_lotto_dis2[$key] || $ex_lotto_com2 < 0 || !is_numeric($ex_lotto_com2)){
          warningInput(4,"".$ex_lotto_com2.">".$r_lotto_dis2[$key].$lang_ag[663].$value.$lang_ag[661],"7_".$key."_lotto_com2");
        }
        ...
        if($ex_lotto_com3 > $r_lotto_dis3[$key] || $ex_lotto_com3 < 0 || !is_numeric($ex_lotto_com3)){
          warningInput(4,"".$ex_lotto_com3.">".$r_lotto_dis3[$key].$lang_ag[663].$value.$lang_ag[661],"7_".$key."_lotto_com3");
        }
      }
...
if($r_open[9] != 0)
{
    if($ex_lotto_share_hun_betmax_money > $r_lotto_hun_max[1] || $ex_lotto_share_hun_betmax_money < 0 || !is_numeric($ex_lotto_share_hun_betmax_money)){
...
if($r_open[12] != 0)
{
  ...
  //   if($ex_casino_com > $r_casino_dis[$key] || $ex_casino_com < 0 || !is_numeric($ex_casino_com)){
  //     warningInput(8,$lang_ag[210]." ".$value.$lang_ag[661],"casino_com".$key."");
