...
#################API
   $url=$x_process.'api/getBalance2.php?user='.$re['m_user'];
...
/* echo"<script language='JavaScript'>window.location.href = '{$hostserver}index.php';</script>";*/
echo"<script language='JavaScript'> window.location.href='".$hostserver."check_login_link.php?token=".$_SESSION['m_token']."&id=".$_SESSION['m_id']."&user=".$_SESSION['m_user']."&clang=".$_SESSION['lang']."&referer=texasbetx.com&clink=".$_SESSION['m_login_from']."&ref_url=".$ref_url."';</script>";

/*echo"<script language='JavaScript'> window.location.href='http://4g63t.ohoking.com/check_login_link.php?token=".$_SESSION['m_token']."&id=".$_SESSION['m_id']."&user=".$_SESSION['m_user']."&clang=".$_SESSION['lang']."&referer=big289.com';</script>";*/
// header("Location: {$check_url}/index.php");
exit();
